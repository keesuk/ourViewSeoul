...
import d3worker from 'worker-loader!./Worker.js'; // eslint-disable-line import/no-webpack-loader-syntax
...
class Img extends Component {
    ...
    componentDidMount() {
        this.worker = new Worker(d3worker);
        this.updateCanvas();
    }
    ...
    updateCanvas() {
        ...
        img.onload = () => {
            ...
            this.worker.onmessage = (event) => draw(event.data, context);
