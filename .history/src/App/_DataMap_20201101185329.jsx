...
const location = [
    ...
    {name : 'Sujiguoffice', number: 80, id: 0},
    {name : 'Euljiro4saga', number: 92, id: 0},
    {name : 'Noryangjin', number: 51, id: 0},
    {name : 'Wolgye', number: 64, id: 0},
]
...
class MapShow extends PureComponent {
    ...
    componentDidMount(){
        ...
        if(location[0].number > 50){
            this.setState({ ornaType : 2})
        }else if(10 < location[0].number <= 50){
            this.setState({ ornaType : 1})
        }else if(location[0].number <= 10){
            this.setState({ ornaType : 0})
        }
    }
                            ...
                            <SvgContainer> 
                                ...
                                <g>
                                    <g style={{mixBlendMode: 'multiply'}}>
                                            ...
                                            // circlePin(fontsize, transform, key)
                                            // rectPin(fontsize,x, y, key)
                                            // trianglePin(fontsize, transform, key)
                                            // rhombusPin(transform, size, x, y, key)
                                            // ellipsePin(fontsize, x, y, transform, key)
                                    </g>
                                </g>
                            </Svg>
                            </SvgContainer>
