...
export class AskMarker extends React.PureComponent {
    render(){ 
        ...
        return(
            <>
                <MarkerDiv style={{color:colorOn === 'red'? colorListTag[0] : (colorOn === 'green'? colorListTag[1]: (colorOn === 'blue'? colorListTag[2]: (colorOn === 'purple'? colorListTag[3] : colorListTag[4])))}}>
                    {colorOn === 'red' ? shapeItems[0] : (colorOn === 'green'? shapeItems[1]: (colorOn === 'blue'? shapeItems[2]: (colorOn === 'purple'? shapeItems[3] : shapeItems[4])))}
                </MarkerDiv>
            </>
        )
    }
