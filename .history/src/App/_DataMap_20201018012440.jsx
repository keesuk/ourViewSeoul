...
import { pxStringfier, colorChooser, randomizer} from "./_Diagram.jsx";
...
const distanceLeftList  = ['0vw', '5vw', '10vw', '15vw', '20vw']
        ...
        return (
                ...
                {stroke ? null :
                    <ExplainDiv>
                        ...
                        <ExplainNumber>
                            {colorList.map(item => <div style={{color: item}}>{this.state[colorChooser(item)]}%</div>)}
                        </ExplainNumber>
                        <ExplainDiagram>
