...
class Map extends PureComponent {
    ...
    render() {
        const dataJson = data.map(station => station.attributes)
        console.log(dataJson)
        // const {match, history} = this.props;
        // const mapList = data.map((station, i) => {
        //         <g key={i} onClick={()=>history.push(match.path.replace(':station', `${station.attribute.id}`))}>
