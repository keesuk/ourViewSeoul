...
class Map extends PureComponent {
  ...
  render() {
    ...
    <g key= '{g.id}' id="map">
      ...
      <g key= '{g.id}' id="IntlBusinessDistrict">
      ...
      <g key= '{g.id}' id="HanyangUnivatAnsan">
      ...
      <g key= '{g.id}' id="SuwonCityHall_1_">
      ...
      <g key= '{g.id}' id="GyeonggiProvincialGovernmentNorthernOffice">
      ...
      <g key= '{g.id}' id="GeumcheonGuOffice">
      ...
      <g key= '{g.id}' id="DongdaemunHistoryCulturePark">
      ...
      <g key= '{g.id}' id="GuroDigitalComplex">
