                ...
                <header className="window-header">
                    <div className="header-content">
                        ...
                        <div className="tag-wrapper">
                            ...
                            { fetching ? 
                                randomize([
                                    <Ellipse left={'3px'} right={'3px'} size={'19px'} top={'-6px'} on={1} getDown={0}/>, 
                                    <Circle left={'3px'} right={'3px'} size={'15px'}on={1} getDown={0}/>, 
                                    <Rectangular left={'3px'} right={'3px'} size={'15px'}on={1} getDown={0}/>, 
                                    <Triangle left={'3px'} right={'3px'} size={'16.2px'} top={'-1.5px'}on={1} getDown={0}/>, 
                                    <Rhombus left={'3px'} right={'3px'} size={'15px'}on={1} getDown={0}/>
                                ])
                                : null
                            }
                        </div>
