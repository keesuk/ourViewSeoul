...
class Output extends Component {
    ...
    posterPageUp() {
        ...
        setTimeout(() => {this.setState(state => ({contentShow : !state.contentShow}))},500)
    }
        ...
        return(
            <OutputWrapper 
                ...
                style={{ 
                    ...
                    backgroundColor: contentShow ? '#222222' : (pageUp? '#222222':'white'),
                }}
            >
                <div>
                    ...
                    <OutputButton
                        ...
                        style={{
                            color: contentShow ? (scrolling ? '#333' : 'white') : '#333'
                        }}
                    >
                        ￣
                    </OutputButton>
