...
class Poster extends PureComponent {
    ...
    componentDidUpdate(){
        if(this.props.pinCorArr !== null)this.setState({ posterPinCor : this.props.pinCorArr})
    }

    changeOn(diceOn){
        // this.setState({posterPinCor : diceOn})
    }


    render(){
        const posterPinCor = this.state.posterPinCor

        console.log(this.props.pinCorArr)
        console.log(posterPinCor)
            ...
            <>
                <PosterContentDiv>
                    ...
                    <DataMap 
                        ...
                        stroke={true}
                        pointer={false}
                        // diagrma={this.state.posterPinCor}
                    />
                    : 
                    <QuestionDiv>
