...
class MapShow extends PureComponent {
    ...
    componentDidMount(){
        ...
        setTimeout(() => {
            ...
            let num = getRandomIntInclusive(0, 500)
            // let one = this.cor[randomize(arr)]
            // let two = randomize(this.cor)
            // let three = randomize(this.cor)
            // let four = randomize(this.cor)
            // let five = randomize(this.cor)
        console.log(num)
            }, 1000)
    }
