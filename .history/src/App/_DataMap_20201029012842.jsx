                        ...
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                : null}
                                    ...
                                    <g onClick={()=> this.getLocation("Gangchon-2" data-name="Gangchon")} id="Gangchon-2" data-name="Gangchon">
                                    ...
                                    <g onClick={()=> this.getLocation("Yangpyeong-2" data-name="Yangpyeong")} id="Yangpyeong-2" data-name="Yangpyeong">
                                    ...
                                    <g onClick={()=> this.getLocation("Jeongja-2" data-name="Jeongja")} id="Jeongja-2" data-name="Jeongja">
