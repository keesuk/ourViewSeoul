        ...
        return (
                ...
                {stroke ? null :
                    <ExplainDiv>
                        ...
                        <ExplainNumber>
                            {colorList.map(item => <div key={item} style={{color: item}}>{this.state[colorChooser(item)]}%</div>)}
                        </ExplainNumber>
                        <ExplainDiagram>
                            {colorList.map((item, i) => <Diagram color={colorList[i]} size={pxStringfier(this.state[colorChooser(item)])}>{diagramList[i]}</Diagram>)}
                        </ExplainDiagram>
                    </ExplainDiv>
                }
                <TransformWrapper
