...
class Map extends PureComponent {
    ...
    render() {
        const mapList = data.children.map(station => station.attributes.id )
        console.log(mapList)
        // const {match, history} = this.props;
        // const mapList = data.children.map(station => 
        //         <g key={station.attributes.id} >
        //             {station.children.map((child) => {
        //                 return (
        //                     <text transform={child.attributes.transform} className={child.attributes.className}>
