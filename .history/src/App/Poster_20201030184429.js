            ...
            <>
                ...
                <MapExplainWrapperDiv>
                    <MapExplainDiv>
                        ...
                        />
                        <MapShowText>
                            <Rhombus getDown={1} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#e90087'}}>박물관 갤러리</div>
                            <Rectangular getDown={1} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#006CC4'}}>쇼핑 마켓</div>
                            <Circle getDown={1} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#E20000'}}>랜드마크</div>
                            <Triangle getDown={1} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#087A0D'}}>자연 휴양지</div>
                            <Ellipse getDown={1} left={'3px'} right={'0px'} size={'17px'} top={'-4px'}/>
