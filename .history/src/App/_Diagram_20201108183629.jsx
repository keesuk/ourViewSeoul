...
const DiceDiv = styled.div`
    ...
    .front { 
        transform: rotateY(0deg) translateZ(4.4vw);
    ...
    .back { 
        transform: rotateX(180deg) translateZ(4.4vw);
    ...
    .right { 
        transform: rotateY(90deg) translateZ(4.4vw); 
    ...
    .top { 
        transform: rotateX(90deg) translateZ(4.4vw);
