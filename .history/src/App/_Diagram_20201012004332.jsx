    ...
    render() {
        return(
            ...
            <g filter="url(#prefix__filter0_d)" transform="translate(-20 -330)">
                <path
                d="M49.451 276.563H13.146V8.71h233.931v267.853H85.689l-.726 1.225-16.995 28.691-16.345-28.655-.72-1.261h-1.452z"
                stroke="#000"
                strokeWidth={5}
                />
                <path
                d="M10.646 6.21h238.931v272.853H87.114l-19.187 32.39-18.476-32.39H10.646V6.21z"
                fill="#fff"
                />
            </g>
            <defs>
