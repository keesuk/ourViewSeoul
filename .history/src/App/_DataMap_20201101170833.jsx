                        ...
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                ? <g>
                                    ...
                                    <text transform="translate(80 60)" className="st0 green">▲ 자연 휴양지</text>
                                    <text transform="translate(80 100)" className="st0 blue">■ 쇼핑 마켓</text>
                                    <text transform="translate(80 140)" className="st0 red">● 랜드마크</text>
