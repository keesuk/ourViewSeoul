            ...
            <>
                ...
                <MapExplainWrapperDiv>
                    <MapExplainDiv>
                        ...
                        />
                        <MapShowText>
                            <Rhombus on={true} left={'0px'} right={'10px'} size={'23.5px'}/>
                                <div style={{color:'#7B2E8E'}}>박물관 갤러리</div>
                            <Rectangular on={true} left={'0px'} right={'0px'} size={'12px'}/>
                                <div style={{color:'#006CC4'}}>쇼핑 마켓</div>
                            <Circle on={true} left={'0px'} right={'0px'} size={'12.7px'}/>
                                <div style={{color:'#E20000'}}>랜드마크</div>
                            <Triangle on={true} left={'0px'} right={'0px'} size={'19.5px'}/>
                                <div style={{color:'#087A0D'}}>자연 휴양지</div>
                            <Ellipse on={true} left={'0px'} right={'0px'} width={'9px'} height={'15px'}/>
