...
class Map extends PureComponent {
  ...
  render() {
    ...
    <g id="map" key="map">
      ...
      <g id="Jeongwang1" key="Jeongwang1">
      ...
      <g id="Jongno5oga1" key="Jongno5oga1">
      ...
      <g id="Yeouinaru1" key="Yeouinaru1">
