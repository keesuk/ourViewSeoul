...
class Map extends PureComponent {
  ...
  render() {
    ...
    <g id="map" key="mapStation" data="map">
      <g onclick={this.handleClick} id="Ilsan" key="IlsanStation" data="Ilsan">
      ...
      <g onclick={this.handleClick} id="Pungsan" key="PungsanStation" data="Pungsan">
      ...
      <g onclick={this.handleClick} id="Baengma" key="BaengmaStation" data="Baengma">
      ...
      <g onclick={this.handleClick} id="Wondang" key="WondangStation" data="Wondang">
      ...
      <g onclick={this.handleClick} id="Wonheung" key="WonheungStation" data="Wonheung">
      ...
      <g onclick={this.handleClick} id="Samsong" key="SamsongStation" data="Samsong">
      ...
      <g onclick={this.handleClick} id="Tanhyeon" key="TanhyeonStation" data="Tanhyeon">
      ...
      <g onclick={this.handleClick} id="Unjeong" key="UnjeongStation" data="Unjeong">
      ...
      <g onclick={this.handleClick} id="Geumneung" key="GeumneungStation" data="Geumneung">
      ...
      <g onclick={this.handleClick} id="Geumchon" key="GeumchonStation" data="Geumchon">
      ...
      <g onclick={this.handleClick} id="Wollong" key="WollongStation" data="Wollong">
      ...
      <g onclick={this.handleClick} id="Paju" key="PajuStation" data="Paju">
      ...
      <g onclick={this.handleClick} id="Munsan" key="MunsanStation" data="Munsan">
      ...
      <g onclick={this.handleClick} id="Bugae" key="BugaeStation" data="Bugae">
      ...
      <g onclick={this.handleClick} id="Songnae" key="SongnaeStation" data="Songnae">
      ...
      <g onclick={this.handleClick} id="Jungdong" key="JungdongStation" data="Jungdong">
      ...
      <g onclick={this.handleClick} id="Bucheon" key="BucheonStation" data="Bucheon">
      ...
      <g onclick={this.handleClick} id="Sosa" key="SosaStation" data="Sosa">
      ...
      <g onclick={this.handleClick} id="Yeokgok" key="YeokgokStation" data="Yeokgok">
      ...
      <g onclick={this.handleClick} id="Technopark" key="TechnoparkStation" data="Technopark">
      ...
      <g onclick={this.handleClick} id="BITZone" key="BITZoneStation" data="BITZone">
      ...
      <g onclick={this.handleClick} id="IncheonNatlUniv" key="IncheonNatlUnivStation" data="IncheonNatlUniv">
      ...
      <g onclick={this.handleClick} id="CentralPark" key="CentralParkStation" data="CentralPark">
      ...
      <g onclick={this.handleClick} id="IntlBusinessDistrict" key="IntlBusinessDistrictStation" data="IntlBusinessDistrict">
      ...
      <g onclick={this.handleClick} id="Singiloncheon" key="SingiloncheonStation" data="Singiloncheon">
      ...
      <g onclick={this.handleClick} id="Sinchang" key="SinchangStation" data="Sinchang">
      ...
      <g onclick={this.handleClick} id="Onyangoncheon" key="OnyangoncheonStation" data="Onyangoncheon">
      ...
      <g onclick={this.handleClick} id="Baebang" key="BaebangStation" data="Baebang">
      ...
      <g onclick={this.handleClick} id="Asan" key="AsanStation" data="Asan">
      ...
      <g onclick={this.handleClick} id="Ssangyong" key="SsangyongStation" data="Ssangyong">
      ...
      <g onclick={this.handleClick} id="Bongmyeong" key="BongmyeongStation" data="Bongmyeong">
      ...
      <g onclick={this.handleClick} id="Cheonan" key="CheonanStation" data="Cheonan">
      ...
      <g onclick={this.handleClick} id="Dujeong" key="DujeongStation" data="Dujeong">
      ...
      <g onclick={this.handleClick} id="Jiksan" key="JiksanStation" data="Jiksan">
      ...
      <g onclick={this.handleClick} id="Seonghwan" key="SeonghwanStation" data="Seonghwan">
      ...
      <g onclick={this.handleClick} id="Pyeongtaek" key="PyeongtaekStation" data="Pyeongtaek">
      ...
      <g onclick={this.handleClick} id="Jije" key="JijeStation" data="Jije">
      ...
      <g onclick={this.handleClick} id="Seojeongri" key="SeojeongriStation" data="Seojeongri">
      ...
      <g onclick={this.handleClick} id="Songtan" key="SongtanStation" data="Songtan">
      ...
      <g onclick={this.handleClick} id="Osan" key="OsanStation" data="Osan">
      ...
      <g onclick={this.handleClick} id="OsanCollege" key="OsanCollegeStation" data="OsanCollege">
      ...
      <g onclick={this.handleClick} id="Sema" key="SemaStation" data="Sema">
      ...
      <g onclick={this.handleClick} id="Seodongtan" key="SeodongtanStation" data="Seodongtan">
      ...
      <g onclick={this.handleClick} id="Jinwi" key="JinwiStation" data="Jinwi">
      ...
      <g onclick={this.handleClick} id="Ansan" key="AnsanStation" data="Ansan">
      ...
      <g onclick={this.handleClick} id="Choji" key="ChojiStation" data="Choji">
      ...
      <g onclick={this.handleClick} id="Gojan" key="GojanStation" data="Gojan">
      ...
      <g onclick={this.handleClick} id="Jungang" key="JungangStation" data="Jungang">
      ...
      <g onclick={this.handleClick} id="HanyangUnivatAnsan" key="HanyangUnivatAnsanStation" data="HanyangUnivatAnsan">
      ...
      <g onclick={this.handleClick} id="Sangnoksu" key="SangnoksuStation" data="Sangnoksu">
      ...
      <g onclick={this.handleClick} id="Banwol" key="BanwolStation" data="Banwol">
      ...
      <g onclick={this.handleClick} id="Daeyami" key="DaeyamiStation" data="Daeyami">
      ...
      <g onclick={this.handleClick} id="Surisan" key="SurisanStation" data="Surisan">
      ...
      <g onclick={this.handleClick} id="SuwonCityHall1" key="SuwonCityHall1Station" data="SuwonCityHall1">
      ...
      <g onclick={this.handleClick} id="SuwonCityHall" key="SuwonCityHallStation" data="SuwonCityHall">
      ...
      <g onclick={this.handleClick} id="MaetanGwonseon" key="MaetanGwonseonStation" data="MaetanGwonseon">
      ...
      <g onclick={this.handleClick} id="Mangpo" key="MangpoStation" data="Mangpo">
      ...
      <g onclick={this.handleClick} id="Yeongtong" key="YeongtongStation" data="Yeongtong">
      ...
      <g onclick={this.handleClick} id="Cheongmyeong" key="CheongmyeongStation" data="Cheongmyeong">
      ...
      <g onclick={this.handleClick} id="Sanggal" key="SanggalStation" data="Sanggal">
      ...
      <g onclick={this.handleClick} id="Singal" key="SingalStation" data="Singal">
      ...
      <g onclick={this.handleClick} id="Guseong" key="GuseongStation" data="Guseong">
      ...
      <g onclick={this.handleClick} id="Bojeong" key="BojeongStation" data="Bojeong">
      ...
      <g onclick={this.handleClick} id="Jukjeon" key="JukjeonStation" data="Jukjeon">
      ...
      <g onclick={this.handleClick} id="Ori" key="OriStation" data="Ori">
      ...
      <g onclick={this.handleClick} id="MyongjiUniv" key="MyongjiUnivStation" data="MyongjiUniv">
      ...
      <g onclick={this.handleClick} id="Samga1" key="Samga1Station" data="Samga1">
      ...
      <g onclick={this.handleClick} id="Samga" key="SamgaStation" data="Samga">
      ...
      <g onclick={this.handleClick} id="Chodang" key="ChodangStation" data="Chodang">
      ...
      <g onclick={this.handleClick} id="Dongbaek" key="DongbaekStation" data="Dongbaek">
      ...
      <g onclick={this.handleClick} id="Eojeong" key="EojeongStation" data="Eojeong">
      ...
      <g onclick={this.handleClick} id="Jiseok" key="JiseokStation" data="Jiseok">
      ...
      <g onclick={this.handleClick} id="Gulpocheon" key="GulpocheonStation" data="Gulpocheon">
      ...
      <g onclick={this.handleClick} id="SamsanGymnasium" key="SamsanGymnasiumStation" data="SamsanGymnasium">
      ...
      <g onclick={this.handleClick} id="BucheonCityHall" key="BucheonCityHallStation" data="BucheonCityHall">
      ...
      <g onclick={this.handleClick} id="Sinjungdong" key="SinjungdongStation" data="Sinjungdong">
      ...
      <g onclick={this.handleClick} id="Sangdong" key="SangdongStation" data="Sangdong">
      ...
      <g onclick={this.handleClick} id="Jeongwang" key="JeongwangStation" data="Jeongwang">
      ...
      <g onclick={this.handleClick} id="Ungilsan1" key="Ungilsan1Station" data="Ungilsan1">
      ...
      <g onclick={this.handleClick} id="Ungilsan" key="UngilsanStation" data="Ungilsan">
      ...
      <g onclick={this.handleClick} id="Yangsu" key="YangsuStation" data="Yangsu">
      ...
      <g onclick={this.handleClick} id="Sinwon" key="SinwonStation" data="Sinwon">
      ...
      <g onclick={this.handleClick} id="Guksu" key="GuksuStation" data="Guksu">
      ...
      <g onclick={this.handleClick} id="Asin" key="AsinStation" data="Asin">
      ...
      <g onclick={this.handleClick} id="Obin" key="ObinStation" data="Obin">
      ...
      <g onclick={this.handleClick} id="Yangpyeong1" key="Yangpyeong1Station" data="Yangpyeong1">
      ...
      <g onclick={this.handleClick} id="Wondeok" key="WondeokStation" data="Wondeok">
      ...
      <g onclick={this.handleClick} id="Yongmun" key="YongmunStation" data="Yongmun">
      ...
      <g onclick={this.handleClick} id="Paldang" key="PaldangStation" data="Paldang">
      ...
      <g onclick={this.handleClick} id="CampusTown" key="CampusTownStation" data="CampusTown">
      ...
      <g onclick={this.handleClick} id="KangnamUniv" key="KangnamUnivStation" data="KangnamUniv">
      ...
      <g onclick={this.handleClick} id="Sanbon" key="SanbonStation" data="Sanbon">
      ...
      <g onclick={this.handleClick} id="Mullae" key="MullaeStation" data="Mullae">
        <text transform="translate(421.9213 808.1027)" className="st0 st1">문래</text>
      </g>
      <g onclick={this.handleClick} id="Beomgye" key="BeomgyeStation" data="Beomgye">
        <text transform="translate(689.579 1103.5685)" className="st0 st1">범계</text>
      </g>
      <g onclick={this.handleClick} id="Pyeongchon" key="PyeongchonStation" data="Pyeongchon">
        <text transform="translate(689.579 1088.3175)" className="st0 st1">평촌</text>
      </g>
      <g onclick={this.handleClick} id="Indeogwon" key="IndeogwonStation" data="Indeogwon">
        <text transform="translate(689.579 1073.0675)" className="st0 st1">인덕원</text>
      </g>
      <g onclick={this.handleClick} id="GovernmentComplexGwacheon" key="GovernmentComplexGwacheonStation" data="GovernmentComplexGwacheon">
        <text transform="translate(689.579 1057.8116)" className="st0 st1">정부과천청사</text>
      </g>
      <g onclick={this.handleClick} id="Gwacheon" key="GwacheonStation" data="Gwacheon">
        <text transform="translate(689.579 1042.5616)" className="st0 st1">과천</text>
      </g>
      <g onclick={this.handleClick} id="SeoulGrandPark" key="SeoulGrandParkStation" data="SeoulGrandPark">
        <text transform="translate(689.579 1027.3038)" className="st0 st1">대공원</text>
      </g>
      <g onclick={this.handleClick} id="SeoulRacecoursePark" key="SeoulRacecourseParkStation" data="SeoulRacecoursePark">
        <text transform="translate(689.579 1012.0548)" className="st0 st1">경마공원</text>
      </g>
      <g onclick={this.handleClick} id="Seonbawi" key="SeonbawiStation" data="Seonbawi">
        <text transform="translate(689.579 996.8038)" className="st0 st1">선바위</text>
      </g>
      <g onclick={this.handleClick} id="Namtaeryeong" key="NamtaeryeongStation" data="Namtaeryeong">
        <text transform="translate(689.579 981.547)" className="st0 st1">남태령</text>
      </g>
      <g onclick={this.handleClick} id="Geomam" key="GeomamStation" data="Geomam">
        <text transform="translate(74.4359 557.6925)" className="st0 st1">검암</text>
      </g>
      <g onclick={this.handleClick} id="Gyulhyeon" key="GyulhyeonStation" data="Gyulhyeon">
        <text transform="translate(74.4359 626.3771)" className="st0 st1">귤현</text>
      </g>
      <g onclick={this.handleClick} id="Bakchon" key="BakchonStation" data="Bakchon">
        <text transform="translate(74.4359 659.2882)" className="st0 st1">박촌</text>
      </g>
      <g onclick={this.handleClick} id="Imhak" key="ImhakStation" data="Imhak">
        <text transform="translate(74.4359 692.1993)" className="st0 st1">임학</text>
      </g>
      <g onclick={this.handleClick} id="Gyesan" key="GyesanStation" data="Gyesan">
        <text transform="translate(74.4359 725.1183)" className="st0 st1">계산</text>
      </g>
      <g onclick={this.handleClick} id="GyeonginNatlUnivofEducation" key="GyeonginNatlUnivofEducationStation" data="GyeonginNatlUnivofEducation">
        <text transform="translate(74.4359 758.0304)" className="st0 st1">경인교대입구</text>
      </g>
      <g onclick={this.handleClick} id="CheongnaIntlCityStation" key="CheongnaIntlCityStationStation" data="CheongnaIntlCityStation">
        <text transform="translate(75.9447 539.4855)" className="st0 st1">청라국제도시</text>
      </g>
      <g onclick={this.handleClick} id="Yongmasan" key="YongmasanStation" data="Yongmasan">
        <text transform="translate(999.2616 602.9288)" className="st0 st1">용마산</text>
      </g>
      <g onclick={this.handleClick} id="Sagajeong" key="SagajeongStation" data="Sagajeong">
        <text transform="translate(999.2616 576.5245)" className="st0 st1">사가정</text>
      </g>
      <g onclick={this.handleClick} id="Myeonmok" key="MyeonmokStation" data="Myeonmok">
        <text transform="translate(999.2616 547.546)" className="st0 st1">면목</text>
      </g>
      <g onclick={this.handleClick} id="Jungnang" key="JungnangStation" data="Jungnang">
        <text transform="translate(952.6971 533.172)" className="st0 st1">중랑</text>
      </g>
      <g onclick={this.handleClick} id="Sinnae" key="SinnaeStation" data="Sinnae">
        <text transform="translate(1045.7147 457.4913)" className="st0 st1">신내</text>
      </g>
      <g onclick={this.handleClick} id="Changsin" key="ChangsinStation" data="Changsin">
        <text transform="translate(786.6542 581.3898)" className="st0 st1">창신</text>
      </g>
      <g onclick={this.handleClick} id="Apgujeong" key="ApgujeongStation" data="Apgujeong">
        <text transform="translate(798.9677 779.5177)" className="st0 st1">압구정</text>
      </g>
      <g onclick={this.handleClick} id="Saejeol" key="SaejeolStation" data="Saejeol">
        <text transform="translate(487.3246 536.0724)" className="st0 st1">새절</text>
      </g>
      <g onclick={this.handleClick} id="Eungam" key="EungamStation" data="Eungam">
        <text transform="translate(487.3246 509.6984)" className="st0 st1">응암</text>
      </g>
      <g onclick={this.handleClick} id="Gupabal" key="GupabalStation" data="Gupabal">
        <text transform="translate(503.6517 366.7472)" className="st0 st1">구파발</text>
      </g>
      <g onclick={this.handleClick} id="SookmyungWomensUniv" key="SookmyungWomensUnivStation" data="SookmyungWomensUniv">
        <text transform="translate(662.0165 707.6759)" className="st0 st1">숙대입구</text>
      </g>
      <g onclick={this.handleClick} id="Namyeong" key="NamyeongStation" data="Namyeong">
        <text transform="translate(657.6512 724.6798)" className="st0 st1">남영</text>
      </g>
      <g onclick={this.handleClick} id="Seryu" key="SeryuStation" data="Seryu">
        <text transform="translate(790.1747 1155.4816)" className="st0 st1">세류</text>
      </g>
      <g onclick={this.handleClick} id="GachonUniv" key="GachonUnivStation" data="GachonUniv">
        <text transform="translate(1084.0741 1012.7999)" className="st0 st1">가천대</text>
      </g>
      <g onclick={this.handleClick} id="Jangji" key="JangjiStation" data="Jangji">
        <text transform="translate(1114.5497 957.3292)" className="st0 st1">장지</text>
      </g>
      <g onclick={this.handleClick} id="Dandaeogeori" key="DandaeogeoriStation" data="Dandaeogeori">
        <text transform="translate(1144.9891 1032.671)" className="st0 st1">단대오거리</text>
      </g>
      <g onclick={this.handleClick} id="Taepyeong" key="TaepyeongStation" data="Taepyeong">
        <text transform="translate(1089.6171 1036.5177)" className="st0 st1">태평</text>
      </g>
      <g onclick={this.handleClick} id="Banghak" key="BanghakStation" data="Banghak">
        <text transform="translate(861.9227 253.8585)" className="st0 st1">방학</text>
      </g>
      <g onclick={this.handleClick} id="Dobong" key="DobongStation" data="Dobong">
        <text transform="translate(862.0604 209.5226)" className="st0 st1">도봉</text>
      </g>
      <g onclick={this.handleClick} id="Dokbawi" key="DokbawiStation" data="Dokbawi">
        <text transform="translate(547.1039 434.4816)" className="st0 st1">독바위</text>
      </g>
      <g onclick={this.handleClick} id="Sinheung" key="SinheungStation" data="Sinheung">
        <text transform="translate(1144.5682 1052.2491)" className="st0 st1">신흥</text>
      </g>
      <g onclick={this.handleClick} id="Geumho" key="GeumhoStation" data="Geumho">
        <text transform="translate(789.7303 696.9347)" className="st0 st1">금호</text>
      </g>
      <g onclick={this.handleClick} id="Hyehwa" key="HyehwaStation" data="Hyehwa">
        <text transform="translate(744.8182 571.2072)" className="st0 st1">혜화</text>
      </g>
      <g onclick={this.handleClick} id="Achasan" key="AchasanStation" data="Achasan">
        <text transform="translate(1007.2538 683.2189)" className="st0 st1">아차산</text>
      </g>
      <g onclick={this.handleClick} id="Jichuk" key="JichukStation" data="Jichuk">
        <text transform="translate(503.5902 339.8673)" className="st0 st1">지축</text>
      </g>
      <g onclick={this.handleClick} id="Gusan" key="GusanStation" data="Gusan">
        <text transform="translate(487.3314 461.13)" className="st0 st1">구산</text>
      </g>
      <g onclick={this.handleClick} id="Munjeong" key="MunjeongStation" data="Munjeong">
        <text transform="translate(1114.5575 926.8282)" className="st0 st1">문정</text>
      </g>
      <g onclick={this.handleClick} id="Mangwolsa" key="MangwolsaStation" data="Mangwolsa">
        <text transform="translate(880.5663 83.1691)" className="st0 st1">망월사</text>
      </g>
      <g onclick={this.handleClick} id="NamdongInduspark" key="NamdongIndusparkStation" data="NamdongInduspark">
      ...
      <g onclick={this.handleClick} id="Hogupo" key="HogupoStation" data="Hogupo">
        <text transform="translate(258.9594 1085.7189)" className="st0 st1">호구포</text>
      </g>
      <g onclick={this.handleClick} id="IncheonNonhyeon" key="IncheonNonhyeonStation" data="IncheonNonhyeon">
        <text transform="translate(290.5687 1085.7189)" className="st0 st1">인천논현</text>
      </g>
      <g onclick={this.handleClick} id="Gwanak" key="GwanakStation" data="Gwanak">
        <text transform="translate(499.1869 1111.7286)" className="st0 st1">관악</text>
      </g>
      <g onclick={this.handleClick} id="Anyang" key="AnyangStation" data="Anyang">
        <text transform="translate(559.2426 1111.7286)" className="st0 st1">안양</text>
      </g>
      <g onclick={this.handleClick} id="Myeonghak" key="MyeonghakStation" data="Myeonghak">
        <text transform="translate(619.598 1111.7286)" className="st0 st1">명학</text>
      </g>
      <g onclick={this.handleClick} id="Gunpo" key="GunpoStation" data="Gunpo">
        <text transform="translate(700.3573 1111.7286)" className="st0 st1">군포</text>
      </g>
      <g onclick={this.handleClick} id="Dangjeong" key="DangjeongStation" data="Dangjeong">
        <text transform="translate(720.6688 1111.7286)" className="st0 st1">당정</text>
      </g>
      <g onclick={this.handleClick} id="Uiwang" key="UiwangStation" data="Uiwang">
        <text transform="translate(740.9227 1111.7286)" className="st0 st1">의왕</text>
      </g>
      <g onclick={this.handleClick} id="SungkyunkwanUniv" key="SungkyunkwanUnivStation" data="SungkyunkwanUniv">
        <text transform="translate(755.7469 1111.7286)" className="st0 st1">성균관대</text>
      </g>
      <g onclick={this.handleClick} id="Sindaebang" key="SindaebangStation" data="Sindaebang">
        <text transform="translate(470.9662 936.3361)" className="st0 st1">신대방</text>
      </g>
      <g onclick={this.handleClick} id="Bongcheon" key="BongcheonStation" data="Bongcheon">
        <text transform="translate(555.9603 938.84)" className="st0 st1">봉천</text>
      </g>
      <g onclick={this.handleClick} id="Euljiro1ilga" key="Euljiro1ilgaStation" data="Euljiro1ilga">
        <text transform="translate(671.5243 639.88)" className="st0 st1">을지로입구</text>
      </g>
      <g onclick={this.handleClick} id="Jongno5oga" key="Jongno5ogaStation" data="Jongno5oga">
      ...
      <g onclick={this.handleClick} id="Daebang" key="DaebangStation" data="Daebang">
        <text transform="translate(512.4271 830.09)" className="st0 st1">대방</text>
      </g>
      <g onclick={this.handleClick} id="Sinpung" key="SinpungStation" data="Sinpung">
        <text transform="translate(459.8558 883.8019)" className="st0 st1">신풍</text>
      </g>
      <g onclick={this.handleClick} id="Namguro" key="NamguroStation" data="Namguro">
        <text transform="translate(384.9515 922.6007)" className="st0 st1">남구로</text>
      </g>
      <g onclick={this.handleClick} id="Boramae" key="BoramaeStation" data="Boramae">
        <text transform="translate(490.9633 883.6583)" className="st0 st1">보라매</text>
      </g>
      <g onclick={this.handleClick} id="YangcheonHyanggyo" key="YangcheonHyanggyoStation" data="YangcheonHyanggyo">
        <text transform="translate(258.7406 614.8595)" className="st0 st1">양천향교</text>
      </g>
      <g onclick={this.handleClick} id="Magongnaru" key="MagongnaruStation" data="Magongnaru">
        <text transform="translate(214.4369 614.8595)" className="st0 st1">마곡나루</text>
      </g>
      <g onclick={this.handleClick} id="Sinbanghwa" key="SinbanghwaStation" data="Sinbanghwa">
        <text transform="translate(187.6635 614.8654)" className="st0 st1">신방화</text>
      </g>
      <g onclick={this.handleClick} id="IncheonIntlAirportCargoTerminal1" key="IncheonIntlAirportCargoTerminal1Station" data="IncheonIntlAirportCargoTerminal1">
        <text transform="translate(138.6185 523.8781)" className="st0 st1">인천국제공항</text>
      </g>
      <g onclick={this.handleClick} id="IncheonIntlAirportCargoTerminal" key="IncheonIntlAirportCargoTerminalStation" data="IncheonIntlAirportCargoTerminal">
      ...
      <g onclick={this.handleClick} id="Songjeong" key="SongjeongStation" data="Songjeong">
        <text transform="translate(177.6615 651.3849)" className="st0 st1">송정</text>
      </g>
      <g onclick={this.handleClick} id="Magok" key="MagokStation" data="Magok">
        <text transform="translate(211.1859 651.3849)" className="st0 st1">마곡</text>
      </g>
      <g onclick={this.handleClick} id="Sinjeong" key="SinjeongStation" data="Sinjeong">
        <text transform="translate(304.0209 776.3175)" className="st0 st1">신정</text>
      </g>
      <g onclick={this.handleClick} id="Mokdong" key="MokdongStation" data="Mokdong">
        <text transform="translate(328.5228 776.3175)" className="st0 st1">목동</text>
      </g>
      <g onclick={this.handleClick} id="Omokgyo" key="OmokgyoStation" data="Omokgyo">
        <text transform="translate(357.6205 776.3175)" className="st0 st1">오목교</text>
      </g>
      <g onclick={this.handleClick} id="Yangpyeong" key="YangpyeongStation" data="Yangpyeong">
        <text transform="translate(391.1205 776.3175)" className="st0 st1">양평</text>
      </g>
      <g onclick={this.handleClick} id="Gwanghwamun" key="GwanghwamunStation" data="Gwanghwamun">
        <text transform="translate(658.2391 601.0743)" className="st0 st1">광화문</text>
      </g>
      <g onclick={this.handleClick} id="Itaewon" key="ItaewonStation" data="Itaewon">
        <text transform="translate(712.5272 752.3615)" className="st0 st1">이태원</text>
      </g>
      <g onclick={this.handleClick} id="Noksapyeong" key="NoksapyeongStation" data="Noksapyeong">
        <text transform="translate(688.8143 752.3927)" className="st0 st1">녹사평</text>
      </g>
      <g onclick={this.handleClick} id="Seobinggo" key="SeobinggoStation" data="Seobinggo">
        <text transform="translate(692.8485 808.8419)" className="st0 st1">서빙고</text>
      </g>
      <g onclick={this.handleClick} id="Gwangheungchang" key="GwangheungchangStation" data="Gwangheungchang">
        <text transform="translate(526.0931 706.4865)" className="st0 st1">광흥창</text>
      </g>
      <g onclick={this.handleClick} id="Sangsu" key="SangsuStation" data="Sangsu">
        <text transform="translate(502.5941 706.4865)" className="st0 st1">상수</text>
      </g>
      <g onclick={this.handleClick} id="Baekseok" key="BaekseokStation" data="Baekseok">
        <text transform="translate(396.8383 337.1681)" className="st0 st1">백석</text>
      </g>
      <g onclick={this.handleClick} id="Gyeongbokgung" key="GyeongbokgungStation" data="Gyeongbokgung">
        <text transform="translate(650.2665 584.1642)" className="st0 st1">경복궁</text>
      </g>
      <g onclick={this.handleClick} id="Anguk" key="AngukStation" data="Anguk">
        <text transform="translate(688.5907 584.1466)" className="st0 st1">안국</text>
      </g>
      <g onclick={this.handleClick} id="Myeongdong" key="MyeongdongStation" data="Myeongdong">
        <text transform="translate(690.7069 655.4435)" className="st0 st1">명동</text>
      </g>
      <g onclick={this.handleClick} id="LrtUijeongbu" key="LrtUijeongbuStation" data="LrtUijeongbu">
      ...
      <g onclick={this.handleClick} id="Beomgol" key="BeomgolStation" data="Beomgol">
        <text transform="translate(794.1708 76.173)" className="st0 st1">범골</text>
      </g>
      <g onclick={this.handleClick} id="EwhaWomansUniv" key="EwhaWomansUnivStation" data="EwhaWomansUniv">
        <text transform="translate(570.973 668.4698)" className="st0 st1">이대</text>
      </g>
      <g onclick={this.handleClick} id="Sinchon" key="SinchonStation" data="Sinchon">
        <text transform="translate(545.3705 668.4698)" className="st0 st1">신촌</text>
      </g>
      <g onclick={this.handleClick} id="SeoulNatlUniv" key="SeoulNatlUnivStation" data="SeoulNatlUniv">
        <text transform="translate(580.7113 938.84)" className="st0 st1">서울대입구</text>
      </g>
      <g onclick={this.handleClick} id="SportsComplex" key="SportsComplexStation" data="SportsComplex">
        <text transform="translate(940.2528 837.0118)" className="st0 st1">종합운동장</text>
      </g>
      <g onclick={this.handleClick} id="Sincheon" key="SincheonStation" data="Sincheon">
        <text transform="translate(984.3182 837.0118)" className="st0 st1">신천</text>
      </g>
      <g onclick={this.handleClick} id="Guui" key="GuuiStation" data="Guui">
        <text transform="translate(986.1659 730.9562)" className="st0 st1">구의</text>
      </g>
      <g onclick={this.handleClick} id="Yongdu" key="YongduStation" data="Yongdu">
        <text transform="translate(854.2069 598.9894)" className="st0 st1">용두</text>
      </g>
      <g onclick={this.handleClick} id="Sangwangsimni" key="SangwangsimniStation" data="Sangwangsimni">
        <text transform="translate(811.2499 625.713)" className="st0 st1">상왕십리</text>
      </g>
      <g onclick={this.handleClick} id="Baegun" key="BaegunStation" data="Baegun">
        <text transform="translate(93.6683 908.3273)" className="st0 st1">백운</text>
      </g>
      <g onclick={this.handleClick} id="Anam" key="AnamStation" data="Anam">
        <text transform="translate(817.7626 562.1447)" className="st0 st1">안암</text>
      </g>
      <g onclick={this.handleClick} id="Bomun" key="BomunStation" data="Bomun">
        <text transform="translate(788.6659 562.1447)" className="st0 st1">보문</text>
      </g>
      <g onclick={this.handleClick} id="Sujin" key="SujinStation" data="Sujin">
        <text transform="translate(1117.7938 1067.3058)" className="st0 st1">수진</text>
      </g>
      <g onclick={this.handleClick} id="DonggukUniv" key="DonggukUnivStation" data="DonggukUniv">
        <text transform="translate(740.4032 660.8849)" className="st0 st1">동대입구</text>
      </g>
      <g onclick={this.handleClick} id="Unseo" key="UnseoStation" data="Unseo">
        <text transform="translate(93.0424 523.8722)" className="st0 st1">운서</text>
      </g>
      <g onclick={this.handleClick} id="Balgok" key="BalgokStation" data="Balgok">
        <text transform="translate(834.3466 90.2462)" className="st0 st1">발곡</text>
      </g>
      <g onclick={this.handleClick} id="YangcheonguOffice" key="YangcheonguOfficeStation" data="YangcheonguOffice">
        <text transform="translate(334.5287 832.7032)" className="st0 st1">양천구청</text>
      </g>
      <g onclick={this.handleClick} id="Oryudong" key="OryudongStation" data="Oryudong">
        <text transform="translate(273.8597 904.9142)" className="st0 st1">오류동</text>
      </g>
      <g onclick={this.handleClick} id="Gaebong" key="GaebongStation" data="Gaebong">
        <text transform="translate(308.5941 890.5294)" className="st0 st1">개봉</text>
      </g>
      <g onclick={this.handleClick} id="Guil" key="GuilStation" data="Guil">
        <text transform="translate(343.3285 876.1427)" className="st0 st1">구일</text>
      </g>
      <g onclick={this.handleClick} id="Yeongdeungpo" key="YeongdeungpoStation" data="Yeongdeungpo">
        <text transform="translate(461.0404 827.3663)" className="st0 st1">영등포</text>
      </g>
      <g onclick={this.handleClick} id="Nakseongdae" key="NakseongdaeStation" data="Nakseongdae">
        <text transform="translate(626.4066 952.9073)" className="st0 st1">낙성대</text>
      </g>
      <g onclick={this.handleClick} id="Jangseungbaegi" key="JangseungbaegiStation" data="Jangseungbaegi">
        <text transform="translate(536.3138 855.7374)" className="st0 st1">장승배기</text>
      </g>
      <g onclick={this.handleClick} id="Seocho" key="SeochoStation" data="Seocho">
        <text transform="translate(750.3729 914.8907)" className="st0 st1">서초</text>
      </g>
      <g onclick={this.handleClick} id="Yeoksam" key="YeoksamStation" data="Yeoksam">
        <text transform="translate(841.0106 877.3517)" className="st0 st1">역삼</text>
      </g>
      <g onclick={this.handleClick} id="Samseong" key="SamseongStation" data="Samseong">
        <text transform="translate(918.3514 845.3156)" className="st0 st1">삼성</text>
      </g>
      <g onclick={this.handleClick} id="Naebang" key="NaebangStation" data="Naebang">
        <text transform="translate(707.8348 915.2042)" className="st0 st1">내방</text>
      </g>
      <g onclick={this.handleClick} id="Maebong" key="MaebongStation" data="Maebong">
        <text transform="translate(866.4755 918.6427)" className="st0 st1">매봉</text>
      </g>
      <g onclick={this.handleClick} id="Daechi" key="DaechiStation" data="Daechi">
        <text transform="translate(917.5995 897.4679)" className="st0 st1">대치</text>
      </g>
      <g onclick={this.handleClick} id="Hangnyeoul" key="HangnyeoulStation" data="Hangnyeoul">
        <text transform="translate(933.3632 888.6437)" className="st0 st1">학여울</text>
      </g>
      <g onclick={this.handleClick} id="Gaepodong" key="GaepodongStation" data="Gaepodong">
        <text transform="translate(930.5643 924.6866)" className="st0 st1">개포동</text>
      </g>
      <g onclick={this.handleClick} id="Banpo" key="BanpoStation" data="Banpo">
        <text transform="translate(763.3944 841.714)" className="st0 st1">반포</text>
      </g>
      <g onclick={this.handleClick} id="Nonhyeon" key="NonhyeonStation" data="Nonhyeon">
        <text transform="translate(792.5858 830.3976)" className="st0 st1">논현</text>
      </g>
      <g onclick={this.handleClick} id="Sinnonhyeon" key="SinnonhyeonStation" data="Sinnonhyeon">
        <text transform="translate(807.8163 865.4386)" className="st0 st1">신논현</text>
      </g>
      <g onclick={this.handleClick} id="Sinbanpo" key="SinbanpoStation" data="Sinbanpo">
        <text transform="translate(723.537 873.8068)" className="st0 st1">신반포</text>
      </g>
      <g onclick={this.handleClick} id="Gubanpo" key="GubanpoStation" data="Gubanpo">
        <text transform="translate(697.9911 884.3849)" className="st0 st1">구반포</text>
      </g>
      <g onclick={this.handleClick} id="Hakdong" key="HakdongStation" data="Hakdong">
        <text transform="translate(821.8788 819.0372)" className="st0 st1">학동</text>
      </g>
      <g onclick={this.handleClick} id="Sinsa" key="SinsaStation" data="Sinsa">
        <text transform="translate(788.1005 807.3068)" className="st0 st1">신사</text>
      </g>
      <g onclick={this.handleClick} id="Jamwon" key="JamwonStation" data="Jamwon">
        <text transform="translate(760.9706 818.6056)" className="st0 st1">잠원</text>
      </g>
      <g onclick={this.handleClick} id="Ssangmun" key="SsangmunStation" data="Ssangmun">
        <text transform="translate(837.9159 328.844)" className="st0 st1">쌍문</text>
      </g>
      <g onclick={this.handleClick} id="Sanggye" key="SanggyeStation" data="Sanggye">
        <text transform="translate(951.1698 281.9347)" className="st0 st1">상계</text>
      </g>
      <g onclick={this.handleClick} id="Dolgoji" key="DolgojiStation" data="Dolgoji">
        <text transform="translate(891.8915 461.8497)" className="st0 st1">돌곶이</text>
      </g>
      <g onclick={this.handleClick} id="Sangwolgok" key="SangwolgokStation" data="Sangwolgok">
        <text transform="translate(866.8143 472.2335)" className="st0 st1">상월곡</text>
      </g>
      <g onclick={this.handleClick} id="Cheonwang" key="CheonwangStation" data="Cheonwang">
        <text transform="translate(249.766 921.631)" className="st0 st1">천왕</text>
      </g>
      <g onclick={this.handleClick} id="Gwangmyeongsageori" key="GwangmyeongsageoriStation" data="Gwangmyeongsageori">
        <text transform="translate(293.5443 939.7677)" className="st0 st1">광명사거리</text>
      </g>
      <g onclick={this.handleClick} id="Cheolsan" key="CheolsanStation" data="Cheolsan">
        <text transform="translate(337.347 957.9113)" className="st0 st1">철산</text>
      </g>
      <g onclick={this.handleClick} id="Dapsimni" key="DapsimniStation" data="Dapsimni">
        <text transform="translate(891.2655 617.3282)" className="st0 st1">답십리</text>
      </g>
      <g onclick={this.handleClick} id="Janghanpyeong" key="JanghanpyeongStation" data="Janghanpyeong">
        <text transform="translate(927.871 632.5148)" className="st0 st1">장한평</text>
      </g>
      <g onclick={this.handleClick} id="Gwangnaru" key="GwangnaruStation" data="Gwangnaru">
        <text transform="translate(1041.4052 700.6486)" className="st0 st1">광나루</text>
      </g>
      <g onclick={this.handleClick} id="Heukseok" key="HeukseokStation" data="Heukseok">
        <text transform="translate(614.0482 858.0861)" className="st0 st1">흑석</text>
      </g>
      <g onclick={this.handleClick} id="Nodeul" key="NodeulStation" data="Nodeul">
        <text transform="translate(584.6439 845.9044)" className="st0 st1">노들</text>
      </g>
      <g onclick={this.handleClick} id="YeongdeungpoMarket" key="YeongdeungpoMarketStation" data="YeongdeungpoMarket">
        <text transform="translate(450.4623 786.9825)" className="st0 st1">영등포시장</text>
      </g>
      <g onclick={this.handleClick} id="Cheonggyesan" key="CheonggyesanStation" data="Cheonggyesan">
        <text transform="translate(896.7645 1058.3624)" className="st0 st1">청계산입구</text>
      </g>
      <g onclick={this.handleClick} id="Pangyo" key="PangyoStation" data="Pangyo">
        <text transform="translate(1013.1346 1106.5685)" className="st0 st1">판교</text>
      </g>
      <g onclick={this.handleClick} id="Geoyeo" key="GeoyeoStation" data="Geoyeo">
      ...
      <g onclick={this.handleClick} id="Jegidong" key="JegidongStation" data="Jegidong">
        <text transform="translate(826.6044 581.4777)" className="st0 st1">제기동</text>
      </g>
      <g onclick={this.handleClick} id="Hwarangdae" key="HwarangdaeStation" data="Hwarangdae">
        <text transform="translate(969.8944 429.5343)" className="st0 st1">화랑대</text>
      </g>
      <g onclick={this.handleClick} id="Gaehwa" key="GaehwaStation" data="Gaehwa">
        <text transform="translate(134.14 583.5577)" className="st0 st1">개화</text>
      </g>
      <g onclick={this.handleClick} id="Daemosan" key="DaemosanStation" data="Daemosan">
        <text transform="translate(948.701 917.171)" className="st0 st1">대모산입구</text>
      </g>
      <g onclick={this.handleClick} id="Namhansanseong" key="NamhansanseongStation" data="Namhansanseong">
        <text transform="translate(1129.3563 1006.9806)" className="st0 st1">남한산성입구</text>
      </g>
      <g onclick={this.handleClick} id="Sanseong" key="SanseongStation" data="Sanseong">
        <text transform="translate(1112.1952 999.3146)" className="st0 st1">산성</text>
      </g>
      <g onclick={this.handleClick} id="Godeok" key="GodeokStation" data="Godeok">
        <text transform="translate(1189.4667 675.1017)" className="st0 st1">고덕</text>
      </g>
      <g onclick={this.handleClick} id="Sangildong" key="SangildongStation" data="Sangildong">
        <text transform="translate(1223.0487 661.1915)" className="st0 st1">상일동</text>
      </g>
      <g onclick={this.handleClick} id="Bangbae" key="BangbaeStation" data="Bangbae">
        <text transform="translate(726.4237 955.3624)" className="st0 st1">방배</text>
      </g>
      <g onclick={this.handleClick} id="Sindaebangsamgeori" key="SindaebangsamgeoriStation" data="Sindaebangsamgeori">
        <text transform="translate(520.8383 882.881)" className="st0 st1">신대방삼거리</text>
      </g>
      <g onclick={this.handleClick} id="Cheongdam" key="CheongdamStation" data="Cheongdam">
        <text transform="translate(880.7245 796.1652)" className="st0 st1">청담</text>
      </g>
      <g onclick={this.handleClick} id="Guryong" key="GuryongStation" data="Guryong">
        <text transform="translate(908.663 932.1075)" className="st0 st1">구룡</text>
      </g>
      <g onclick={this.handleClick} id="Sapyeong" key="SapyeongStation" data="Sapyeong">
        <text transform="translate(771.16 866.7296)" className="st0 st1">사평</text>
      </g>
      <g onclick={this.handleClick} id="Daeheung" key="DaeheungStation" data="Daeheung">
        <text transform="translate(552.9603 710.6827)" className="st0 st1">대흥</text>
      </g>
      <g onclick={this.handleClick} id="Hyochangpark" key="HyochangparkStation" data="Hyochangpark">
        <text transform="translate(619.6166 721.6671)" className="st0 st1">효창공원앞</text>
      </g>
      <g onclick={this.handleClick} id="Hoehyeon" key="HoehyeonStation" data="Hoehyeon">
        <text transform="translate(668.2919 662.4005)" className="st0 st1">회현</text>
      </g>
      <g onclick={this.handleClick} id="Ahyeon" key="AhyeonStation" data="Ahyeon">
        <text transform="translate(603.4515 666.7609)" className="st0 st1">아현</text>
      </g>
      <g onclick={this.handleClick} id="Ttukseom" key="TtukseomStation" data="Ttukseom">
        <text transform="translate(872.4559 695.8458)" className="st0 st1">뚝섬</text>
      </g>
      <g onclick={this.handleClick} id="HanyangUniv" key="HanyangUnivStation" data="HanyangUniv">
        <text transform="translate(870.9344 665.6212)" className="st0 st1">한양대</text>
      </g>
      <g onclick={this.handleClick} id="Seonyudo" key="SeonyudoStation" data="Seonyudo">
        <text transform="translate(420.4056 723.2706)" className="st0 st1">선유도</text>
      </g>
      <g onclick={this.handleClick} id="Bonghwasan" key="BonghwasanStation" data="Bonghwasan">
        <text transform="translate(1004.6229 435.257)" className="st0 st1">봉화산</text>
      </g>
      <g onclick={this.handleClick} id="HankukUnivofForeignStudies" key="HankukUnivofForeignStudiesStation" data="HankukUnivofForeignStudies">
        <text transform="translate(893.3124 517.6534)" className="st0 st1">외대앞</text>
      </g>
      <g onclick={this.handleClick} id="HansungUniv" key="HansungUnivStation" data="HansungUniv">
        <text transform="translate(755.1346 544.089)" className="st0 st1">한성대입구</text>
      </g>
      <g onclick={this.handleClick} id="SungshinWomensUniv" key="SungshinWomensUnivStation" data="SungshinWomensUniv">
        <text transform="translate(780.286 518.923)" className="st0 st1">성신여대입구</text>
      </g>
      <g onclick={this.handleClick} id="Gireum" key="GireumStation" data="Gireum">
        <text transform="translate(809.5702 489.632)" className="st0 st1">길음</text>
      </g>
      <g onclick={this.handleClick} id="Uijeongbu" key="UijeongbuStation" data="Uijeongbu">
        <text transform="translate(810.5536 96.9786)" className="st0 st1">의정부</text>
      </g>
      <g onclick={this.handleClick} id="Ganeung" key="GaneungStation" data="Ganeung">
        <text transform="translate(799.1678 108.3645)" className="st0 st1">가능</text>
      </g>
      <g onclick={this.handleClick} id="Nogyang" key="NogyangStation" data="Nogyang">
        <text transform="translate(787.7821 119.7511)" className="st0 st1">녹양</text>
      </g>
      <g onclick={this.handleClick} id="Yangju" key="YangjuStation" data="Yangju">
        <text transform="translate(776.3964 131.1368)" className="st0 st1">양주</text>
      </g>
      <g onclick={this.handleClick} id="Deokgye" key="DeokgyeStation" data="Deokgye">
        <text transform="translate(765.0106 142.5226)" className="st0 st1">덕계</text>
      </g>
      <g onclick={this.handleClick} id="Deokjeong" key="DeokjeongStation" data="Deokjeong">
        <text transform="translate(753.6249 153.9083)" className="st0 st1">덕정</text>
      </g>
      <g onclick={this.handleClick} id="Jihaeng" key="JihaengStation" data="Jihaeng">
        <text transform="translate(742.2382 165.2941)" className="st0 st1">지행</text>
      </g>
      <g onclick={this.handleClick} id="Dongducheonjungang" key="DongducheonjungangStation" data="Dongducheonjungang">
        <text transform="translate(730.8524 176.6798)" className="st0 st1">동두천중앙</text>
      </g>
      <g onclick={this.handleClick} id="Bosan" key="BosanStation" data="Bosan">
        <text transform="translate(719.4667 188.0656)" className="st0 st1">보산</text>
      </g>
      <g onclick={this.handleClick} id="Dongducheon" key="DongducheonStation" data="Dongducheon">
        <text transform="translate(708.08 199.4513)" className="st0 st1">동두천</text>
      </g>
      <g onclick={this.handleClick} id="Soyosan" key="SoyosanStation" data="Soyosan">
        <text transform="translate(695.1903 210.837)" className="st0 st1">소요산</text>
      </g>
      <g onclick={this.handleClick} id="Tapseok" key="TapseokStation" data="Tapseok">
        <text transform="translate(642.1503 210.5558)" className="st0 st1">탑석</text>
      </g>
      <g onclick={this.handleClick} id="Songsan" key="SongsanStation" data="Songsan">
        <text transform="translate(654.5829 198.1241)" className="st0 st1">송산</text>
      </g>
      <g onclick={this.handleClick} id="eoryong" key="eoryongStation" data="eoryong">
        <text transform="translate(667.0145 185.6925)" className="st0 st1">어룡</text>
      </g>
      <g onclick={this.handleClick} id="gonjae" key="gonjaeStation" data="gonjae">
        <text transform="translate(679.4452 173.2609)" className="st0 st1">곤제</text>
      </g>
      <g onclick={this.handleClick} id="hyoja" key="hyojaStation" data="hyoja">
        <text transform="translate(691.8778 160.8282)" className="st0 st1">효자</text>
      </g>
      <g onclick={this.handleClick} id="GyeonggiProvincialGovernmentNorthernOffice" key="GyeonggiProvincialGovernmentNorthernOfficeStation" data="GyeonggiProvincialGovernmentNorthernOffice">
      ...
      <g onclick={this.handleClick} id="saemal" key="saemalStation" data="saemal">
        <text transform="translate(716.7352 135.965)" className="st0 st1">새말</text>
      </g>
      <g onclick={this.handleClick} id="Dongo" key="DongoStation" data="Dongo">
        <text transform="translate(729.1669 123.5392)" className="st0 st1">동오</text>
      </g>
      <g onclick={this.handleClick} id="UijeongbuJungang" key="UijeongbuJungangStation" data="UijeongbuJungang">
        <text transform="translate(741.5995 111.1075)" className="st0 st1">의정부중앙</text>
      </g>
      <g onclick={this.handleClick} id="Heungseon" key="HeungseonStation" data="Heungseon">
        <text transform="translate(754.0321 98.6749)" className="st0 st1">흥선</text>
      </g>
      <g onclick={this.handleClick} id="UijeongbuCityHall" key="UijeongbuCityHallStation" data="UijeongbuCityHall">
        <text transform="translate(763.5253 89.8507)" className="st0 st1">의정부시청</text>
      </g>
      <g onclick={this.handleClick} id="Yatap" key="YatapStation" data="Yatap">
        <text transform="translate(1094.1073 1077.0128)" className="st0 st1">야탑</text>
      </g>
      <g onclick={this.handleClick} id="Imae" key="ImaeStation" data="Imae">
        <text transform="translate(1082.1708 1088.9445)" className="st0 st1">이매</text>
      </g>
      <g onclick={this.handleClick} id="Dunjeon" key="DunjeonStation" data="Dunjeon">
        <text transform="translate(1121.7157 1106.173)" className="st0 st1">둔전</text>
      </g>
      <g onclick={this.handleClick} id="Bopyeong" key="BopyeongStation" data="Bopyeong">
        <text transform="translate(1109.5399 1118.3478)" className="st0 st1">보평</text>
      </g>
      <g onclick={this.handleClick} id="Gojin" key="GojinStation" data="Gojin">
        <text transform="translate(1097.371 1130.5167)" className="st0 st1">고진</text>
      </g>
      <g onclick={this.handleClick} id="Gimnyangjang" key="GimnyangjangStation" data="Gimnyangjang">
        <text transform="translate(1073.0262 1154.8605)" className="st0 st1">김량장</text>
      </g>
      <g onclick={this.handleClick} id="Seohyeon" key="SeohyeonStation" data="Seohyeon">
      ...
      <g onclick={this.handleClick} id="Migeum" key="MigeumStation" data="Migeum">
        <text transform="translate(1033.5135 1137.5939)" className="st0 st1">미금</text>
      </g>
      <g onclick={this.handleClick} id="Yeouinaru" key="YeouinaruStation" data="Yeouinaru">
      ...
      <g onclick={this.handleClick} id="Mapo" key="MapoStation" data="Mapo">
        <text transform="translate(577.6615 727.9991)" className="st0 st1">마포</text>
      </g>
      <g onclick={this.handleClick} id="Haengdang" key="HaengdangStation" data="Haengdang">
        <text transform="translate(827.621 663.5157)" className="st0 st1">행당</text>
      </g>
      <g onclick={this.handleClick} id="Jeungsan" key="JeungsanStation" data="Jeungsan">
        <text transform="translate(479.2523 571.1251)" className="st0 st1">증산</text>
      </g>
      <g onclick={this.handleClick} id="Yeokchon" key="YeokchonStation" data="Yeokchon">
        <text transform="translate(513.5922 481.5597)" className="st0 st1">역촌</text>
      </g>
      <g onclick={this.handleClick} id="Sangdo" key="SangdoStation" data="Sangdo">
        <text transform="translate(582.7338 865.4386)" className="st0 st1">상도</text>
      </g>
      <g onclick={this.handleClick} id="SoongsilUniv" key="SoongsilUnivStation" data="SoongsilUniv">
        <text transform="translate(606.9974 889.4269)" className="st0 st1">숭실대입구</text>
      </g>
      <g onclick={this.handleClick} id="Namseong" key="NamseongStation" data="Namseong">
        <text transform="translate(650.2245 932.6525)" className="st0 st1">남성</text>
      </g>
      <g onclick={this.handleClick} id="Saetgang" key="SaetgangStation" data="Saetgang">
        <text transform="translate(529.5365 810.9698)" className="st0 st1">샛강</text>
      </g>
      <g onclick={this.handleClick} id="NationalAssembly" key="NationalAssemblyStation" data="NationalAssembly">
        <text transform="translate(491.3148 772.7482)" className="st0 st1">국회의사당</text>
      </g>
      <g onclick={this.handleClick} id="Sinmokdong" key="SinmokdongStation" data="Sinmokdong">
        <text transform="translate(391.8402 711.3087)" className="st0 st1">신목동</text>
      </g>
      <g onclick={this.handleClick} id="Yeomchang" key="YeomchangStation" data="Yeomchang">
        <text transform="translate(374.5355 694.2609)" className="st0 st1">염창</text>
      </g>
      <g onclick={this.handleClick} id="Deungchon" key="DeungchonStation" data="Deungchon">
        <text transform="translate(354.1381 673.8556)" className="st0 st1">등촌</text>
      </g>
      <g onclick={this.handleClick} id="Jeungmi" key="JeungmiStation" data="Jeungmi">
        <text transform="translate(333.8324 653.546)" className="st0 st1">증미</text>
      </g>
      <g onclick={this.handleClick} id="Gayang" key="GayangStation" data="Gayang">
        <text transform="translate(316.3783 636.0909)" className="st0 st1">가양</text>
      </g>
      <g onclick={this.handleClick} id="Soraepogu" key="SoraepoguStation" data="Soraepogu">
        <text transform="translate(324.9467 1085.6925)" className="st0 st1">소래포구</text>
      </g>
      <g onclick={this.handleClick} id="Wolgot" key="WolgotStation" data="Wolgot">
        <text transform="translate(368.5492 1088.9562)" className="st0 st1">월곶</text>
      </g>
      <g onclick={this.handleClick} id="Dalwol" key="DalwolStation" data="Dalwol">
        <text transform="translate(391.1771 1111.0646)" className="st0 st1">달월</text>
      </g>
      <g onclick={this.handleClick} id="Songpa" key="SongpaStation" data="Songpa">
        <text transform="translate(1067.3837 879.4728)" className="st0 st1">송파</text>
      </g>
      <g onclick={this.handleClick} id="Mangwon" key="MangwonStation" data="Mangwon">
        <text transform="translate(466.764 670.1866)" className="st0 st1">망원</text>
      </g>
      <g onclick={this.handleClick} id="MapoguOffice" key="MapoguOfficeStation" data="MapoguOffice">
        <text transform="translate(442.4828 642.8976)" className="st0 st1">마포구청</text>
      </g>
      <g onclick={this.handleClick} id="Muakjae" key="MuakjaeStation" data="Muakjae">
        <text transform="translate(585.0648 567.8185)" className="st0 st1">무악재</text>
      </g>
      <g onclick={this.handleClick} id="Hongje" key="HongjeStation" data="Hongje">
        <text transform="translate(563.3627 545.9542)" className="st0 st1">홍제</text>
      </g>
      <g onclick={this.handleClick} id="Dongnimmun" key="DongnimmunStation" data="Dongnimmun">
        <text transform="translate(615.5453 598.3068)" className="st0 st1">독립문</text>
      </g>
      <g onclick={this.handleClick} id="Aeogae" key="AeogaeStation" data="Aeogae">
        <text transform="translate(618.6469 685.504)" className="st0 st1">애오개</text>
      </g>
      <g onclick={this.handleClick} id="WorldCupStadium" key="WorldCupStadiumStation" data="WorldCupStadium">
        <text transform="translate(434.9164 615.4552)" className="st0 st1">월드컵경기장</text>
      </g>
      <g onclick={this.handleClick} id="Sunae" key="SunaeStation" data="Sunae">
        <text transform="translate(1057.1874 1113.9142)" className="st0 st1">수내</text>
      </g>
      <g onclick={this.handleClick} id="Dorimcheon" key="DorimcheonStation" data="Dorimcheon">
        <text transform="translate(374.4613 818.5802)" className="st0 st1">도림천</text>
      </g>
      <g onclick={this.handleClick} id="Gangmae" key="GangmaeStation" data="Gangmae">
        <text transform="translate(373.265 509.6857)" className="st0 st1">강매</text>
      </g>
      <g onclick={this.handleClick} id="Susaek" key="SusaekStation" data="Susaek">
        <text transform="translate(433.3324 569.7531)" className="st0 st1">수색</text>
      </g>
      <g onclick={this.handleClick} id="Hannam" key="HannamStation" data="Hannam">
        <text transform="translate(761.0575 761.4923)" className="st0 st1">한남</text>
      </g>
      <g onclick={this.handleClick} id="Eungbong" key="EungbongStation" data="Eungbong">
        <text transform="translate(836.1512 686.4015)" className="st0 st1">응봉</text>
      </g>
      <g onclick={this.handleClick} id="Sillim" key="SillimStation" data="Sillim">
        <text transform="translate(528.5287 938.8146)" className="st0 st1">신림</text>
      </g>
      <g onclick={this.handleClick} id="Dongam" key="DongamStation" data="Dongam">
        <text transform="translate(66.7377 896.8781)" className="st0 st1">동암</text>
      </g>
      <g onclick={this.handleClick} id="Singeumho" key="SingeumhoStation" data="Singeumho">
        <text transform="translate(798.2098 664.004)" className="st0 st1">신금호</text>
      </g>
      <g onclick={this.handleClick} id="Majang" key="MajangStation" data="Majang">
        <text transform="translate(866.2372 624.8868)" className="st0 st1">마장</text>
      </g>
      <g onclick={this.handleClick} id="AirportMarket" key="AirportMarketStation" data="AirportMarket">
        <text transform="translate(174.6918 628.8947)" className="st0 st1">공항시장</text>
      </g>
      <g onclick={this.handleClick} id="Seodaemun" key="SeodaemunStation" data="Seodaemun">
        <text transform="translate(617.8002 624.0538)" className="st0 st1">서대문</text>
      </g>
      <g onclick={this.handleClick} id="Sinimun" key="SinimunStation" data="Sinimun">
        <text transform="translate(915.4833 495.5314)" className="st0 st1">신이문</text>
      </g>
      <g onclick={this.handleClick} id="Miasamgeori" key="MiasamgeoriStation" data="Miasamgeori">
        <text transform="translate(838.6932 459.8585)" className="st0 st1">미아사거리</text>
      </g>
      <g onclick={this.handleClick} id="Macheon" key="MacheonStation" data="Macheon">
        <text transform="translate(1200.8905 889.0197)" className="st0 st1">마천</text>
      </g>
      <g onclick={this.handleClick} id="Chunui" key="ChunuiStation" data="Chunui">
        <text transform="translate(189.9613 849.1359)" className="st0 st1">춘의</text>
      </g>
      <g onclick={this.handleClick} id="Hwaseo" key="HwaseoStation" data="Hwaseo">
        <text transform="translate(786.6737 1118.2286)" className="st0 st1">화서</text>
      </g>
      <g onclick={this.handleClick} id="Gajwa" key="GajwaStation" data="Gajwa">
        <text transform="translate(474.8744 611.84)" className="st0 st1">가좌</text>
      </g>
      <g onclick={this.handleClick} id="SogangUniv" key="SogangUnivStation" data="SogangUniv">
        <text transform="translate(544.4047 681.3712)" className="st0 st1">서강대</text>
      </g>
      <g onclick={this.handleClick} id="TtukseomPark" key="TtukseomParkStation" data="TtukseomPark">
        <text transform="translate(940.2401 761.049)" className="st0 st1">뚝섬유원지</text>
      </g>
      <g onclick={this.handleClick} id="ChildrensGrandPark" key="ChildrensGrandParkStation" data="ChildrensGrandPark">
        <text transform="translate(965.2235 700.8429)" className="st0 st1">어린이대공원</text>
      </g>
      <g onclick={this.handleClick} id="Junggok" key="JunggokStation" data="Junggok">
        <text transform="translate(992.455 635.2316)" className="st0 st1">중곡</text>
      </g>
      <g onclick={this.handleClick} id="Galmae" key="GalmaeStation" data="Galmae">
        <text transform="translate(1067.0897 396.6526)" className="st0 st1">갈매</text>
      </g>
      <g onclick={this.handleClick} id="Toegyewon" key="ToegyewonStation" data="Toegyewon">
        <text transform="translate(1079.5028 366.3839)" className="st0 st1">퇴계원</text>
      </g>
      <g onclick={this.handleClick} id="Byeollae" key="ByeollaeStation" data="Byeollae">
        <text transform="translate(1073.3524 381.5157)" className="st0 st1">별내</text>
      </g>
      <g onclick={this.handleClick} id="Wolgok" key="WolgokStation" data="Wolgok">
        <text transform="translate(842.6083 495.6193)" className="st0 st1">월곡</text>
      </g>
      <g onclick={this.handleClick} id="KoreaUniv" key="KoreaUnivStation" data="KoreaUniv">
        <text transform="translate(818.6522 539.2159)" className="st0 st1">고려대</text>
      </g>
      <g onclick={this.handleClick} id="Beotigogae" key="BeotigogaeStation" data="Beotigogae">
        <text transform="translate(730.1385 696.1583)" className="st0 st1">버티고개</text>
      </g>
      <g onclick={this.handleClick} id="Mongchontoseong" key="MongchontoseongStation" data="Mongchontoseong">
        <text transform="translate(1072.6698 811.6027)" className="st0 st1">몽촌토성</text>
      </g>
      <g onclick={this.handleClick} id="GangdongguOffice" key="GangdongguOfficeStation" data="GangdongguOffice">
        <text transform="translate(1093.1132 765.2765)" className="st0 st1">강동구청</text>
      </g>
      <g onclick={this.handleClick} id="Amsa" key="AmsaStation" data="Amsa">
        <text transform="translate(1122.7469 693.7228)" className="st0 st1">암사</text>
      </g>
      <g onclick={this.handleClick} id="Hangangjin" key="HangangjinStation" data="Hangangjin">
        <text transform="translate(721.8885 729.4581)" className="st0 st1">한강진</text>
      </g>
      <g onclick={this.handleClick} id="Gildong" key="GildongStation" data="Gildong">
        <text transform="translate(1156.3417 738.5021)" className="st0 st1">길동</text>
      </g>
      <g onclick={this.handleClick} id="Dunchondong" key="DunchondongStation" data="Dunchondong">
        <text transform="translate(1141.3798 774.8517)" className="st0 st1">둔촌동</text>
      </g>
      <g onclick={this.handleClick} id="OlympicPark" key="OlympicParkStation" data="OlympicPark">
        <text transform="translate(1124.6776 815.548)" className="st0 st1">올림픽공원</text>
      </g>
      <g onclick={this.handleClick} id="Bangi" key="BangiStation" data="Bangi">
        <text transform="translate(1112.0458 846.3185)" className="st0 st1">방이</text>
      </g>
      <g onclick={this.handleClick} id="Gubeundari" key="GubeundariStation" data="Gubeundari">
        <text transform="translate(1168.2177 709.8361)" className="st0 st1">굽은다리</text>
      </g>
      <g onclick={this.handleClick} id="Myeongil" key="MyeongilStation" data="Myeongil">
        <text transform="translate(1176.8026 689.1134)" className="st0 st1">명일</text>
      </g>
      <g onclick={this.handleClick} id="Banghwa" key="BanghwaStation" data="Banghwa">
        <text transform="translate(183.7484 582.7433)" className="st0 st1">방화</text>
      </g>
      <g onclick={this.handleClick} id="Gaehwasan" key="GaehwasanStation" data="Gaehwasan">
        <text transform="translate(174.4301 605.2452)" className="st0 st1">개화산</text>
      </g>
      <g onclick={this.handleClick} id="Suyu" key="SuyuStation" data="Suyu">
        <text transform="translate(818.7841 363.9923)" className="st0 st1">수유</text>
      </g>
      <g onclick={this.handleClick} id="Daehwa" key="DaehwaStation" data="Daehwa">
        <text transform="translate(333.683 375.8468)" className="st0 st1">대화</text>
      </g>
      <g onclick={this.handleClick} id="Juyeop" key="JuyeopStation" data="Juyeop">
        <text transform="translate(341.3861 357.6085)" className="st0 st1">주엽</text>
      </g>
      <g onclick={this.handleClick} id="Jeongbalsan" key="JeongbalsanStation" data="Jeongbalsan">
        <text transform="translate(343.266 339.3722)" className="st0 st1">정발산</text>
      </g>
      <g onclick={this.handleClick} id="Madu" key="MaduStation" data="Madu">
        <text transform="translate(376.183 337.0363)" className="st0 st1">마두</text>
      </g>
      <g onclick={this.handleClick} id="Goksan" key="GoksanStation" data="Goksan">
        <text transform="translate(435.4496 315.0968)" className="st0 st1">곡산</text>
      </g>
      <g onclick={this.handleClick} id="Neunggok" key="NeunggokStation" data="Neunggok">
        <text transform="translate(410.0219 377.4327)" className="st0 st1">능곡</text>
      </g>
      <g onclick={this.handleClick} id="Haengsin" key="HaengsinStation" data="Haengsin">
        <text transform="translate(391.9594 421.0343)" className="st0 st1">행신</text>
      </g>
      <g onclick={this.handleClick} id="Hwajeon" key="HwajeonStation" data="Hwajeon">
        <text transform="translate(372.6625 467.5558)" className="st0 st1">화전</text>
      </g>
      <g onclick={this.handleClick} id="Jangam" key="JangamStation" data="Jangam">
        <text transform="translate(901.3544 130.2345)" className="st0 st1">장암</text>
      </g>
      <g onclick={this.handleClick} id="Guri" key="GuriStation" data="Guri">
        <text transform="translate(1061.6542 523.5656)" className="st0 st1">구리</text>
      </g>
      <g onclick={this.handleClick} id="Donong" key="DonongStation" data="Donong">
        <text transform="translate(1067.6346 537.9689)" className="st0 st1">도농</text>
      </g>
      <g onclick={this.handleClick} id="Yangjeong" key="YangjeongStation" data="Yangjeong">
        <text transform="translate(1073.6024 552.3741)" className="st0 st1">양정</text>
      </g>
      <g onclick={this.handleClick} id="Deokso" key="DeoksoStation" data="Deokso">
        <text transform="translate(1079.5712 566.7794)" className="st0 st1">덕소</text>
      </g>
      <g onclick={this.handleClick} id="Dosim" key="DosimStation" data="Dosim">
        <text transform="translate(1085.8661 581.1837)" className="st0 st1">도심</text>
      </g>
      <g onclick={this.handleClick} id="Yangwon" key="YangwonStation" data="Yangwon">
        <text transform="translate(1055.704 509.1593)" className="st0 st1">양원</text>
      </g>
      <g onclick={this.handleClick} id="Chuncheon" key="ChuncheonStation" data="Chuncheon">
        <text transform="translate(992.1288 133.298)" className="st0 st1">춘천</text>
      </g>
      <g onclick={this.handleClick} id="Namchuncheon" key="NamchuncheonStation" data="Namchuncheon">
        <text transform="translate(998.5604 148.8224)" className="st0 st1">남춘천</text>
      </g>
      <g onclick={this.handleClick} id="Gimyujeong" key="GimyujeongStation" data="Gimyujeong">
        <text transform="translate(1004.994 164.3488)" className="st0 st1">김유정</text>
      </g>
      <g onclick={this.handleClick} id="Gangchon" key="GangchonStation" data="Gangchon">
        <text transform="translate(1011.4257 179.8741)" className="st0 st1">강촌</text>
      </g>
      <g onclick={this.handleClick} id="Baegyangri" key="BaegyangriStation" data="Baegyangri">
        <text transform="translate(1017.8563 197.548)" className="st0 st1">백양리</text>
      </g>
      <g onclick={this.handleClick} id="Gulbongsan" key="GulbongsanStation" data="Gulbongsan">
        <text transform="translate(1024.2889 210.9259)" className="st0 st1">굴봉산</text>
      </g>
      <g onclick={this.handleClick} id="Gapyeong" key="GapyeongStation" data="Gapyeong">
        <text transform="translate(1030.7206 226.4523)" className="st0 st1">가평</text>
      </g>
      <g onclick={this.handleClick} id="Sangcheon" key="SangcheonStation" data="Sangcheon">
        <text transform="translate(1037.1532 241.9777)" className="st0 st1">상천</text>
      </g>
      <g onclick={this.handleClick} id="Cheongpyeong" key="CheongpyeongStation" data="Cheongpyeong">
        <text transform="translate(1043.5848 257.4972)" className="st0 st1">청평</text>
      </g>
      <g onclick={this.handleClick} id="Daeseongri" key="DaeseongriStation" data="Daeseongri">
        <text transform="translate(1050.0165 273.0227)" className="st0 st1">대성리</text>
      </g>
      <g onclick={this.handleClick} id="Maseok" key="MaseokStation" data="Maseok">
        <text transform="translate(1056.4423 288.549)" className="st0 st1">마석</text>
      </g>
      <g onclick={this.handleClick} id="Cheonmasan" key="CheonmasanStation" data="Cheonmasan">
        <text transform="translate(1062.8759 304.0753)" className="st0 st1">천마산</text>
      </g>
      <g onclick={this.handleClick} id="PyeongnaeHopyeong" key="PyeongnaeHopyeongStation" data="PyeongnaeHopyeong">
        <text transform="translate(1069.3075 319.5997)" className="st0 st1">평내호평</text>
      </g>
      <g onclick={this.handleClick} id="Geumgok" key="GeumgokStation" data="Geumgok">
        <text transform="translate(1075.7323 335.1202)" className="st0 st1">금곡</text>
      </g>
      <g onclick={this.handleClick} id="Wolgye" key="WolgyeStation" data="Wolgye">
        <text transform="translate(897.5272 382.2102)" className="st0 st1">월계</text>
      </g>
      <g onclick={this.handleClick} id="Nokcheon" key="NokcheonStation" data="Nokcheon">
        <text transform="translate(879.3817 338.4532)" className="st0 st1">녹천</text>
      </g>
      <g onclick={this.handleClick} id="Danggogae" key="DanggogaeStation" data="Danggogae">
        <text transform="translate(980.4276 238.5284)" className="st0 st1">당고개</text>
      </g>
      <g onclick={this.handleClick} id="Kkachiul" key="KkachiulStation" data="Kkachiul">
        <text transform="translate(205.3226 883.4913)" className="st0 st1">까치울</text>
      </g>
      <g onclick={this.handleClick} id="BucheonStadium" key="BucheonStadiumStation" data="BucheonStadium">
        <text transform="translate(198.8842 865.8341)" className="st0 st1">부천종합운동장</text>
      </g>
      <g onclick={this.handleClick} id="Doksan" key="DoksanStation" data="Doksan">
        <text transform="translate(417.8304 999.2355)" className="st0 st1">독산</text>
      </g>
      <g onclick={this.handleClick} id="Incheon" key="IncheonStation" data="Incheon">
        <text transform="translate(37.9779 782.6886)" className="st0 st1">인천</text>
      </g>
      <g onclick={this.handleClick} id="Dongincheon" key="DongincheonStation" data="Dongincheon">
        <text transform="translate(44.5912 798.7091)" className="st0 st1">동인천</text>
      </g>
      <g onclick={this.handleClick} id="Dowon" key="DowonStation" data="Dowon">
        <text transform="translate(51.2045 814.7306)" className="st0 st1">도원</text>
      </g>
      <g onclick={this.handleClick} id="Jemulpo" key="JemulpoStation" data="Jemulpo">
        <text transform="translate(57.8246 830.7511)" className="st0 st1">제물포</text>
      </g>
      <g onclick={this.handleClick} id="Dohwa" key="DohwaStation" data="Dohwa">
        <text transform="translate(64.4379 846.7716)" className="st0 st1">도화</text>
      </g>
      <g onclick={this.handleClick} id="Juan" key="JuanStation" data="Juan">
        <text transform="translate(71.0521 862.7921)" className="st0 st1">주안</text>
      </g>
      <g onclick={this.handleClick} id="Ganseok" key="GanseokStation" data="Ganseok">
        <text transform="translate(77.6722 878.8126)" className="st0 st1">간석</text>
      </g>
      <g onclick={this.handleClick} id="Galsan" key="GalsanStation" data="Galsan">
        <text transform="translate(88.7386 817.3038)" className="st0 st1">갈산</text>
      </g>
      <g onclick={this.handleClick} id="Dongsu" key="DongsuStation" data="Dongsu">
        <text transform="translate(132.347 923.4464)" className="st0 st1">동수</text>
      </g>
      <g onclick={this.handleClick} id="Bupyeongsamgeori" key="BupyeongsamgeoriStation" data="Bupyeongsamgeori">
        <text transform="translate(138.7357 938.8663)" className="st0 st1">부평삼거리</text>
      </g>
      <g onclick={this.handleClick} id="Ganseogogeori" key="GanseogogeoriStation" data="Ganseogogeori">
        <text transform="translate(146.6517 957.9816)" className="st0 st1">간석오거리</text>
      </g>
      <g onclick={this.handleClick} id="IncheonCityHall" key="IncheonCityHallStation" data="IncheonCityHall">
        <text transform="translate(154.5687 977.0958)" className="st0 st1">인천시청</text>
      </g>
      <g onclick={this.handleClick} id="ArtsCenter" key="ArtsCenterStation" data="ArtsCenter">
        <text transform="translate(162.4847 996.2111)" className="st0 st1">예술회관</text>
      </g>
      <g onclick={this.handleClick} id="IncheonBusTerminal" key="IncheonBusTerminalStation" data="IncheonBusTerminal">
        <text transform="translate(170.4008 1015.3243)" className="st0 st1">인천터미널</text>
      </g>
      <g onclick={this.handleClick} id="MunhakSportsComplex" key="MunhakSportsComplexStation" data="MunhakSportsComplex">
        <text transform="translate(178.3168 1034.4386)" className="st0 st1">문학경기장</text>
      </g>
      <g onclick={this.handleClick} id="Seonhak" key="SeonhakStation" data="Seonhak">
        <text transform="translate(186.2338 1053.5529)" className="st0 st1">선학</text>
      </g>
      <g onclick={this.handleClick} id="Sinyeonsu" key="SinyeonsuStation" data="Sinyeonsu">
        <text transform="translate(194.1508 1072.6681)" className="st0 st1">신연수</text>
      </g>
      <g onclick={this.handleClick} id="Dongchun" key="DongchunStation" data="Dongchun">
        <text transform="translate(210.057 1111.0656)" className="st0 st1">동춘</text>
      </g>
      <g onclick={this.handleClick} id="Dongmak" key="DongmakStation" data="Dongmak">
        <text transform="translate(218.0492 1130.3556)" className="st0 st1">동막</text>
      </g>
      <g onclick={this.handleClick} id="BupyeongMarket" key="BupyeongMarketStation" data="BupyeongMarket">
        <text transform="translate(112.0804 873.6632)" className="st0 st1">부평시장</text>
      </g>
      <g onclick={this.handleClick} id="Balsan" key="BalsanStation" data="Balsan">
        <text transform="translate(242.2865 660.9308)" className="st0 st1">발산</text>
      </g>
      <g onclick={this.handleClick} id="Ujangsan" key="UjangsanStation" data="Ujangsan">
        <text transform="translate(254.9261 691.4445)" className="st0 st1">우장산</text>
      </g>
      <g onclick={this.handleClick} id="Hwagok" key="HwagokStation" data="Hwagok">
        <text transform="translate(266.0736 718.3615)" className="st0 st1">화곡</text>
      </g>
      <g onclick={this.handleClick} id="NambuBusTerminal" key="NambuBusTerminalStation" data="NambuBusTerminal">
        <text transform="translate(786.8661 932.298)" className="st0 st1">남부터미널</text>
      </g>
      <g onclick={this.handleClick} id="Hanti" key="HantiStation" data="Hanti">
        <text transform="translate(895.3778 890.8243)" className="st0 st1">한티</text>
      </g>
      <g onclick={this.handleClick} id="Seonjeongneung" key="SeonjeongneungStation" data="Seonjeongneung">
        <text transform="translate(872.1932 834.8585)" className="st0 st1">선정릉</text>
      </g>
      <g onclick={this.handleClick} id="Nokbeon" key="NokbeonStation" data="Nokbeon">
        <text transform="translate(543.8842 500.1115)" className="st0 st1">녹번</text>
      </g>
      <g onclick={this.handleClick} id="Junghwa" key="JunghwaStation" data="Junghwa">
        <text transform="translate(977.8798 495.0753)" className="st0 st1">중화</text>
      </g>
      <g onclick={this.handleClick} id="Meokgol" key="MeokgolStation" data="Meokgol">
        <text transform="translate(970.5018 465.1271)" className="st0 st1">먹골</text>
      </g>
      <g onclick={this.handleClick} id="Hagye" key="HagyeStation" data="Hagye">
        <text transform="translate(947.0526 370.0061)" className="st0 st1">하계</text>
      </g>
      <g onclick={this.handleClick} id="Junggye" key="JunggyeStation" data="Junggye">
        <text transform="translate(938.1649 333.9563)" className="st0 st1">중계</text>
      </g>
      <g onclick={this.handleClick} id="Madeul" key="MadeulStation" data="Madeul">
        <text transform="translate(919.9598 260.0841)" className="st0 st1">마들</text>
      </g>
      <g onclick={this.handleClick} id="Suraksan" key="SuraksanStation" data="Suraksan">
        <text transform="translate(908.7499 214.6036)" className="st0 st1">수락산</text>
      </g>
      <g onclick={this.handleClick} id="Gongneung" key="GongneungStation" data="Gongneung">
        <text transform="translate(956.6796 409.0548)" className="st0 st1">공릉</text>
      </g>
      <g onclick={this.handleClick} id="Jamsillaru" key="JamsillaruStation" data="Jamsillaru">
        <text transform="translate(1036.8446 802.9484)" className="st0 st1">잠실나루</text>
      </g>
      <g onclick={this.handleClick} id="Gangbyeon" key="GangbyeonStation" data="Gangbyeon">
        <text transform="translate(1014.8983 749.965)" className="st0 st1">강변</text>
      </g>
      <g onclick={this.handleClick} id="Yongdap" key="YongdapStation" data="Yongdap">
        <text transform="translate(892.496 644.8351)" className="st0 st1">용답</text>
      </g>
      <g onclick={this.handleClick} id="Sindap" key="SindapStation" data="Sindap">
        <text transform="translate(876.9335 610.0197)" className="st0 st1">신답</text>
      </g>
      <g onclick={this.handleClick} id="Sareung" key="SareungStation" data="Sareung">
        <text transform="translate(1081.9315 350.1526)" className="st0 st1">사릉</text>
      </g>
      <g onclick={this.handleClick} id="Mia" key="MiaStation" data="Mia">
        <text transform="translate(822.2762 405.5099)" className="st0 st1">미아</text>
      </g>
      <g onclick={this.handleClick} id="SeokchonHansolHospital" key="SeokchonHansolHospitalStation" data="SeokchonHansolHospital">
        <text transform="translate(1051.368 857.7804)" className="st0 st1">석촌</text>
      </g>
      <g onclick={this.handleClick} id="NationalPoliceHospital" key="NationalPoliceHospitalStation" data="NationalPoliceHospital">
        <text transform="translate(1109.2186 895.3654)" className="st0 st1">경찰병원</text>
      </g>
      <g onclick={this.handleClick} id="Sinyongsan" key="SinyongsanStation" data="Sinyongsan">
        <text transform="translate(637.4086 770.2814)" className="st0 st1">신용산</text>
      </g>
      <g onclick={this.handleClick} id="YangjaeCitizensForest" key="YangjaeCitizensForestStation" data="YangjaeCitizensForest">
        <text transform="translate(863.3368 985.381)" className="st0 st1">양재시민의숲</text>
      </g>
      <g onclick={this.handleClick} id="Daecheong" key="DaecheongStation" data="Daecheong">
        <text transform="translate(975.7118 905.424)" className="st0 st1">대청</text>
      </g>
      <g onclick={this.handleClick} id="Irwon" key="IrwonStation" data="Irwon">
        <text transform="translate(989.0155 936.5255)" className="st0 st1">일원</text>
      </g>
      <g onclick={this.handleClick} id="Sinjeongnegeori" key="SinjeongnegeoriStation" data="Sinjeongnegeori">
        <text transform="translate(258.7894 801.7472)" className="st0 st1">신정네거리</text>
      </g>
      <g onclick={this.handleClick} id="Jakjeon" key="JakjeonStation" data="Jakjeon">
        <text transform="translate(77.0892 789.1583)" className="st0 st1">작전</text>
      </g>
      <g onclick={this.handleClick} id="Seoulforest" key="SeoulforestStation" data="Seoulforest">
        <text transform="translate(845.7762 715.3741)" className="st0 st1">서울숲</text>
      </g>
      <g onclick={this.handleClick} id="Gwangmyeong" key="GwangmyeongStation" data="Gwangmyeong">
        <text transform="translate(412.7006 1069.9493)" className="st0 st1">광명</text>
      </g>
      <g onclick={this.handleClick} id="Seoksu" key="SeoksuStation" data="Seoksu">
        <text transform="translate(458.2767 1096.8878)" className="st0 st1">석수</text>
      </g>
      <g onclick={this.handleClick} id="Apgujeongrodeo" key="ApgujeongrodeoStation" data="Apgujeongrodeo">
        <text transform="translate(857.2919 774.5333)" className="st0 st1">압구정로데오</text>
      </g>
      <g onclick={this.handleClick} id="HongikUniv" key="HongikUnivStation" data="HongikUniv">
        <text transform="translate(507.5287 671.1388)" className="st0 st1">홍대입구</text>
      </g>
      <g onclick={this.handleClick} id="Hapjeong" key="HapjeongStation" data="Hapjeong">
        <text transform="translate(489.9515 691.2228)" className="st0 st1">합정</text>
      </g>
      <g onclick={this.handleClick} id="Dangsan" key="DangsanStation" data="Dangsan">
        <text transform="translate(445.3617 735.4513)" className="st0 st1">당산</text>
      </g>
      <g onclick={this.handleClick} id="YeongdeungpoguOffice" key="YeongdeungpoguOfficeStation" data="YeongdeungpoguOffice">
        <text transform="translate(419.7943 777.0577)" className="st0 st1">영등포구청</text>
      </g>
      <g onclick={this.handleClick} id="Daerim" key="DaerimStation" data="Daerim">
        <text transform="translate(422.1742 916.9064)" className="st0 st1">대림</text>
      </g>
      <g onclick={this.handleClick} id="GasanDigitalComplex" key="GasanDigitalComplexStation" data="GasanDigitalComplex">
      ...
      <g onclick={this.handleClick} id="GeumcheonGuOffice" key="GeumcheonGuOfficeStation" data="GeumcheonGuOffice">
        <text transform="translate(438.0033 1045.7853)" className="st0 st1">금천구청</text>
      </g>
      <g onclick={this.handleClick} id="Guro" key="GuroStation" data="Guro">
        <text transform="translate(377.4447 863.4972)" className="st0 st1">구로</text>
      </g>
      <g onclick={this.handleClick} id="Kkachisan" key="KkachisanStation" data="Kkachisan">
        <text transform="translate(284.4828 754.3507)" className="st0 st1">까치산</text>
      </g>
      <g onclick={this.handleClick} id="GimpoIntlAirport" key="GimpoIntlAirportStation" data="GimpoIntlAirport">
        <text transform="translate(146.2113 650.7023)" className="st0 st1">김포공항</text>
      </g>
      <g onclick={this.handleClick} id="BupyeongguOffice" key="BupyeongguOfficeStation" data="BupyeongguOffice">
        <text transform="translate(90.1273 854.6261)" className="st0 st1">부평구청</text>
      </g>
      <g onclick={this.handleClick} id="Bupyeong" key="BupyeongStation" data="Bupyeong">
        <text transform="translate(120.389 895.672)" className="st0 st1">부평</text>
      </g>
      <g onclick={this.handleClick} id="Woninjae" key="WoninjaeStation" data="Woninjae">
        <text transform="translate(201.7982 1085.9435)" className="st0 st1">원인재</text>
      </g>
      <g onclick={this.handleClick} id="Gyeyang" key="GyeyangStation" data="Gyeyang">
        <text transform="translate(74.4701 582.379)" className="st0 st1">계양</text>
      </g>
      <g onclick={this.handleClick} id="Sindorim" key="SindorimStation" data="Sindorim">
        <text transform="translate(421.2543 842.3361)" className="st0 st1">신도림</text>
      </g>
      <g onclick={this.handleClick} id="Sadang" key="SadangStation" data="Sadang">
        <text transform="translate(689.5155 959.9845)" className="st0 st1">사당</text>
      </g>
      <g onclick={this.handleClick} id="SeoulNatlUnivofEducation" key="SeoulNatlUnivofEducationStation" data="SeoulNatlUnivofEducation">
        <text transform="translate(775.1727 904.0958)" className="st0 st1">교대</text>
      </g>
      <g onclick={this.handleClick} id="Gangnam" key="GangnamStation" data="Gangnam">
        <text transform="translate(821.6708 884.8361)" className="st0 st1">강남</text>
      </g>
      <g onclick={this.handleClick} id="Seolleung" key="SeolleungStation" data="Seolleung">
        <text transform="translate(882.4579 859.6564)" className="st0 st1">선릉</text>
      </g>
      <g onclick={this.handleClick} id="KonkukUniv" key="KonkukUnivStation" data="KonkukUniv">
        <text transform="translate(952.8798 729.632)" className="st0 st1">건대입구</text>
      </g>
      <g onclick={this.handleClick} id="Wangsimni" key="WangsimniStation" data="Wangsimni">
        <text transform="translate(843.3182 640.0626)" className="st0 st1">왕십리</text>
      </g>
      <g onclick={this.handleClick} id="Jamsil" key="JamsilStation" data="Jamsil">
        <text transform="translate(1042.3436 830.9122)" className="st0 st1">잠실</text>
      </g>
      <g onclick={this.handleClick} id="Euljiro3samga" key="Euljiro3samgaStation" data="Euljiro3samga">
        <text transform="translate(702.4716 640.0607)" className="st0 st1">을지로3가</text>
      </g>
      <g onclick={this.handleClick} id="Euljiro4saga" key="Euljiro4sagaStation" data="Euljiro4saga">
        <text transform="translate(723.7313 626.3898)" className="st0 st1">을지로4가</text>
      </g>
      <g onclick={this.handleClick} id="ExpressBusTerminal1" key="ExpressBusTerminal1Station" data="ExpressBusTerminal1">
        <text transform="translate(689.5106 939.004)" className="st0 st1">총신대입구(이수)</text>
      </g>
      <g onclick={this.handleClick} id="ExpressBusTerminal" key="ExpressBusTerminalStation" data="ExpressBusTerminal">
        <text transform="translate(717.3983 852.5519)" className="st0 st1">고속터미널</text>
      </g>
      <g onclick={this.handleClick} id="Dongjak" key="DongjakStation" data="Dongjak">
        <text transform="translate(662.7723 880.8282)" className="st0 st1">동작</text>
      </g>
      <g onclick={this.handleClick} id="Noryangjin" key="NoryangjinStation" data="Noryangjin">
        <text transform="translate(545.6771 835.1212)" className="st0 st1">노량진</text>
      </g>
      <g onclick={this.handleClick} id="Yeouido" key="YeouidoStation" data="Yeouido">
        <text transform="translate(510.4633 793.9689)" className="st0 st1">여의도</text>
      </g>
      <g onclick={this.handleClick} id="Singil" key="SingilStation" data="Singil">
        <text transform="translate(482.7992 818.5216)" className="st0 st1">신길</text>
      </g>
      <g onclick={this.handleClick} id="GangnamguOffice" key="GangnamguOfficeStation" data="GangnamguOffice">
        <text transform="translate(865.1718 817.9318)" className="st0 st1">Gangnam-gu청</text>
      </g>
      <g onclick={this.handleClick} id="Gunja" key="GunjaStation" data="Gunja">
        <text transform="translate(983.4764 655.9933)" className="st0 st1">군자</text>
      </g>
      <g onclick={this.handleClick} id="Sangbong" key="SangbongStation" data="Sangbong">
        <text transform="translate(999.286 521.0245)" className="st0 st1">상봉</text>
      </g>
      <g onclick={this.handleClick} id="Mangu" key="ManguStation" data="Mangu">
        <text transform="translate(1015.8241 515.7111)" className="st0 st1">망우</text>
      </g>
      <g onclick={this.handleClick} id="Hoegi" key="HoegiStation" data="Hoegi">
        <text transform="translate(897.8134 552.0031)" className="st0 st1">회기</text>
      </g>
      <g onclick={this.handleClick} id="Cheongnyangni" key="CheongnyangniStation" data="Cheongnyangni">
        <text transform="translate(869.4061 580.4113)" className="st0 st1">청량리</text>
      </g>
      <g onclick={this.handleClick} id="Sinseoldong" key="SinseoldongStation" data="Sinseoldong">
        <text transform="translate(803.6678 592.8263)" className="st0 st1">신설동</text>
      </g>
      <g onclick={this.handleClick} id="Dongdaemun" key="DongdaemunStation" data="Dongdaemun">
        <text transform="translate(758.2802 605.4318)" className="st0 st1">동대문</text>
      </g>
      <g onclick={this.handleClick} id="Changdong" key="ChangdongStation" data="Changdong">
        <text transform="translate(885.8397 308.1046)" className="st0 st1">창동</text>
      </g>
      <g onclick={this.handleClick} id="Taereung" key="TaereungStation" data="Taereung">
        <text transform="translate(966.203 449.9728)" className="st0 st1">태릉입구</text>
      </g>
      <g onclick={this.handleClick} id="Seokgye" key="SeokgyeStation" data="Seokgye">
        <text transform="translate(921.9012 452.5704)" className="st0 st1">석계</text>
      </g>
      <g onclick={this.handleClick} id="KwangwoonUniv" key="KwangwoonUnivStation" data="KwangwoonUniv">
        <text transform="translate(908.5262 423.3868)" className="st0 st1">광운대</text>
      </g>
      <g onclick={this.handleClick} id="Dongmyo" key="DongmyoStation" data="Dongmyo">
        <text transform="translate(784.3339 605.4318)" className="st0 st1">동묘앞</text>
      </g>
      <g onclick={this.handleClick} id="Sindang" key="SindangStation" data="Sindang">
        <text transform="translate(784.3339 625.9747)" className="st0 st1">신당</text>
      </g>
      <g onclick={this.handleClick} id="Cheonggu" key="CheongguStation" data="Cheonggu">
        <text transform="translate(781.7313 647.2872)" className="st0 st1">청구</text>
      </g>
      <g onclick={this.handleClick} id="Yaksu" key="YaksuStation" data="Yaksu">
        <text transform="translate(774.5106 664.2013)" className="st0 st1">약수</text>
      </g>
      <g onclick={this.handleClick} id="Oksu" key="OksuStation" data="Oksu">
        <text transform="translate(795.6766 726.4679)" className="st0 st1">옥수</text>
      </g>
      <g onclick={this.handleClick} id="Yangjae" key="YangjaeStation" data="Yangjae">
        <text transform="translate(845.8456 943.2208)" className="st0 st1">양재</text>
      </g>
      <g onclick={this.handleClick} id="Dogok" key="DogokStation" data="Dogok">
        <text transform="translate(901.7587 908.4806)" className="st0 st1">도곡</text>
      </g>
      <g onclick={this.handleClick} id="Suseo" key="SuseoStation" data="Suseo">
        <text transform="translate(1039.2665 932.7189)" className="st0 st1">수서</text>
      </g>
      <g onclick={this.handleClick} id="Bokjeong" key="BokjeongStation" data="Bokjeong">
        <text transform="translate(1087.0145 989.5157)" className="st0 st1">복정</text>
      </g>
      <g onclick={this.handleClick} id="Moran" key="MoranStation" data="Moran">
        <text transform="translate(1085.371 1060.672)" className="st0 st1">모란</text>
      </g>
      <g onclick={this.handleClick} id="Jeongja" key="JeongjaStation" data="Jeongja">
        <text transform="translate(1044.1063 1129.1329)" className="st0 st1">정자</text>
      </g>
      <g onclick={this.handleClick} id="Seongsu" key="SeongsuStation" data="Seongsu">
        <text transform="translate(897.8934 706.3527)" className="st0 st1">성수</text>
      </g>
      <g onclick={this.handleClick} id="GarakMarket" key="GarakMarketStation" data="GarakMarket">
        <text transform="translate(1093.3593 911.4073)" className="st0 st1">가락시장</text>
      </g>
      <g onclick={this.handleClick} id="Cheonho" key="CheonhoStation" data="Cheonho">
        <text transform="translate(1107.8856 729.3146)" className="st0 st1">천호</text>
      </g>
      <g onclick={this.handleClick} id="Gangdong" key="GangdongStation" data="Gangdong">
        <text transform="translate(1133.2821 739.298)" className="st0 st1">강동</text>
      </g>
      <g onclick={this.handleClick} id="Gongdeok" key="GongdeokStation" data="Gongdeok">
        <text transform="translate(595.9095 708.6525)" className="st0 st1">공덕</text>
      </g>
      <g onclick={this.handleClick} id="DigitalMediaCity" key="DigitalMediaCityStation" data="DigitalMediaCity">
        <text transform="translate(457.4496 593.5626)" className="st0 st1">디지털미디어시티</text>
      </g>
      <g onclick={this.handleClick} id="Yeonsinnae" key="YeonsinnaeStation" data="Yeonsinnae">
        <text transform="translate(514.2377 428.9103)" className="st0 st1">연신내</text>
      </g>
      <g onclick={this.handleClick} id="Daegok" key="DaegokStation" data="Daegok">
        <text transform="translate(408.7748 323.2697)" className="st0 st1">대곡</text>
      </g>
      <g onclick={this.handleClick} id="Jongno3samga" key="Jongno3samgaStation" data="Jongno3samga">
        <text transform="translate(691.2723 601.7755)" className="st0 st1">종로3가</text>
      </g>
      <g onclick={this.handleClick} id="Chungmuro" key="ChungmuroStation" data="Chungmuro">
        <text transform="translate(708.0341 655.9484)" className="st0 st1">충무로</text>
      </g>
      <g onclick={this.handleClick} id="SeoulStation" key="SeoulStationStation" data="SeoulStation">
        <text transform="translate(664.4169 674.1368)" className="st0 st1">서울역</text>
      </g>
      <g onclick={this.handleClick} id="CityHall" key="CityHallStation" data="CityHall">
        <text transform="translate(648.0682 647.9054)" className="st0 st1">시청</text>
      </g>
      <g onclick={this.handleClick} id="Chungjeongno" key="ChungjeongnoStation" data="Chungjeongno">
        <text transform="translate(620.0043 659.5314)" className="st0 st1">충정로</text>
      </g>
      <g onclick={this.handleClick} id="Ichon" key="IchonStation" data="Ichon">
        <text transform="translate(659.3075 809.0988)" className="st0 st1">이촌</text>
      </g>
      <g onclick={this.handleClick} id="Yongsan" key="YongsanStation" data="Yongsan">
        <text transform="translate(612.0531 756.0587)" className="st0 st1">용산</text>
      </g>
      <g onclick={this.handleClick} id="Samgakji" key="SamgakjiStation" data="Samgakji">
        <text transform="translate(656.2616 752.6447)" className="st0 st1">삼각지</text>
      </g>
      <g onclick={this.handleClick} id="Bulgwang" key="BulgwangStation" data="Bulgwang">
        <text transform="translate(531.309 463.6564)" className="st0 st1">불광</text>
      </g>
      <g onclick={this.handleClick} id="Nowon" key="NowonStation" data="Nowon">
        <text transform="translate(928.2401 292.4944)" className="st0 st1">노원</text>
      </g>
      <g onclick={this.handleClick} id="Dobongsan" key="DobongsanStation" data="Dobongsan">
        <text transform="translate(854.8466 176.0548)" className="st0 st1">도봉산</text>
      </g>
      <g onclick={this.handleClick} id="Hoeryong" key="HoeryongStation" data="Hoeryong">
        <text transform="translate(810.1034 76.1222)" className="st0 st1">회룡</text>
      </g>
      <g onclick={this.handleClick} id="Ogeum" key="OgeumStation" data="Ogeum">
        <text transform="translate(1117.2557 873.9435)" className="st0 st1">오금</text>
      </g>
      <g onclick={this.handleClick} id="Onsu" key="OnsuStation" data="Onsu">
        <text transform="translate(212.3871 907.1788)" className="st0 st1">온수</text>
      </g>
      <g onclick={this.handleClick} id="Oido" key="OidoStation" data="Oido">
      ...
      <g onclick={this.handleClick} id="Geumjeong" key="GeumjeongStation" data="Geumjeong">
        <text transform="translate(669.5272 1113.2062)" className="st0 st1">금정</text>
      </g>
      <g onclick={this.handleClick} id="Suwon" key="SuwonStation" data="Suwon">
        <text transform="translate(769.3934 1141.7072)" className="st0 st1">수원</text>
      </g>
      <g onclick={this.handleClick} id="Byeongjeom" key="ByeongjeomStation" data="Byeongjeom">
        <text transform="translate(789.9432 1170.1271)" className="st0 st1">병점</text>
      </g>
      <g onclick={this.handleClick} id="Giheung" key="GiheungStation" data="Giheung">
      ...
      <g onclick={this.handleClick} id="DongdaemunHistoryCulturePark" key="DongdaemunHistoryCultureParkStation" data="DongdaemunHistoryCulturePark">
      ...
      <g onclick={this.handleClick} id="GuroDigitalComplex" key="GuroDigitalComplexStation" data="GuroDigitalComplex">
    ...
    <g onclick={this.handleClick} id="broad" key="broadStation" data="broad">
      <g onclick={this.handleClick} id="GangnamGu" key="GangnamGuStation" data="GangnamGu">
        <text transform="translate(946.6327 985.6007)" className="st3 st0 st4">강남구</text>
      </g>
      <g onclick={this.handleClick} id="SeochoGu" key="SeochoGuStation" data="SeochoGu">
        <text transform="translate(758.9042 981.338)" className="st3 st0 st4">서초구</text>
      </g>
      <g onclick={this.handleClick} id="SongpaGu" key="SongpaGuStation" data="SongpaGu">
        <text transform="translate(1066.1063 844.8058)" className="st3 st0 st4">송파구</text>
      </g>
      <g onclick={this.handleClick} id="GangdongGu" key="GangdongGuStation" data="GangdongGu">
        <text transform="translate(1181.3065 746.673)" className="st3 st0 st4">강동구</text>
      </g>
      <g onclick={this.handleClick} id="GwanakGu" key="GwanakGuStation" data="GwanakGu">
        <text transform="translate(562.64 994.1437)" className="st3 st0 st4">관악구</text>
      </g>
      <g onclick={this.handleClick} id="DongjakGu" key="DongjakGuStation" data="DongjakGu">
        <text transform="translate(558.3783 900.2755)" className="st3 st0 st4">동작구</text>
      </g>
      <g onclick={this.handleClick} id="GeumcheonGu" key="GeumcheonGuStation" data="GeumcheonGu">
        <text transform="translate(447.4486 985.6095)" className="st3 st0 st4">금천구</text>
      </g>
      <g onclick={this.handleClick} id="GuroGu" key="GuroGuStation" data="GuroGu">
        <text transform="translate(323.7133 913.0812)" className="st3 st0 st4">구로구</text>
      </g>
      <g onclick={this.handleClick} id="YangcheonGu" key="YangcheonGuStation" data="YangcheonGu">
        <text transform="translate(310.9154 806.4152)" className="st3 st0 st4">양천구</text>
      </g>
      <g onclick={this.handleClick} id="GangseoGu" key="GangseoGuStation" data="GangseoGu">
        <text transform="translate(306.6537 712.545)" className="st3 st0 st4">강서구</text>
      </g>
      <g onclick={this.handleClick} id="MapoGu" key="MapoGuStation" data="MapoGu">
        <text transform="translate(571.184 682.6798)" className="st3 st0 st4">마포구</text>
      </g>
      <g onclick={this.handleClick} id="EunpyeongGu" key="EunpyeongGuStation" data="EunpyeongGu">
        <text transform="translate(502.9174 554.6818)" className="st3 st0 st4">은평구</text>
      </g>
      <g onclick={this.handleClick} id="SeodaemunGu" key="SeodaemunGuStation" data="SeodaemunGu">
        <text transform="translate(536.7123 610.1505)" className="st3 st0 st4">서대문구</text>
      </g>
      <g onclick={this.handleClick} id="JongnoGu" key="JongnoGuStation" data="JongnoGu">
        <text transform="translate(665.0526 529.087)" className="st3 st0 st4">종로구</text>
      </g>
      <g onclick={this.handleClick} id="JungGu" key="JungGuStation" data="JungGu">
        <text transform="translate(708.0585 674.1534)" className="st3 st0 st4">중구</text>
      </g>
      <g onclick={this.handleClick} id="SeongdongGu" key="SeongdongGuStation" data="SeongdongGu">
        <text transform="translate(822.9159 704.0197)" className="st3 st0 st4">성동구</text>
      </g>
      <g onclick={this.handleClick} id="DongdaemunGu" key="DongdaemunGuStation" data="DongdaemunGu">
        <text transform="translate(907.9091 588.8195)" className="st3 st0 st4">동대문구</text>
      </g>
      <g onclick={this.handleClick} id="JungnangGu" key="JungnangGuStation" data="JungnangGu">
        <text transform="translate(993.578 477.8888)" className="st3 st0 st4">중랑구</text>
      </g>
      <g onclick={this.handleClick} id="DobongGu" key="DobongGuStation" data="DobongGu">
        <text transform="translate(818.6444 247.4884)" className="st3 st0 st4">도봉구</text>
      </g>
      <g onclick={this.handleClick} id="GangbukGu" key="GangbukGuStation" data="GangbukGu">
        <text transform="translate(763.1757 422.42)" className="st3 st0 st4">강북구</text>
      </g>
      <g onclick={this.handleClick} id="SeongbukGu" key="SeongbukGuStation" data="SeongbukGu">
        <text transform="translate(784.5077 533.3497)" className="st3 st0 st4">성북구</text>
      </g>
      <g onclick={this.handleClick} id="GwangjinGu" key="GwangjinGuStation" data="GwangjinGu">
        <text transform="translate(1014.9091 652.8136)" className="st3 st0 st4">광진구</text>
      </g>
      <g onclick={this.handleClick} id="YongsanGu" key="YongsanGuStation" data="YongsanGu">
        <text transform="translate(686.3749 772.2775)" className="st3 st0 st4">용산구</text>
      </g>
      <g onclick={this.handleClick} id="YeongdeungpoGu" key="YeongdeungpoGuStation" data="YeongdeungpoGu">
        <text transform="translate(464.1742 853.34)" className="st3 st0 st4">영등포구</text>
      </g>
      <g onclick={this.handleClick} id="NowonGu" key="NowonGuStation" data="NowonGu">
