...
const itemListTwo = [ <Ellipse size={'40vw'}/>,<Circle size={'40vw'}/>,<Rectangular size={'40vw'}/>,<Triangle size={'40vw'}/>,<Rhombus size={'40vw'}/>]
...
class Window extends Component {
    ...
    fetchMoreData(element, scrollLevel) {
        ...
        this.interval = setInterval(()=>{
            this.setState({
                ...
                choosePage : this.change(itemListTwo)
            })
        }, 80)
    ...
    render(){
        const { show, okArray, inputOn, sendTextOn, windowUp, value, textOn, nonPass, arr, downArr, imgLoaded, fetching, chooseHead, choosePage } = this.state;
                ...
                <div className="window-content">
                    ...
                    <div className="content-computer-sec">알면 계속 내려주세요</div>
                        <div className="img-content">
                            ...
                            { fetching ? 
                                <div className="chooseImg">{choosePage}</div> : null }
