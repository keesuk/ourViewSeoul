                        ...
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                ? <g transform={'translate(10, 30) scale(.7)'}>
                                    <text transform="translate(80 30)" className="rhombus">&#9670; 박물관 갤러리</text>
                                    <text transform="translate(80 90)" className="triangle">▲ 자연 휴양지</text>
                                    <text transform="translate(80 150)" className="rectang">■ 쇼핑 마켓</text>
                                    <text transform="translate(80 210)" className="circle">● 랜드마크</text>
                                    <text transform="translate(80 270)" className="ellipse">⬮  음식점</text>
                                </g>
                                : null}
