...
const DiceDiv = styled.div`
    ...
    .front { 
        transform: rotateY(0deg) translateZ(4.7vw);
    ...
    .back { 
        transform: rotateX(180deg) translateZ(4.7vw);
    ...
    .right { 
        transform: rotateY(90deg) translateZ(4.7vw); 
    ...
    .top { 
        transform: rotateX(90deg) translateZ(4.7vw);
