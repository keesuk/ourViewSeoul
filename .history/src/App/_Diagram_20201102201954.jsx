...
export function infoGraphic(location, corArr, i){
    ...
    function typeCheck(id, corA, corB, i){ 
        ...
        if(id.id === 0){
            return circlePin(checkSize(id), `translate(${corA.toString()}, ${corB.toString()})`, i)
        }else if(id.id === 1){
            return rectPin(checkSize(id), corA.toString(), corB.toString(), i)
        }else if(id.id === 2){
            return trianglePin(checkSize(id), `translate(${corA.toString()}, ${corB.toString()})`, i)
        }else if(id.id === 3){
            return rhombusPin(null, checkSize(id), corA.toString(), corB.toString(), i)
        }else if(id.id === 4){
            corA = corA + 100
            corB = corB - 530
            return ellipsePin(checkSize(id), corA.toString(), corB.toString(), `rotate(30, 0, 0)`, i)
        }
    }
