    ...
    render() {
        ...
        return(
            <OutputWrapper 
                ...
                style={{ 
                    transform: pageUp ? 'translateY(-97vh)' : 'translateY(-23vh)',
                    width: pageUp ? '100vw' : '95vw',
                    backgroundColor: pageUp ? '#111' : 'white',
                }}
            >
                <div>
                    ...
                    <OutputButton
                        ...
                        style={{
                            color: pageUp ? (scrolling ? '#111' : 'white') : '#111'
                        }}
                    >
                        ￣
                    </OutputButton>
                    {pageUp ? <Poster posterOn={this.props.posterOn}/> : null }
                </div>
            </OutputWrapper>
        )
    }
