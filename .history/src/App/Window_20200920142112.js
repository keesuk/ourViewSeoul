...
class Window extends Component {
    ...
    render(){
        ...
        if(!stationDatas && !stationDatas.locatioName && !stationDatas.locationData) {
            return null;
          }
                    ...
                    <div className="answer">
                        ...
                        {/* { stationDatas[0] && stationDatas[0].locationData 
                            ? stationDatas.map(stationData =>  
                                ...
                                />)
                            : null } */}
                        { stationDatas[0] && stationDatas[0].locationData && <Img key={stationDatas[0] && stationDatas[0].locatioName} points={stationDatas[0] && stationDatas[0].locationData} className="img-stations" />}
                    <div className="input">
                        완료
                    </div>
                </div>
