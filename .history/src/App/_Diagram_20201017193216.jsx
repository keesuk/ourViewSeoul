...
export class Ellipse extends React.PureComponent {
    render() {
        const { on, right, left, width, height } = this.props
        return(
            <EllipseDiv
                style ={{ backgroundColor: on.length !== 0
                    ? '#EFC820'
            ...
            <PinSvg width={this.props.width} height={this.props.height} viewBox='0 -5 70 80' fill="none">
                <g clipPath="url(#prefix__clip0)">
                    <path
                        ...
                        d={this.props.choose==='red'
                            ...
                            ? "M.571 74.2h65.9l2.9 3.3H.571v-3.3z" : (this.props.choose==='yellow' 
                            ? "M68.9 74.2H3L.1 77.5h68.8v-3.3z" : null ))))}
                    ...
                    <path
                        d={this.props.choose==='red'
                            ...
                            ? "M42.771 37.4l-3.5 2.6 25 34.4 5.2 3.4-1.6-6-25.1-34.4z" : (this.props.choose==='yellow' 
                            ? "M26.7 37.4l3.5 2.6-25 34.4L0 77.8l1.6-6 25.1-34.4z" : null ))))}
                ...
                <defs>
                    <linearGradient
                        ...
                        x1={this.props.choose==='red'? 60.788 : (this.props.choose==='blue' ? 8.683: (this.props.choose==='green' ? 60.788 : (this.props.choose==='purple' ? 8.683 : (this.props.choose==='yellow' ? 60.788 : null))))}
                        y1={75.863}
                        x2={this.props.choose==='red'? 17.936 : (this.props.choose==='blue' ? 51.535: (this.props.choose==='green' ? 17.936 : (this.props.choose==='purple' ? 51.535 : (this.props.choose==='yellow' ? 17.936 : null))))}
                        y2={75.863}
                    ...
                    <linearGradient
                        ...
                        x1={this.props.choose==='red'? 15.979 : (this.props.choose==='blue' ? 53.492: (this.props.choose==='green' ? 15.979 : (this.props.choose==='purple' ? 53.492 : (this.props.choose==='yellow' ? 15.979 : null))))}
                        y1={59.527}
                        x2={this.props.choose==='red'? 13.483 : (this.props.choose==='blue' ? 55.988: (this.props.choose==='green' ? 13.483 : (this.props.choose==='purple' ? 55.988 : (this.props.choose==='yellow' ? 13.483 : null))))}
                        y2={57.709}
                        gradientUnits="userSpaceOnUse"
                    >
