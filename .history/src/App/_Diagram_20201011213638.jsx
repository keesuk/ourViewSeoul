...
export class AskMarker extends React.PureComponent {
    render(){ 
        const colorOn = this.props.color
        let markerOn = 
                <MarkerDiv 
                    style={{color:colorOn === 'red'
                        ? colorListTag[0] : (colorOn === 'green'
                        ? colorListTag[1]: (colorOn === 'blue'
                        ? colorListTag[2]: (colorOn === 'purple'
                        ? colorListTag[3] : (colorOn === 'yellow'
                        ? colorListTag[4] : null))))}}>
                    {colorOn === 'red' 
                        ? shapeItems[0] : (colorOn === 'green'
                        ? shapeItems[1]: (colorOn === 'blue'
                        ? shapeItems[2]: (colorOn === 'purple'
                        ? shapeItems[3] : (colorOn === 'yellow' 
                        ? shapeItems[4] : null))))}
                </MarkerDiv>

        if(colorOn !== ''){
            setTimeout(markerOn = null,2000)
        }
        return(
            <>
                {markerOn}
