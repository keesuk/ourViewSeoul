...
const DiceDiv = styled.div`
    ...
    .front { 
        transform: rotateY(0deg) translateZ(5.2vw);
    ...
    .back { 
        transform: rotateX(180deg) translateZ(5.2vw);
    ...
    .right { 
        transform: rotateY(90deg) translateZ(5.2vw); 
    ...
    .top { 
        transform: rotateX(90deg) translateZ(5.2vw);
