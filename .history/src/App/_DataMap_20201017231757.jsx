                ...
                <React.Fragment>
                    <TransformComponent>
                        <SvgContainer> 
                            ...
                            >
                            <g>
                                <text transform="translate(90 20)" className="st0 purple">&#9670; 박물관 갤러리</text>
                                <text transform="translate(40 60)" className="st0 blue">■ 쇼핑 마켓</text>
                                <text transform="translate(40 100)" className="st0 red">● 랜드마크</text>
                                <text transform="translate(40 140)" className="st0 green">▲ 자연 휴양지</text>
                                <text transform="translate(40 180)" className="st0 yellow">⬮ 음식점</text>
                            </g>
                            <g id="Ilsan" >
