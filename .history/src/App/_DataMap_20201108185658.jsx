...
const diagramList = ['◆', '■', '●', '▲', '⬮']
const location = [
    {name : 'Bulgwang', number: 62, id: 0},
    {name : 'Sujiguoffice', number: 63, id: 1},
    {name : 'Euljiro4saga', number: 74, id: 2},
    {name : 'Noryangjin', number: 92, id: 3},
    {name : 'Wolgye', number: 54, id: 4},
]
...
class MapShow extends PureComponent {
    ...
    componentDidMount(){
        ...
        setTimeout(() => {
            this.setState({dataLocation : location})
            this.parsingCor()
            }, 1000)
    }
    ...
    render() {
        const { scale, panOff, stroke, pointer, pageUp } = this.props
                        ...
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                <g style={{mixBlendMode: 'multiply'}}>
                                    {pageUp && this.state.dataLocation !== [] ? this.state.dataLocation.map((one, i) => infoGraphic(one, this.state.corArr[i], i)) : null}
                                </g>
                            </Svg>
                            </SvgContainer>
                        </TransformComponent>
