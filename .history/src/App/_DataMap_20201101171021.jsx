                        ...
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                ? <g>
                                    ...
                                    <text transform="translate(80 120)" className="green">▲ 자연 휴양지</text>
                                    <text transform="translate(80 200)" className="blue">■ 쇼핑 마켓</text>
                                    <text transform="translate(80 280)" className="red">● 랜드마크</text>
                                    <text transform="translate(80 360)" className="yellow">⬮ 음식점</text>
                                </g>
                                : null}
