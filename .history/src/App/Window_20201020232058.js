                    ...
                    <div className="header-content">
                        ...
                        <div className="tag-wrapper">
                            {stationDatas.map((stationData, i) =>
                                ...
                                ? <Circle left={'3px'} right={'0px'} size={'15px'} key={i} on={okArray.filter(value => value === i)}/> 
                                : (stationData && stationData.locationTagID === shopping
                                ? <Rectangular left={'3px'} right={'0px'} size={'15px'} key={i} on={okArray.filter(value => value === i)}/> 
                                : (stationData && stationData.locationTagID === museum
                                ? <Rhombus left={'3px'} right={'0px'} size={'15px'} key={i} on={okArray.filter(value => value === i)}/> 
                                : (stationData && stationData.locationTagID === cafe
                                ? <Ellipse left={'3px'} right={'0px'} size={'17px'} key={i} on={okArray.filter(value => value === i)}/> 
                                : <Triangle left={'3px'} right={'0px'} size={'15px'} key={i} on={okArray.filter(value => value === i)}/>
                            ))))}
                        </div>
                    </div>
                </header>
