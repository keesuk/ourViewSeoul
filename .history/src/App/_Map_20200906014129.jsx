...
class Map extends PureComponent {
  ...
  render() {
    ...
    <Svg
      ...
      xmlSpace="preserve"
    >
    <g id="map" key="mapSt_ation" data="map">
      ...
      <g onClick={this.handleClick} id="Pungsan" key="Pungs_anStation" data="Pungsan">
      ...
      <g onClick={this.handleClick} id="Baengma" key="Baeng_maStation" data="Baengma">
      ...
      <g onClick={this.handleClick} id="Wondang" key="Wonda_ngStation" data="Wondang">
      ...
      <g onClick={this.handleClick} id="Wonheung" key="Wonhe_ungStation" data="Wonheung">
      ...
      <g onClick={this.handleClick} id="Samsong" key="Samso_ngStation" data="Samsong">
      ...
      <g onClick={this.handleClick} id="Tanhyeon" key="Tanhy_eonStation" data="Tanhyeon">
      ...
      <g onClick={this.handleClick} id="Unjeong" key="Unjeo_ngStation" data="Unjeong">
      ...
      <g onClick={this.handleClick} id="Geumneung" key="Geumn_eungStation" data="Geumneung">
      ...
      <g onClick={this.handleClick} id="Geumchon" key="Geumc_honStation" data="Geumchon">
      ...
      <g onClick={this.handleClick} id="Wollong" key="Wollo_ngStation" data="Wollong">
      ...
      <g onClick={this.handleClick} id="Paju" key="PajuS_tation" data="Paju">
      ...
      <g onClick={this.handleClick} id="Munsan" key="Munsa_nStation" data="Munsan">
      ...
      <g onClick={this.handleClick} id="Songnae" key="Songn_aeStation" data="Songnae">
      ...
      <g onClick={this.handleClick} id="Jungdong" key="Jungd_ongStation" data="Jungdong">
      ...
      <g onClick={this.handleClick} id="Bucheon" key="Buche_onStation" data="Bucheon">
      ...
      <g onClick={this.handleClick} id="Sosa" key="SosaS_tation" data="Sosa">
      ...
      <g onClick={this.handleClick} id="Yeokgok" key="Yeokg_okStation" data="Yeokgok">
      ...
      <g onClick={this.handleClick} id="Technopark" key="Techn_oparkStation" data="Technopark">
      ...
      <g onClick={this.handleClick} id="BITZone" key="BITZo_neStation" data="BITZone">
      ...
      <g onClick={this.handleClick} id="IncheonNatlUniv" key="Inche_onNatlUnivStation" data="IncheonNatlUniv">
      ...
      <g onClick={this.handleClick} id="CentralPark" key="Centr_alParkStation" data="CentralPark">
      ...
      <g onClick={this.handleClick} id="IntlBusinessDistrict" key="IntlB_usinessDistrictStation" data="IntlBusinessDistrict">
      ...
      <g onClick={this.handleClick} id="SingilonCheon" key="Singi_lonCheonStation" data="SingilonCheon">
      ...
      <g onClick={this.handleClick} id="Sinchang" key="Sinch_angStation" data="Sinchang">
      ...
      <g onClick={this.handleClick} id="OnyangonCheon" key="Onyan_gonCheonStation" data="OnyangonCheon">
      ...
      <g onClick={this.handleClick} id="Baebang" key="Baeba_ngStation" data="Baebang">
      ...
      <g onClick={this.handleClick} id="Asan" key="AsanS_tation" data="Asan">
      ...
      <g onClick={this.handleClick} id="Ssangyong" key="Ssang_yongStation" data="Ssangyong">
      ...
      <g onClick={this.handleClick} id="Bongmyeong" key="Bongm_yeongStation" data="Bongmyeong">
      ...
      <g onClick={this.handleClick} id="Cheonan" key="Cheon_anStation" data="Cheonan">
      ...
      <g onClick={this.handleClick} id="Dujeong" key="Dujeo_ngStation" data="Dujeong">
      ...
      <g onClick={this.handleClick} id="Jiksan" key="Jiksa_nStation" data="Jiksan">
      ...
      <g onClick={this.handleClick} id="Seonghwan" key="Seong_hwanStation" data="Seonghwan">
      ...
      <g onClick={this.handleClick} id="Pyeongtaek" key="Pyeon_gtaekStation" data="Pyeongtaek">
      ...
      <g onClick={this.handleClick} id="Jije" key="JijeS_tation" data="Jije">
      ...
      <g onClick={this.handleClick} id="Seojeongri" key="Seoje_ongriStation" data="Seojeongri">
      ...
      <g onClick={this.handleClick} id="Songtan" key="Songt_anStation" data="Songtan">
      ...
      <g onClick={this.handleClick} id="Osan" key="OsanS_tation" data="Osan">
      ...
      <g onClick={this.handleClick} id="OsanCollege" key="OsanC_ollegeStation" data="OsanCollege">
      ...
      <g onClick={this.handleClick} id="Sema" key="SemaS_tation" data="Sema">
      ...
      <g onClick={this.handleClick} id="Seodongtan" key="Seodo_ngtanStation" data="Seodongtan">
      ...
      <g onClick={this.handleClick} id="Jungang" key="Junga_ngStation" data="Jungang">
      ...
      <g onClick={this.handleClick} id="HanyangUnivatAnsan" key="Hanya_ngUnivatAnsanStation" data="HanyangUnivatAnsan">
      ...
      <g onClick={this.handleClick} id="Sangnoksu" key="Sangn_oksuStation" data="Sangnoksu">
      ...
      <g onClick={this.handleClick} id="Banwol" key="Banwo_lStation" data="Banwol">
      ...
      <g onClick={this.handleClick} id="Daeyami" key="Daeya_miStation" data="Daeyami">
      ...
      <g onClick={this.handleClick} id="Surisan" key="Suris_anStation" data="Surisan">
      ...
      <g onClick={this.handleClick} id="SuwonCityHall1" key="Suwon_CityHall1Station" data="SuwonCityHall1">
      ...
      <g onClick={this.handleClick} id="SuwonCityHall" key="Suwon_CityHallStation" data="SuwonCityHall">
      ...
      <g onClick={this.handleClick} id="MaetanGwonseon" key="Maeta_nGwonseonStation" data="MaetanGwonseon">
      ...
      <g onClick={this.handleClick} id="Mangpo" key="Mangp_oStation" data="Mangpo">
      ...
      <g onClick={this.handleClick} id="Yeongtong" key="Yeong_tongStation" data="Yeongtong">
      ...
      <g onClick={this.handleClick} id="Cheongmyeong" key="Cheon_gmyeongStation" data="Cheongmyeong">
      ...
      <g onClick={this.handleClick} id="Sanggal" key="Sangg_alStation" data="Sanggal">
      ...
      <g onClick={this.handleClick} id="Singal" key="Singa_lStation" data="Singal">
      ...
      <g onClick={this.handleClick} id="Guseong" key="Guseo_ngStation" data="Guseong">
      ...
      <g onClick={this.handleClick} id="Bojeong" key="Bojeo_ngStation" data="Bojeong">
      ...
      <g onClick={this.handleClick} id="Jukjeon" key="Jukje_onStation" data="Jukjeon">
      ...
      <g onClick={this.handleClick} id="Ori" key="OriSt_ation" data="Ori">
      ...
      <g onClick={this.handleClick} id="MyongjiUniv" key="Myong_jiUnivStation" data="MyongjiUniv">
      ...
      <g onClick={this.handleClick} id="Samga1" key="Samga_1Station" data="Samga1">
      ...
      <g onClick={this.handleClick} id="Chodang" key="Choda_ngStation" data="Chodang">
      ...
      <g onClick={this.handleClick} id="Dongbaek" key="Dongb_aekStation" data="Dongbaek">
      ...
      <g onClick={this.handleClick} id="Eojeong" key="Eojeo_ngStation" data="Eojeong">
      ...
      <g onClick={this.handleClick} id="Jiseok" key="Jiseo_kStation" data="Jiseok">
      ...
      <g onClick={this.handleClick} id="Gulpocheon" key="Gulpo_cheonStation" data="Gulpocheon">
      ...
      <g onClick={this.handleClick} id="SamsanGymnasium" key="Samsa_nGymnasiumStation" data="SamsanGymnasium">
      ...
      <g onClick={this.handleClick} id="BucheonCityHall" key="Buche_onCityHallStation" data="BucheonCityHall">
      ...
      <g onClick={this.handleClick} id="Sinjungdong" key="Sinju_ngdongStation" data="Sinjungdong">
      ...
      <g onClick={this.handleClick} id="Sangdong" key="Sangd_ongStation" data="Sangdong">
      ...
      <g onClick={this.handleClick} id="Jeongwang" key="Jeong_wangStation" data="Jeongwang">
      ...
      <g onClick={this.handleClick} id="Ungilsan1" key="Ungil_san1Station" data="Ungilsan1">
      ...
      <g onClick={this.handleClick} id="Ungilsan" key="Ungil_sanStation" data="Ungilsan">
      ...
      <g onClick={this.handleClick} id="Yangsu" key="Yangs_uStation" data="Yangsu">
      ...
      <g onClick={this.handleClick} id="Sinwon" key="Sinwo_nStation" data="Sinwon">
      ...
      <g onClick={this.handleClick} id="Asin" key="AsinS_tation" data="Asin">
      ...
      <g onClick={this.handleClick} id="Obin" key="ObinS_tation" data="Obin">
      ...
      <g onClick={this.handleClick} id="Yangpyeong1" key="Yangp_yeong1Station" data="Yangpyeong1">
      ...
      <g onClick={this.handleClick} id="Wondeok" key="Wonde_okStation" data="Wondeok">
      ...
      <g onClick={this.handleClick} id="Yongmun" key="Yongm_unStation" data="Yongmun">
      ...
      <g onClick={this.handleClick} id="Paldang" key="Palda_ngStation" data="Paldang">
      ...
      <g onClick={this.handleClick} id="CampusTown" key="Campu_sTownStation" data="CampusTown">
      ...
      <g onClick={this.handleClick} id="KangnamUniv" key="Kangn_amUnivStation" data="KangnamUniv">
      ...
      <g onClick={this.handleClick} id="Sanbon" key="Sanbo_nStation" data="Sanbon">
      ...
      <g onClick={this.handleClick} id="Mullae" key="Mulla_eStation" data="Mullae">
        <text transform="translate(421.9213 808.1027)" className="st0 st1">문래</text>
      </g>
      <g onClick={this.handleClick} id="Beomgye" key="Beomg_yeStation" data="Beomgye">
        <text transform="translate(689.579 1103.5685)" className="st0 st1">범계</text>
      </g>
      <g onClick={this.handleClick} id="Pyeongchon" key="Pyeon_gchonStation" data="Pyeongchon">
        <text transform="translate(689.579 1088.3175)" className="st0 st1">평촌</text>
      </g>
      <g onClick={this.handleClick} id="Indeogwon" key="Indeo_gwonStation" data="Indeogwon">
        <text transform="translate(689.579 1073.0675)" className="st0 st1">인덕원</text>
      </g>
      <g onClick={this.handleClick} id="GovernmentComplexGwacheon" key="Gover_nmentComplexGwacheonStation" data="GovernmentComplexGwacheon">
        <text transform="translate(689.579 1057.8116)" className="st0 st1">정부과천청사</text>
      </g>
      <g onClick={this.handleClick} id="Gwacheon" key="Gwach_eonStation" data="Gwacheon">
        <text transform="translate(689.579 1042.5616)" className="st0 st1">과천</text>
      </g>
      <g onClick={this.handleClick} id="SeoulGrandPark" key="Seoul_GrandParkStation" data="SeoulGrandPark">
        <text transform="translate(689.579 1027.3038)" className="st0 st1">대공원</text>
      </g>
      <g onClick={this.handleClick} id="SeoulRacecoursePark" key="Seoul_RacecourseParkStation" data="SeoulRacecoursePark">
        <text transform="translate(689.579 1012.0548)" className="st0 st1">경마공원</text>
      </g>
      <g onClick={this.handleClick} id="Seonbawi" key="Seonb_awiStation" data="Seonbawi">
        <text transform="translate(689.579 996.8038)" className="st0 st1">선바위</text>
      </g>
      <g onClick={this.handleClick} id="Namtaeryeong" key="Namta_eryeongStation" data="Namtaeryeong">
        <text transform="translate(689.579 981.547)" className="st0 st1">남태령</text>
      </g>
      <g onClick={this.handleClick} id="Geomam" key="Geoma_mStation" data="Geomam">
        <text transform="translate(74.4359 557.6925)" className="st0 st1">검암</text>
      </g>
      <g onClick={this.handleClick} id="Gyulhyeon" key="Gyulh_yeonStation" data="Gyulhyeon">
        <text transform="translate(74.4359 626.3771)" className="st0 st1">귤현</text>
      </g>
      <g onClick={this.handleClick} id="Bakchon" key="Bakch_onStation" data="Bakchon">
      ...
      <g onClick={this.handleClick} id="Gyesan" key="Gyesa_nStation" data="Gyesan">
        <text transform="translate(74.4359 725.1183)" className="st0 st1">계산</text>
      </g>
      <g onClick={this.handleClick} id="GyeonginNatlUnivofEducation" key="Gyeon_ginNatlUnivofEducationStation" data="GyeonginNatlUnivofEducation">
        <text transform="translate(74.4359 758.0304)" className="st0 st1">경인교대입구</text>
      </g>
      <g onClick={this.handleClick} id="CheongnaIntlCityStation" key="Cheon_gnaIntlCityStationStation" data="CheongnaIntlCityStation">
        <text transform="translate(75.9447 539.4855)" className="st0 st1">청라국제도시</text>
      </g>
      <g onClick={this.handleClick} id="Yongmasan" key="Yongm_asanStation" data="Yongmasan">
        <text transform="translate(999.2616 602.9288)" className="st0 st1">용마산</text>
      </g>
      <g onClick={this.handleClick} id="Sagajeong" key="Sagaj_eongStation" data="Sagajeong">
        <text transform="translate(999.2616 576.5245)" className="st0 st1">사가정</text>
      </g>
      <g onClick={this.handleClick} id="Myeonmok" key="Myeon_mokStation" data="Myeonmok">
        <text transform="translate(999.2616 547.546)" className="st0 st1">면목</text>
      </g>
      <g onClick={this.handleClick} id="Jungnang" key="Jungn_angStation" data="Jungnang">
        <text transform="translate(952.6971 533.172)" className="st0 st1">중랑</text>
      </g>
      <g onClick={this.handleClick} id="Sinnae" key="Sinna_eStation" data="Sinnae">
        <text transform="translate(1045.7147 457.4913)" className="st0 st1">신내</text>
      </g>
      <g onClick={this.handleClick} id="Changsin" key="Chang_sinStation" data="Changsin">
        <text transform="translate(786.6542 581.3898)" className="st0 st1">창신</text>
      </g>
      <g onClick={this.handleClick} id="Apgujeong" key="Apguj_eongStation" data="Apgujeong">
        <text transform="translate(798.9677 779.5177)" className="st0 st1">압구정</text>
      </g>
      <g onClick={this.handleClick} id="Saejeol" key="Saeje_olStation" data="Saejeol">
        <text transform="translate(487.3246 536.0724)" className="st0 st1">새절</text>
      </g>
      <g onClick={this.handleClick} id="Eungam" key="Eunga_mStation" data="Eungam">
        <text transform="translate(487.3246 509.6984)" className="st0 st1">응암</text>
      </g>
      <g onClick={this.handleClick} id="Gupabal" key="Gupab_alStation" data="Gupabal">
        <text transform="translate(503.6517 366.7472)" className="st0 st1">구파발</text>
      </g>
      <g onClick={this.handleClick} id="SookmyungWomensUniv" key="Sookm_yungWomensUnivStation" data="SookmyungWomensUniv">
        <text transform="translate(662.0165 707.6759)" className="st0 st1">숙대입구</text>
      </g>
      <g onClick={this.handleClick} id="Namyeong" key="Namye_ongStation" data="Namyeong">
      ...
      <g onClick={this.handleClick} id="GachonUniv" key="Gacho_nUnivStation" data="GachonUniv">
        <text transform="translate(1084.0741 1012.7999)" className="st0 st1">가천대</text>
      </g>
      <g onClick={this.handleClick} id="Jangji" key="Jangj_iStation" data="Jangji">
        <text transform="translate(1114.5497 957.3292)" className="st0 st1">장지</text>
      </g>
      <g onClick={this.handleClick} id="Dandaeogeori" key="Danda_eogeoriStation" data="Dandaeogeori">
        <text transform="translate(1144.9891 1032.671)" className="st0 st1">단대오거리</text>
      </g>
      <g onClick={this.handleClick} id="Taepyeong" key="Taepy_eongStation" data="Taepyeong">
        <text transform="translate(1089.6171 1036.5177)" className="st0 st1">태평</text>
      </g>
      <g onClick={this.handleClick} id="Banghak" key="Bangh_akStation" data="Banghak">
        <text transform="translate(861.9227 253.8585)" className="st0 st1">방학</text>
      </g>
      <g onClick={this.handleClick} id="Dobong" key="Dobon_gStation" data="Dobong">
        <text transform="translate(862.0604 209.5226)" className="st0 st1">도봉</text>
      </g>
      <g onClick={this.handleClick} id="Dokbawi" key="Dokba_wiStation" data="Dokbawi">
        <text transform="translate(547.1039 434.4816)" className="st0 st1">독바위</text>
      </g>
      <g onClick={this.handleClick} id="Sinheung" key="Sinhe_ungStation" data="Sinheung">
        <text transform="translate(1144.5682 1052.2491)" className="st0 st1">신흥</text>
      </g>
      <g onClick={this.handleClick} id="Geumho" key="Geumh_oStation" data="Geumho">
        <text transform="translate(789.7303 696.9347)" className="st0 st1">금호</text>
      </g>
      <g onClick={this.handleClick} id="Hyehwa" key="Hyehw_aStation" data="Hyehwa">
        <text transform="translate(744.8182 571.2072)" className="st0 st1">혜화</text>
      </g>
      <g onClick={this.handleClick} id="Achasan" key="Achas_anStation" data="Achasan">
        <text transform="translate(1007.2538 683.2189)" className="st0 st1">아차산</text>
      </g>
      <g onClick={this.handleClick} id="Jichuk" key="Jichu_kStation" data="Jichuk">
      ...
      <g onClick={this.handleClick} id="Munjeong" key="Munje_ongStation" data="Munjeong">
        <text transform="translate(1114.5575 926.8282)" className="st0 st1">문정</text>
      </g>
      <g onClick={this.handleClick} id="Mangwolsa" key="Mangw_olsaStation" data="Mangwolsa">
        <text transform="translate(880.5663 83.1691)" className="st0 st1">망월사</text>
      </g>
      <g onClick={this.handleClick} id="NamdongInduspark" key="Namdo_ngIndusparkStation" data="NamdongInduspark">
      ...
      <g onClick={this.handleClick} id="Hogupo" key="Hogup_oStation" data="Hogupo">
        <text transform="translate(258.9594 1085.7189)" className="st0 st1">호구포</text>
      </g>
      <g onClick={this.handleClick} id="IncheonNonhyeon" key="Inche_onNonhyeonStation" data="IncheonNonhyeon">
        <text transform="translate(290.5687 1085.7189)" className="st0 st1">인천논현</text>
      </g>
      <g onClick={this.handleClick} id="Gwanak" key="Gwana_kStation" data="Gwanak">
        <text transform="translate(499.1869 1111.7286)" className="st0 st1">관악</text>
      </g>
      <g onClick={this.handleClick} id="Anyang" key="Anyan_gStation" data="Anyang">
        <text transform="translate(559.2426 1111.7286)" className="st0 st1">안양</text>
      </g>
      <g onClick={this.handleClick} id="Myeonghak" key="Myeon_ghakStation" data="Myeonghak">
      ...
      <g onClick={this.handleClick} id="Dangjeong" key="Dangj_eongStation" data="Dangjeong">
        <text transform="translate(720.6688 1111.7286)" className="st0 st1">당정</text>
      </g>
      <g onClick={this.handleClick} id="Uiwang" key="Uiwan_gStation" data="Uiwang">
        <text transform="translate(740.9227 1111.7286)" className="st0 st1">의왕</text>
      </g>
      <g onClick={this.handleClick} id="SungkyunkwanUniv" key="Sungk_yunkwanUnivStation" data="SungkyunkwanUniv">
        <text transform="translate(755.7469 1111.7286)" className="st0 st1">성균관대</text>
      </g>
      <g onClick={this.handleClick} id="Sindaebang" key="Sinda_ebangStation" data="Sindaebang">
        <text transform="translate(470.9662 936.3361)" className="st0 st1">신대방</text>
      </g>
      <g onClick={this.handleClick} id="Bongcheon" key="Bongc_heonStation" data="Bongcheon">
        <text transform="translate(555.9603 938.84)" className="st0 st1">봉천</text>
      </g>
      <g onClick={this.handleClick} id="Euljiro1ilga" key="Eulji_ro1ilgaStation" data="Euljiro1ilga">
        <text transform="translate(671.5243 639.88)" className="st0 st1">을지로입구</text>
      </g>
      <g onClick={this.handleClick} id="Jongno5oga" key="Jongn_o5ogaStation" data="Jongno5oga">
      ...
      <g onClick={this.handleClick} id="Daebang" key="Daeba_ngStation" data="Daebang">
        <text transform="translate(512.4271 830.09)" className="st0 st1">대방</text>
      </g>
      <g onClick={this.handleClick} id="Sinpung" key="Sinpu_ngStation" data="Sinpung">
        <text transform="translate(459.8558 883.8019)" className="st0 st1">신풍</text>
      </g>
      <g onClick={this.handleClick} id="Namguro" key="Namgu_roStation" data="Namguro">
        <text transform="translate(384.9515 922.6007)" className="st0 st1">남구로</text>
      </g>
      <g onClick={this.handleClick} id="Boramae" key="Boram_aeStation" data="Boramae">
        <text transform="translate(490.9633 883.6583)" className="st0 st1">보라매</text>
      </g>
      <g onClick={this.handleClick} id="YangcheonHyanggyo" key="Yangc_heonHyanggyoStation" data="YangcheonHyanggyo">
        <text transform="translate(258.7406 614.8595)" className="st0 st1">양천향교</text>
      </g>
      <g onClick={this.handleClick} id="Magongnaru" key="Magon_gnaruStation" data="Magongnaru">
        <text transform="translate(214.4369 614.8595)" className="st0 st1">마곡나루</text>
      </g>
      <g onClick={this.handleClick} id="Sinbanghwa" key="Sinba_nghwaStation" data="Sinbanghwa">
        <text transform="translate(187.6635 614.8654)" className="st0 st1">신방화</text>
      </g>
      <g onClick={this.handleClick} id="IncheonIntlAirportCargoTerminal1" key="Inche_onIntlAirportCargoTerminal1Station" data="IncheonIntlAirportCargoTerminal1">
        <text transform="translate(138.6185 523.8781)" className="st0 st1">인천국제공항</text>
      </g>
      <g onClick={this.handleClick} id="IncheonIntlAirportCargoTerminal" key="Inche_onIntlAirportCargoTerminalStation" data="IncheonIntlAirportCargoTerminal">
      ...
      <g onClick={this.handleClick} id="Songjeong" key="Songj_eongStation" data="Songjeong">
      ...
      <g onClick={this.handleClick} id="Sinjeong" key="Sinje_ongStation" data="Sinjeong">
        <text transform="translate(304.0209 776.3175)" className="st0 st1">신정</text>
      </g>
      <g onClick={this.handleClick} id="Mokdong" key="Mokdo_ngStation" data="Mokdong">
        <text transform="translate(328.5228 776.3175)" className="st0 st1">목동</text>
      </g>
      <g onClick={this.handleClick} id="Omokgyo" key="Omokg_yoStation" data="Omokgyo">
        <text transform="translate(357.6205 776.3175)" className="st0 st1">오목교</text>
      </g>
      <g onClick={this.handleClick} id="Yangpyeong" key="Yangp_yeongStation" data="Yangpyeong">
        <text transform="translate(391.1205 776.3175)" className="st0 st1">양평</text>
      </g>
      <g onClick={this.handleClick} id="Gwanghwamun" key="Gwang_hwamunStation" data="Gwanghwamun">
        <text transform="translate(658.2391 601.0743)" className="st0 st1">광화문</text>
      </g>
      <g onClick={this.handleClick} id="Itaewon" key="Itaew_onStation" data="Itaewon">
        <text transform="translate(712.5272 752.3615)" className="st0 st1">이태원</text>
      </g>
      <g onClick={this.handleClick} id="Noksapyeong" key="Noksa_pyeongStation" data="Noksapyeong">
        <text transform="translate(688.8143 752.3927)" className="st0 st1">녹사평</text>
      </g>
      <g onClick={this.handleClick} id="Seobinggo" key="Seobi_nggoStation" data="Seobinggo">
        <text transform="translate(692.8485 808.8419)" className="st0 st1">서빙고</text>
      </g>
      <g onClick={this.handleClick} id="Gwangheungchang" key="Gwang_heungchangStation" data="Gwangheungchang">
        <text transform="translate(526.0931 706.4865)" className="st0 st1">광흥창</text>
      </g>
      <g onClick={this.handleClick} id="Sangsu" key="Sangs_uStation" data="Sangsu">
        <text transform="translate(502.5941 706.4865)" className="st0 st1">상수</text>
      </g>
      <g onClick={this.handleClick} id="Baekseok" key="Baeks_eokStation" data="Baekseok">
        <text transform="translate(396.8383 337.1681)" className="st0 st1">백석</text>
      </g>
      <g onClick={this.handleClick} id="Gyeongbokgung" key="Gyeon_gbokgungStation" data="Gyeongbokgung">
      ...
      <g onClick={this.handleClick} id="Myeongdong" key="Myeon_gdongStation" data="Myeongdong">
        <text transform="translate(690.7069 655.4435)" className="st0 st1">명동</text>
      </g>
      <g onClick={this.handleClick} id="LrtUijeongbu" key="LrtUi_jeongbuStation" data="LrtUijeongbu">
      ...
      <g onClick={this.handleClick} id="Beomgol" key="Beomg_olStation" data="Beomgol">
        <text transform="translate(794.1708 76.173)" className="st0 st1">범골</text>
      </g>
      <g onClick={this.handleClick} id="EwhaWomansUniv" key="EwhaW_omansUnivStation" data="EwhaWomansUniv">
        <text transform="translate(570.973 668.4698)" className="st0 st1">이대</text>
      </g>
      <g onClick={this.handleClick} id="Sinchon" key="Sinch_onStation" data="Sinchon">
        <text transform="translate(545.3705 668.4698)" className="st0 st1">신촌</text>
      </g>
      <g onClick={this.handleClick} id="SeoulNatlUniv" key="Seoul_NatlUnivStation" data="SeoulNatlUniv">
        <text transform="translate(580.7113 938.84)" className="st0 st1">서울대입구</text>
      </g>
      <g onClick={this.handleClick} id="SportsComplex" key="Sport_sComplexStation" data="SportsComplex">
        <text transform="translate(940.2528 837.0118)" className="st0 st1">종합운동장</text>
      </g>
      <g onClick={this.handleClick} id="Sincheon" key="Sinch_eonStation" data="Sincheon">
        <text transform="translate(984.3182 837.0118)" className="st0 st1">신천</text>
      </g>
      <g onClick={this.handleClick} id="Guui" key="GuuiS_tation" data="Guui">
        <text transform="translate(986.1659 730.9562)" className="st0 st1">구의</text>
      </g>
      <g onClick={this.handleClick} id="Yongdu" key="Yongd_uStation" data="Yongdu">
        <text transform="translate(854.2069 598.9894)" className="st0 st1">용두</text>
      </g>
      <g onClick={this.handleClick} id="Sangwangsimni" key="Sangw_angsimniStation" data="Sangwangsimni">
        <text transform="translate(811.2499 625.713)" className="st0 st1">상왕십리</text>
      </g>
      <g onClick={this.handleClick} id="Baegun" key="Baegu_nStation" data="Baegun">
        <text transform="translate(93.6683 908.3273)" className="st0 st1">백운</text>
      </g>
      <g onClick={this.handleClick} id="Anam" key="AnamS_tation" data="Anam">
      ...
      <g onClick={this.handleClick} id="DonggukUniv" key="Dongg_ukUnivStation" data="DonggukUniv">
      ...
      <g onClick={this.handleClick} id="Balgok" key="Balgo_kStation" data="Balgok">
        <text transform="translate(834.3466 90.2462)" className="st0 st1">발곡</text>
      </g>
      <g onClick={this.handleClick} id="YangcheonguOffice" key="Yangc_heonguOfficeStation" data="YangcheonguOffice">
        <text transform="translate(334.5287 832.7032)" className="st0 st1">양천구청</text>
      </g>
      <g onClick={this.handleClick} id="Oryudong" key="Oryud_ongStation" data="Oryudong">
        <text transform="translate(273.8597 904.9142)" className="st0 st1">오류동</text>
      </g>
      <g onClick={this.handleClick} id="Gaebong" key="Gaebo_ngStation" data="Gaebong">
        <text transform="translate(308.5941 890.5294)" className="st0 st1">개봉</text>
      </g>
      <g onClick={this.handleClick} id="Guil" key="GuilS_tation" data="Guil">
        <text transform="translate(343.3285 876.1427)" className="st0 st1">구일</text>
      </g>
      <g onClick={this.handleClick} id="Yeongdeungpo" key="Yeong_deungpoStation" data="Yeongdeungpo">
        <text transform="translate(461.0404 827.3663)" className="st0 st1">영등포</text>
      </g>
      <g onClick={this.handleClick} id="Nakseongdae" key="Nakse_ongdaeStation" data="Nakseongdae">
        <text transform="translate(626.4066 952.9073)" className="st0 st1">낙성대</text>
      </g>
      <g onClick={this.handleClick} id="Jangseungbaegi" key="Jangs_eungbaegiStation" data="Jangseungbaegi">
        <text transform="translate(536.3138 855.7374)" className="st0 st1">장승배기</text>
      </g>
      <g onClick={this.handleClick} id="Seocho" key="Seoch_oStation" data="Seocho">
        <text transform="translate(750.3729 914.8907)" className="st0 st1">서초</text>
      </g>
      <g onClick={this.handleClick} id="Yeoksam" key="Yeoks_amStation" data="Yeoksam">
        <text transform="translate(841.0106 877.3517)" className="st0 st1">역삼</text>
      </g>
      <g onClick={this.handleClick} id="Samseong" key="Samse_ongStation" data="Samseong">
        <text transform="translate(918.3514 845.3156)" className="st0 st1">삼성</text>
      </g>
      <g onClick={this.handleClick} id="Naebang" key="Naeba_ngStation" data="Naebang">
        <text transform="translate(707.8348 915.2042)" className="st0 st1">내방</text>
      </g>
      <g onClick={this.handleClick} id="Maebong" key="Maebo_ngStation" data="Maebong">
        <text transform="translate(866.4755 918.6427)" className="st0 st1">매봉</text>
      </g>
      <g onClick={this.handleClick} id="Daechi" key="Daech_iStation" data="Daechi">
        <text transform="translate(917.5995 897.4679)" className="st0 st1">대치</text>
      </g>
      <g onClick={this.handleClick} id="Hangnyeoul" key="Hangn_yeoulStation" data="Hangnyeoul">
        <text transform="translate(933.3632 888.6437)" className="st0 st1">학여울</text>
      </g>
      <g onClick={this.handleClick} id="Gaepodong" key="Gaepo_dongStation" data="Gaepodong">
      ...
      <g onClick={this.handleClick} id="Nonhyeon" key="Nonhy_eonStation" data="Nonhyeon">
        <text transform="translate(792.5858 830.3976)" className="st0 st1">논현</text>
      </g>
      <g onClick={this.handleClick} id="Sinnonhyeon" key="Sinno_nhyeonStation" data="Sinnonhyeon">
        <text transform="translate(807.8163 865.4386)" className="st0 st1">신논현</text>
      </g>
      <g onClick={this.handleClick} id="Sinbanpo" key="Sinba_npoStation" data="Sinbanpo">
        <text transform="translate(723.537 873.8068)" className="st0 st1">신반포</text>
      </g>
      <g onClick={this.handleClick} id="Gubanpo" key="Guban_poStation" data="Gubanpo">
        <text transform="translate(697.9911 884.3849)" className="st0 st1">구반포</text>
      </g>
      <g onClick={this.handleClick} id="Hakdong" key="Hakdo_ngStation" data="Hakdong">
      ...
      <g onClick={this.handleClick} id="Jamwon" key="Jamwo_nStation" data="Jamwon">
        <text transform="translate(760.9706 818.6056)" className="st0 st1">잠원</text>
      </g>
      <g onClick={this.handleClick} id="Ssangmun" key="Ssang_munStation" data="Ssangmun">
        <text transform="translate(837.9159 328.844)" className="st0 st1">쌍문</text>
      </g>
      <g onClick={this.handleClick} id="Sanggye" key="Sangg_yeStation" data="Sanggye">
        <text transform="translate(951.1698 281.9347)" className="st0 st1">상계</text>
      </g>
      <g onClick={this.handleClick} id="Dolgoji" key="Dolgo_jiStation" data="Dolgoji">
        <text transform="translate(891.8915 461.8497)" className="st0 st1">돌곶이</text>
      </g>
      <g onClick={this.handleClick} id="Sangwolgok" key="Sangw_olgokStation" data="Sangwolgok">
        <text transform="translate(866.8143 472.2335)" className="st0 st1">상월곡</text>
      </g>
      <g onClick={this.handleClick} id="Cheonwang" key="Cheon_wangStation" data="Cheonwang">
        <text transform="translate(249.766 921.631)" className="st0 st1">천왕</text>
      </g>
      <g onClick={this.handleClick} id="Gwangmyeongsageori" key="Gwang_myeongsageoriStation" data="Gwangmyeongsageori">
        <text transform="translate(293.5443 939.7677)" className="st0 st1">광명사거리</text>
      </g>
      <g onClick={this.handleClick} id="Cheolsan" key="Cheol_sanStation" data="Cheolsan">
        <text transform="translate(337.347 957.9113)" className="st0 st1">철산</text>
      </g>
      <g onClick={this.handleClick} id="Dapsimni" key="Dapsi_mniStation" data="Dapsimni">
        <text transform="translate(891.2655 617.3282)" className="st0 st1">답십리</text>
      </g>
      <g onClick={this.handleClick} id="Janghanpyeong" key="Jangh_anpyeongStation" data="Janghanpyeong">
        <text transform="translate(927.871 632.5148)" className="st0 st1">장한평</text>
      </g>
      <g onClick={this.handleClick} id="Gwangnaru" key="Gwang_naruStation" data="Gwangnaru">
        <text transform="translate(1041.4052 700.6486)" className="st0 st1">광나루</text>
      </g>
      <g onClick={this.handleClick} id="Heukseok" key="Heuks_eokStation" data="Heukseok">
        <text transform="translate(614.0482 858.0861)" className="st0 st1">흑석</text>
      </g>
      <g onClick={this.handleClick} id="Nodeul" key="Nodeu_lStation" data="Nodeul">
        <text transform="translate(584.6439 845.9044)" className="st0 st1">노들</text>
      </g>
      <g onClick={this.handleClick} id="YeongdeungpoMarket" key="Yeong_deungpoMarketStation" data="YeongdeungpoMarket">
        <text transform="translate(450.4623 786.9825)" className="st0 st1">영등포시장</text>
      </g>
      <g onClick={this.handleClick} id="Cheonggyesan" key="Cheon_ggyesanStation" data="Cheonggyesan">
        <text transform="translate(896.7645 1058.3624)" className="st0 st1">청계산입구</text>
      </g>
      <g onClick={this.handleClick} id="Pangyo" key="Pangy_oStation" data="Pangyo">
        <text transform="translate(1013.1346 1106.5685)" className="st0 st1">판교</text>
      </g>
      <g onClick={this.handleClick} id="Geoyeo" key="Geoye_oStation" data="Geoyeo">
      ...
      <g onClick={this.handleClick} id="Jegidong" key="Jegid_ongStation" data="Jegidong">
        <text transform="translate(826.6044 581.4777)" className="st0 st1">제기동</text>
      </g>
      <g onClick={this.handleClick} id="Hwarangdae" key="Hwara_ngdaeStation" data="Hwarangdae">
        <text transform="translate(969.8944 429.5343)" className="st0 st1">화랑대</text>
      </g>
      <g onClick={this.handleClick} id="Gaehwa" key="Gaehw_aStation" data="Gaehwa">
        <text transform="translate(134.14 583.5577)" className="st0 st1">개화</text>
      </g>
      <g onClick={this.handleClick} id="Daemosan" key="Daemo_sanStation" data="Daemosan">
        <text transform="translate(948.701 917.171)" className="st0 st1">대모산입구</text>
      </g>
      <g onClick={this.handleClick} id="Namhansanseong" key="Namha_nsanseongStation" data="Namhansanseong">
        <text transform="translate(1129.3563 1006.9806)" className="st0 st1">남한산성입구</text>
      </g>
      <g onClick={this.handleClick} id="Sanseong" key="Sanse_ongStation" data="Sanseong">
        <text transform="translate(1112.1952 999.3146)" className="st0 st1">산성</text>
      </g>
      <g onClick={this.handleClick} id="Godeok" key="Godeo_kStation" data="Godeok">
        <text transform="translate(1189.4667 675.1017)" className="st0 st1">고덕</text>
      </g>
      <g onClick={this.handleClick} id="Sangildong" key="Sangi_ldongStation" data="Sangildong">
        <text transform="translate(1223.0487 661.1915)" className="st0 st1">상일동</text>
      </g>
      <g onClick={this.handleClick} id="Bangbae" key="Bangb_aeStation" data="Bangbae">
        <text transform="translate(726.4237 955.3624)" className="st0 st1">방배</text>
      </g>
      <g onClick={this.handleClick} id="Sindaebangsamgeori" key="Sinda_ebangsamgeoriStation" data="Sindaebangsamgeori">
        <text transform="translate(520.8383 882.881)" className="st0 st1">신대방삼거리</text>
      </g>
      <g onClick={this.handleClick} id="Cheongdam" key="Cheon_gdamStation" data="Cheongdam">
        <text transform="translate(880.7245 796.1652)" className="st0 st1">청담</text>
      </g>
      <g onClick={this.handleClick} id="Guryong" key="Guryo_ngStation" data="Guryong">
        <text transform="translate(908.663 932.1075)" className="st0 st1">구룡</text>
      </g>
      <g onClick={this.handleClick} id="Sapyeong" key="Sapye_ongStation" data="Sapyeong">
        <text transform="translate(771.16 866.7296)" className="st0 st1">사평</text>
      </g>
      <g onClick={this.handleClick} id="Daeheung" key="Daehe_ungStation" data="Daeheung">
        <text transform="translate(552.9603 710.6827)" className="st0 st1">대흥</text>
      </g>
      <g onClick={this.handleClick} id="Hyochangpark" key="Hyoch_angparkStation" data="Hyochangpark">
        <text transform="translate(619.6166 721.6671)" className="st0 st1">효창공원앞</text>
      </g>
      <g onClick={this.handleClick} id="Hoehyeon" key="Hoehy_eonStation" data="Hoehyeon">
        <text transform="translate(668.2919 662.4005)" className="st0 st1">회현</text>
      </g>
      <g onClick={this.handleClick} id="Ahyeon" key="Ahyeo_nStation" data="Ahyeon">
        <text transform="translate(603.4515 666.7609)" className="st0 st1">아현</text>
      </g>
      <g onClick={this.handleClick} id="Ttukseom" key="Ttuks_eomStation" data="Ttukseom">
        <text transform="translate(872.4559 695.8458)" className="st0 st1">뚝섬</text>
      </g>
      <g onClick={this.handleClick} id="HanyangUniv" key="Hanya_ngUnivStation" data="HanyangUniv">
        <text transform="translate(870.9344 665.6212)" className="st0 st1">한양대</text>
      </g>
      <g onClick={this.handleClick} id="Seonyudo" key="Seony_udoStation" data="Seonyudo">
        <text transform="translate(420.4056 723.2706)" className="st0 st1">선유도</text>
      </g>
      <g onClick={this.handleClick} id="Bonghwasan" key="Bongh_wasanStation" data="Bonghwasan">
        <text transform="translate(1004.6229 435.257)" className="st0 st1">봉화산</text>
      </g>
      <g onClick={this.handleClick} id="HankukUnivofForeignStudies" key="Hanku_kUnivofForeignStudiesStation" data="HankukUnivofForeignStudies">
        <text transform="translate(893.3124 517.6534)" className="st0 st1">외대앞</text>
      </g>
      <g onClick={this.handleClick} id="HansungUniv" key="Hansu_ngUnivStation" data="HansungUniv">
        <text transform="translate(755.1346 544.089)" className="st0 st1">한성대입구</text>
      </g>
      <g onClick={this.handleClick} id="SungshinWomensUniv" key="Sungs_hinWomensUnivStation" data="SungshinWomensUniv">
        <text transform="translate(780.286 518.923)" className="st0 st1">성신여대입구</text>
      </g>
      <g onClick={this.handleClick} id="Gireum" key="Gireu_mStation" data="Gireum">
        <text transform="translate(809.5702 489.632)" className="st0 st1">길음</text>
      </g>
      <g onClick={this.handleClick} id="Uijeongbu" key="Uijeo_ngbuStation" data="Uijeongbu">
        <text transform="translate(810.5536 96.9786)" className="st0 st1">의정부</text>
      </g>
      <g onClick={this.handleClick} id="Ganeung" key="Ganeu_ngStation" data="Ganeung">
        <text transform="translate(799.1678 108.3645)" className="st0 st1">가능</text>
      </g>
      <g onClick={this.handleClick} id="Nogyang" key="Nogya_ngStation" data="Nogyang">
        <text transform="translate(787.7821 119.7511)" className="st0 st1">녹양</text>
      </g>
      <g onClick={this.handleClick} id="Yangju" key="Yangj_uStation" data="Yangju">
        <text transform="translate(776.3964 131.1368)" className="st0 st1">양주</text>
      </g>
      <g onClick={this.handleClick} id="Deokgye" key="Deokg_yeStation" data="Deokgye">
        <text transform="translate(765.0106 142.5226)" className="st0 st1">덕계</text>
      </g>
      <g onClick={this.handleClick} id="Deokjeong" key="Deokj_eongStation" data="Deokjeong">
        <text transform="translate(753.6249 153.9083)" className="st0 st1">덕정</text>
      </g>
      <g onClick={this.handleClick} id="Jihaeng" key="Jihae_ngStation" data="Jihaeng">
        <text transform="translate(742.2382 165.2941)" className="st0 st1">지행</text>
      </g>
      <g onClick={this.handleClick} id="Dongducheonjungang" key="Dongd_ucheonjungangStation" data="Dongducheonjungang">
      ...
      <g onClick={this.handleClick} id="Dongducheon" key="Dongd_ucheonStation" data="Dongducheon">
        <text transform="translate(708.08 199.4513)" className="st0 st1">동두천</text>
      </g>
      <g onClick={this.handleClick} id="Soyosan" key="Soyos_anStation" data="Soyosan">
        <text transform="translate(695.1903 210.837)" className="st0 st1">소요산</text>
      </g>
      <g onClick={this.handleClick} id="Tapseok" key="Tapse_okStation" data="Tapseok">
        <text transform="translate(642.1503 210.5558)" className="st0 st1">탑석</text>
      </g>
      <g onClick={this.handleClick} id="Songsan" key="Songs_anStation" data="Songsan">
        <text transform="translate(654.5829 198.1241)" className="st0 st1">송산</text>
      </g>
      <g onClick={this.handleClick} id="eoryong" key="eoryo_ngStation" data="eoryong">
        <text transform="translate(667.0145 185.6925)" className="st0 st1">어룡</text>
      </g>
      <g onClick={this.handleClick} id="gonjae" key="gonja_eStation" data="gonjae">
      ...
      <g onClick={this.handleClick} id="GyeonggiProvincialGovernmentNorthernOffice" key="Gyeon_ggiProvincialGovernmentNorthernOfficeStation" data="GyeonggiProvincialGovernmentNorthernOffice">
      ...
      <g onClick={this.handleClick} id="saemal" key="saema_lStation" data="saemal">
      ...
      <g onClick={this.handleClick} id="UijeongbuJungang" key="Uijeo_ngbuJungangStation" data="UijeongbuJungang">
        <text transform="translate(741.5995 111.1075)" className="st0 st1">의정부중앙</text>
      </g>
      <g onClick={this.handleClick} id="Heungseon" key="Heung_seonStation" data="Heungseon">
        <text transform="translate(754.0321 98.6749)" className="st0 st1">흥선</text>
      </g>
      <g onClick={this.handleClick} id="UijeongbuCityHall" key="Uijeo_ngbuCityHallStation" data="UijeongbuCityHall">
      ...
      <g onClick={this.handleClick} id="Imae" key="ImaeS_tation" data="Imae">
        <text transform="translate(1082.1708 1088.9445)" className="st0 st1">이매</text>
      </g>
      <g onClick={this.handleClick} id="Dunjeon" key="Dunje_onStation" data="Dunjeon">
        <text transform="translate(1121.7157 1106.173)" className="st0 st1">둔전</text>
      </g>
      <g onClick={this.handleClick} id="Bopyeong" key="Bopye_ongStation" data="Bopyeong">
      ...
      <g onClick={this.handleClick} id="Gimnyangjang" key="Gimny_angjangStation" data="Gimnyangjang">
        <text transform="translate(1073.0262 1154.8605)" className="st0 st1">김량장</text>
      </g>
      <g onClick={this.handleClick} id="Seohyeon" key="Seohy_eonStation" data="Seohyeon">
      ...
      <g onClick={this.handleClick} id="Migeum" key="Migeu_mStation" data="Migeum">
        <text transform="translate(1033.5135 1137.5939)" className="st0 st1">미금</text>
      </g>
      <g onClick={this.handleClick} id="Yeouinaru" key="Yeoui_naruStation" data="Yeouinaru">
      ...
      <g onClick={this.handleClick} id="Mapo" key="MapoS_tation" data="Mapo">
        <text transform="translate(577.6615 727.9991)" className="st0 st1">마포</text>
      </g>
      <g onClick={this.handleClick} id="Haengdang" key="Haeng_dangStation" data="Haengdang">
        <text transform="translate(827.621 663.5157)" className="st0 st1">행당</text>
      </g>
      <g onClick={this.handleClick} id="Jeungsan" key="Jeung_sanStation" data="Jeungsan">
        <text transform="translate(479.2523 571.1251)" className="st0 st1">증산</text>
      </g>
      <g onClick={this.handleClick} id="Yeokchon" key="Yeokc_honStation" data="Yeokchon">
        <text transform="translate(513.5922 481.5597)" className="st0 st1">역촌</text>
      </g>
      <g onClick={this.handleClick} id="Sangdo" key="Sangd_oStation" data="Sangdo">
        <text transform="translate(582.7338 865.4386)" className="st0 st1">상도</text>
      </g>
      <g onClick={this.handleClick} id="SoongsilUniv" key="Soong_silUnivStation" data="SoongsilUniv">
        <text transform="translate(606.9974 889.4269)" className="st0 st1">숭실대입구</text>
      </g>
      <g onClick={this.handleClick} id="Namseong" key="Namse_ongStation" data="Namseong">
        <text transform="translate(650.2245 932.6525)" className="st0 st1">남성</text>
      </g>
      <g onClick={this.handleClick} id="Saetgang" key="Saetg_angStation" data="Saetgang">
        <text transform="translate(529.5365 810.9698)" className="st0 st1">샛강</text>
      </g>
      <g onClick={this.handleClick} id="NationalAssembly" key="Natio_nalAssemblyStation" data="NationalAssembly">
        <text transform="translate(491.3148 772.7482)" className="st0 st1">국회의사당</text>
      </g>
      <g onClick={this.handleClick} id="Sinmokdong" key="Sinmo_kdongStation" data="Sinmokdong">
        <text transform="translate(391.8402 711.3087)" className="st0 st1">신목동</text>
      </g>
      <g onClick={this.handleClick} id="Yeomchang" key="Yeomc_hangStation" data="Yeomchang">
        <text transform="translate(374.5355 694.2609)" className="st0 st1">염창</text>
      </g>
      <g onClick={this.handleClick} id="Deungchon" key="Deung_chonStation" data="Deungchon">
        <text transform="translate(354.1381 673.8556)" className="st0 st1">등촌</text>
      </g>
      <g onClick={this.handleClick} id="Jeungmi" key="Jeung_miStation" data="Jeungmi">
        <text transform="translate(333.8324 653.546)" className="st0 st1">증미</text>
      </g>
      <g onClick={this.handleClick} id="Gayang" key="Gayan_gStation" data="Gayang">
        <text transform="translate(316.3783 636.0909)" className="st0 st1">가양</text>
      </g>
      <g onClick={this.handleClick} id="Soraepogu" key="Sorae_poguStation" data="Soraepogu">
        <text transform="translate(324.9467 1085.6925)" className="st0 st1">소래포구</text>
      </g>
      <g onClick={this.handleClick} id="Wolgot" key="Wolgo_tStation" data="Wolgot">
        <text transform="translate(368.5492 1088.9562)" className="st0 st1">월곶</text>
      </g>
      <g onClick={this.handleClick} id="Dalwol" key="Dalwo_lStation" data="Dalwol">
        <text transform="translate(391.1771 1111.0646)" className="st0 st1">달월</text>
      </g>
      <g onClick={this.handleClick} id="Songpa" key="Songp_aStation" data="Songpa">
        <text transform="translate(1067.3837 879.4728)" className="st0 st1">송파</text>
      </g>
      <g onClick={this.handleClick} id="Mangwon" key="Mangw_onStation" data="Mangwon">
        <text transform="translate(466.764 670.1866)" className="st0 st1">망원</text>
      </g>
      <g onClick={this.handleClick} id="MapoguOffice" key="Mapog_uOfficeStation" data="MapoguOffice">
        <text transform="translate(442.4828 642.8976)" className="st0 st1">마포구청</text>
      </g>
      <g onClick={this.handleClick} id="Muakjae" key="Muakj_aeStation" data="Muakjae">
        <text transform="translate(585.0648 567.8185)" className="st0 st1">무악재</text>
      </g>
      <g onClick={this.handleClick} id="Hongje" key="Hongj_eStation" data="Hongje">
        <text transform="translate(563.3627 545.9542)" className="st0 st1">홍제</text>
      </g>
      <g onClick={this.handleClick} id="Dongnimmun" key="Dongn_immunStation" data="Dongnimmun">
        <text transform="translate(615.5453 598.3068)" className="st0 st1">독립문</text>
      </g>
      <g onClick={this.handleClick} id="Aeogae" key="Aeoga_eStation" data="Aeogae">
        <text transform="translate(618.6469 685.504)" className="st0 st1">애오개</text>
      </g>
      <g onClick={this.handleClick} id="WorldCupStadium" key="World_CupStadiumStation" data="WorldCupStadium">
      ...
      <g onClick={this.handleClick} id="Dorimcheon" key="Dorim_cheonStation" data="Dorimcheon">
        <text transform="translate(374.4613 818.5802)" className="st0 st1">도림천</text>
      </g>
      <g onClick={this.handleClick} id="Gangmae" key="Gangm_aeStation" data="Gangmae">
        <text transform="translate(373.265 509.6857)" className="st0 st1">강매</text>
      </g>
      <g onClick={this.handleClick} id="Susaek" key="Susae_kStation" data="Susaek">
        <text transform="translate(433.3324 569.7531)" className="st0 st1">수색</text>
      </g>
      <g onClick={this.handleClick} id="Hannam" key="Hanna_mStation" data="Hannam">
        <text transform="translate(761.0575 761.4923)" className="st0 st1">한남</text>
      </g>
      <g onClick={this.handleClick} id="Eungbong" key="Eungb_ongStation" data="Eungbong">
        <text transform="translate(836.1512 686.4015)" className="st0 st1">응봉</text>
      </g>
      <g onClick={this.handleClick} id="Sillim" key="Silli_mStation" data="Sillim">
        <text transform="translate(528.5287 938.8146)" className="st0 st1">신림</text>
      </g>
      <g onClick={this.handleClick} id="Dongam" key="Donga_mStation" data="Dongam">
        <text transform="translate(66.7377 896.8781)" className="st0 st1">동암</text>
      </g>
      <g onClick={this.handleClick} id="Singeumho" key="Singe_umhoStation" data="Singeumho">
        <text transform="translate(798.2098 664.004)" className="st0 st1">신금호</text>
      </g>
      <g onClick={this.handleClick} id="Majang" key="Majan_gStation" data="Majang">
        <text transform="translate(866.2372 624.8868)" className="st0 st1">마장</text>
      </g>
      <g onClick={this.handleClick} id="AirportMarket" key="Airpo_rtMarketStation" data="AirportMarket">
        <text transform="translate(174.6918 628.8947)" className="st0 st1">공항시장</text>
      </g>
      <g onClick={this.handleClick} id="Seodaemun" key="Seoda_emunStation" data="Seodaemun">
        <text transform="translate(617.8002 624.0538)" className="st0 st1">서대문</text>
      </g>
      <g onClick={this.handleClick} id="Sinimun" key="Sinim_unStation" data="Sinimun">
        <text transform="translate(915.4833 495.5314)" className="st0 st1">신이문</text>
      </g>
      <g onClick={this.handleClick} id="Miasamgeori" key="Miasa_mgeoriStation" data="Miasamgeori">
        <text transform="translate(838.6932 459.8585)" className="st0 st1">미아사거리</text>
      </g>
      <g onClick={this.handleClick} id="Macheon" key="Mache_onStation" data="Macheon">
        <text transform="translate(1200.8905 889.0197)" className="st0 st1">마천</text>
      </g>
      <g onClick={this.handleClick} id="Chunui" key="Chunu_iStation" data="Chunui">
        <text transform="translate(189.9613 849.1359)" className="st0 st1">춘의</text>
      </g>
      <g onClick={this.handleClick} id="Hwaseo" key="Hwase_oStation" data="Hwaseo">
      ...
      <g onClick={this.handleClick} id="SogangUniv" key="Sogan_gUnivStation" data="SogangUniv">
        <text transform="translate(544.4047 681.3712)" className="st0 st1">서강대</text>
      </g>
      <g onClick={this.handleClick} id="TtukseomPark" key="Ttuks_eomParkStation" data="TtukseomPark">
        <text transform="translate(940.2401 761.049)" className="st0 st1">뚝섬유원지</text>
      </g>
      <g onClick={this.handleClick} id="ChildrensGrandPark" key="Child_rensGrandParkStation" data="ChildrensGrandPark">
        <text transform="translate(965.2235 700.8429)" className="st0 st1">어린이대공원</text>
      </g>
      <g onClick={this.handleClick} id="Junggok" key="Jungg_okStation" data="Junggok">
        <text transform="translate(992.455 635.2316)" className="st0 st1">중곡</text>
      </g>
      <g onClick={this.handleClick} id="Galmae" key="Galma_eStation" data="Galmae">
        <text transform="translate(1067.0897 396.6526)" className="st0 st1">갈매</text>
      </g>
      <g onClick={this.handleClick} id="Toegyewon" key="Toegy_ewonStation" data="Toegyewon">
        <text transform="translate(1079.5028 366.3839)" className="st0 st1">퇴계원</text>
      </g>
      <g onClick={this.handleClick} id="Byeollae" key="Byeol_laeStation" data="Byeollae">
        <text transform="translate(1073.3524 381.5157)" className="st0 st1">별내</text>
      </g>
      <g onClick={this.handleClick} id="Wolgok" key="Wolgo_kStation" data="Wolgok">
        <text transform="translate(842.6083 495.6193)" className="st0 st1">월곡</text>
      </g>
      <g onClick={this.handleClick} id="KoreaUniv" key="Korea_UnivStation" data="KoreaUniv">
        <text transform="translate(818.6522 539.2159)" className="st0 st1">고려대</text>
      </g>
      <g onClick={this.handleClick} id="Beotigogae" key="Beoti_gogaeStation" data="Beotigogae">
        <text transform="translate(730.1385 696.1583)" className="st0 st1">버티고개</text>
      </g>
      <g onClick={this.handleClick} id="Mongchontoseong" key="Mongc_hontoseongStation" data="Mongchontoseong">
        <text transform="translate(1072.6698 811.6027)" className="st0 st1">몽촌토성</text>
      </g>
      <g onClick={this.handleClick} id="GangdongguOffice" key="Gangd_ongguOfficeStation" data="GangdongguOffice">
        <text transform="translate(1093.1132 765.2765)" className="st0 st1">강동구청</text>
      </g>
      <g onClick={this.handleClick} id="Amsa" key="AmsaS_tation" data="Amsa">
        <text transform="translate(1122.7469 693.7228)" className="st0 st1">암사</text>
      </g>
      <g onClick={this.handleClick} id="Hangangjin" key="Hanga_ngjinStation" data="Hangangjin">
        <text transform="translate(721.8885 729.4581)" className="st0 st1">한강진</text>
      </g>
      <g onClick={this.handleClick} id="Gildong" key="Gildo_ngStation" data="Gildong">
        <text transform="translate(1156.3417 738.5021)" className="st0 st1">길동</text>
      </g>
      <g onClick={this.handleClick} id="Dunchondong" key="Dunch_ondongStation" data="Dunchondong">
        <text transform="translate(1141.3798 774.8517)" className="st0 st1">둔촌동</text>
      </g>
      <g onClick={this.handleClick} id="OlympicPark" key="Olymp_icParkStation" data="OlympicPark">
      ...
      <g onClick={this.handleClick} id="Gubeundari" key="Gubeu_ndariStation" data="Gubeundari">
        <text transform="translate(1168.2177 709.8361)" className="st0 st1">굽은다리</text>
      </g>
      <g onClick={this.handleClick} id="Myeongil" key="Myeon_gilStation" data="Myeongil">
        <text transform="translate(1176.8026 689.1134)" className="st0 st1">명일</text>
      </g>
      <g onClick={this.handleClick} id="Banghwa" key="Bangh_waStation" data="Banghwa">
        <text transform="translate(183.7484 582.7433)" className="st0 st1">방화</text>
      </g>
      <g onClick={this.handleClick} id="Gaehwasan" key="Gaehw_asanStation" data="Gaehwasan">
        <text transform="translate(174.4301 605.2452)" className="st0 st1">개화산</text>
      </g>
      <g onClick={this.handleClick} id="Suyu" key="SuyuS_tation" data="Suyu">
        <text transform="translate(818.7841 363.9923)" className="st0 st1">수유</text>
      </g>
      <g onClick={this.handleClick} id="Daehwa" key="Daehw_aStation" data="Daehwa">
        <text transform="translate(333.683 375.8468)" className="st0 st1">대화</text>
      </g>
      <g onClick={this.handleClick} id="Juyeop" key="Juyeo_pStation" data="Juyeop">
        <text transform="translate(341.3861 357.6085)" className="st0 st1">주엽</text>
      </g>
      <g onClick={this.handleClick} id="Jeongbalsan" key="Jeong_balsanStation" data="Jeongbalsan">
        <text transform="translate(343.266 339.3722)" className="st0 st1">정발산</text>
      </g>
      <g onClick={this.handleClick} id="Madu" key="MaduS_tation" data="Madu">
        <text transform="translate(376.183 337.0363)" className="st0 st1">마두</text>
      </g>
      <g onClick={this.handleClick} id="Goksan" key="Goksa_nStation" data="Goksan">
        <text transform="translate(435.4496 315.0968)" className="st0 st1">곡산</text>
      </g>
      <g onClick={this.handleClick} id="Neunggok" key="Neung_gokStation" data="Neunggok">
        <text transform="translate(410.0219 377.4327)" className="st0 st1">능곡</text>
      </g>
      <g onClick={this.handleClick} id="Haengsin" key="Haeng_sinStation" data="Haengsin">
        <text transform="translate(391.9594 421.0343)" className="st0 st1">행신</text>
      </g>
      <g onClick={this.handleClick} id="Hwajeon" key="Hwaje_onStation" data="Hwajeon">
        <text transform="translate(372.6625 467.5558)" className="st0 st1">화전</text>
      </g>
      <g onClick={this.handleClick} id="Jangam" key="Janga_mStation" data="Jangam">
        <text transform="translate(901.3544 130.2345)" className="st0 st1">장암</text>
      </g>
      <g onClick={this.handleClick} id="Guri" key="GuriS_tation" data="Guri">
        <text transform="translate(1061.6542 523.5656)" className="st0 st1">구리</text>
      </g>
      <g onClick={this.handleClick} id="Donong" key="Donon_gStation" data="Donong">
        <text transform="translate(1067.6346 537.9689)" className="st0 st1">도농</text>
      </g>
      <g onClick={this.handleClick} id="Yangjeong" key="Yangj_eongStation" data="Yangjeong">
        <text transform="translate(1073.6024 552.3741)" className="st0 st1">양정</text>
      </g>
      <g onClick={this.handleClick} id="Deokso" key="Deoks_oStation" data="Deokso">
      ...
      <g onClick={this.handleClick} id="Yangwon" key="Yangw_onStation" data="Yangwon">
        <text transform="translate(1055.704 509.1593)" className="st0 st1">양원</text>
      </g>
      <g onClick={this.handleClick} id="Chuncheon" key="Chunc_heonStation" data="Chuncheon">
        <text transform="translate(992.1288 133.298)" className="st0 st1">춘천</text>
      </g>
      <g onClick={this.handleClick} id="Namchuncheon" key="Namch_uncheonStation" data="Namchuncheon">
        <text transform="translate(998.5604 148.8224)" className="st0 st1">남춘천</text>
      </g>
      <g onClick={this.handleClick} id="Gimyujeong" key="Gimyu_jeongStation" data="Gimyujeong">
        <text transform="translate(1004.994 164.3488)" className="st0 st1">김유정</text>
      </g>
      <g onClick={this.handleClick} id="Gangchon" key="Gangc_honStation" data="Gangchon">
        <text transform="translate(1011.4257 179.8741)" className="st0 st1">강촌</text>
      </g>
      <g onClick={this.handleClick} id="Baegyangri" key="Baegy_angriStation" data="Baegyangri">
        <text transform="translate(1017.8563 197.548)" className="st0 st1">백양리</text>
      </g>
      <g onClick={this.handleClick} id="Gulbongsan" key="Gulbo_ngsanStation" data="Gulbongsan">
        <text transform="translate(1024.2889 210.9259)" className="st0 st1">굴봉산</text>
      </g>
      <g onClick={this.handleClick} id="Gapyeong" key="Gapye_ongStation" data="Gapyeong">
        <text transform="translate(1030.7206 226.4523)" className="st0 st1">가평</text>
      </g>
      <g onClick={this.handleClick} id="Sangcheon" key="Sangc_heonStation" data="Sangcheon">
        <text transform="translate(1037.1532 241.9777)" className="st0 st1">상천</text>
      </g>
      <g onClick={this.handleClick} id="Cheongpyeong" key="Cheon_gpyeongStation" data="Cheongpyeong">
        <text transform="translate(1043.5848 257.4972)" className="st0 st1">청평</text>
      </g>
      <g onClick={this.handleClick} id="Daeseongri" key="Daese_ongriStation" data="Daeseongri">
        <text transform="translate(1050.0165 273.0227)" className="st0 st1">대성리</text>
      </g>
      <g onClick={this.handleClick} id="Maseok" key="Maseo_kStation" data="Maseok">
        <text transform="translate(1056.4423 288.549)" className="st0 st1">마석</text>
      </g>
      <g onClick={this.handleClick} id="Cheonmasan" key="Cheon_masanStation" data="Cheonmasan">
        <text transform="translate(1062.8759 304.0753)" className="st0 st1">천마산</text>
      </g>
      <g onClick={this.handleClick} id="PyeongnaeHopyeong" key="Pyeon_gnaeHopyeongStation" data="PyeongnaeHopyeong">
        <text transform="translate(1069.3075 319.5997)" className="st0 st1">평내호평</text>
      </g>
      <g onClick={this.handleClick} id="Geumgok" key="Geumg_okStation" data="Geumgok">
        <text transform="translate(1075.7323 335.1202)" className="st0 st1">금곡</text>
      </g>
      <g onClick={this.handleClick} id="Wolgye" key="Wolgy_eStation" data="Wolgye">
        <text transform="translate(897.5272 382.2102)" className="st0 st1">월계</text>
      </g>
      <g onClick={this.handleClick} id="Nokcheon" key="Nokch_eonStation" data="Nokcheon">
        <text transform="translate(879.3817 338.4532)" className="st0 st1">녹천</text>
      </g>
      <g onClick={this.handleClick} id="Danggogae" key="Dangg_ogaeStation" data="Danggogae">
        <text transform="translate(980.4276 238.5284)" className="st0 st1">당고개</text>
      </g>
      <g onClick={this.handleClick} id="Kkachiul" key="Kkach_iulStation" data="Kkachiul">
        <text transform="translate(205.3226 883.4913)" className="st0 st1">까치울</text>
      </g>
      <g onClick={this.handleClick} id="BucheonStadium" key="Buche_onStadiumStation" data="BucheonStadium">
        <text transform="translate(198.8842 865.8341)" className="st0 st1">부천종합운동장</text>
      </g>
      <g onClick={this.handleClick} id="Doksan" key="Doksa_nStation" data="Doksan">
        <text transform="translate(417.8304 999.2355)" className="st0 st1">독산</text>
      </g>
      <g onClick={this.handleClick} id="Incheon" key="Inche_onStation" data="Incheon">
        <text transform="translate(37.9779 782.6886)" className="st0 st1">인천</text>
      </g>
      <g onClick={this.handleClick} id="Dongincheon" key="Dongi_ncheonStation" data="Dongincheon">
      ...
      <g onClick={this.handleClick} id="Jemulpo" key="Jemul_poStation" data="Jemulpo">
      ...
      <g onClick={this.handleClick} id="Juan" key="JuanS_tation" data="Juan">
        <text transform="translate(71.0521 862.7921)" className="st0 st1">주안</text>
      </g>
      <g onClick={this.handleClick} id="Ganseok" key="Ganse_okStation" data="Ganseok">
        <text transform="translate(77.6722 878.8126)" className="st0 st1">간석</text>
      </g>
      <g onClick={this.handleClick} id="Galsan" key="Galsa_nStation" data="Galsan">
        <text transform="translate(88.7386 817.3038)" className="st0 st1">갈산</text>
      </g>
      <g onClick={this.handleClick} id="Dongsu" key="Dongs_uStation" data="Dongsu">
        <text transform="translate(132.347 923.4464)" className="st0 st1">동수</text>
      </g>
      <g onClick={this.handleClick} id="Bupyeongsamgeori" key="Bupye_ongsamgeoriStation" data="Bupyeongsamgeori">
        <text transform="translate(138.7357 938.8663)" className="st0 st1">부평삼거리</text>
      </g>
      <g onClick={this.handleClick} id="Ganseogogeori" key="Ganse_ogogeoriStation" data="Ganseogogeori">
        <text transform="translate(146.6517 957.9816)" className="st0 st1">간석오거리</text>
      </g>
      <g onClick={this.handleClick} id="IncheonCityHall" key="Inche_onCityHallStation" data="IncheonCityHall">
        <text transform="translate(154.5687 977.0958)" className="st0 st1">인천시청</text>
      </g>
      <g onClick={this.handleClick} id="ArtsCenter" key="ArtsC_enterStation" data="ArtsCenter">
        <text transform="translate(162.4847 996.2111)" className="st0 st1">예술회관</text>
      </g>
      <g onClick={this.handleClick} id="IncheonBusTerminal" key="Inche_onBusTerminalStation" data="IncheonBusTerminal">
        <text transform="translate(170.4008 1015.3243)" className="st0 st1">인천터미널</text>
      </g>
      <g onClick={this.handleClick} id="MunhakSportsComplex" key="Munha_kSportsComplexStation" data="MunhakSportsComplex">
        <text transform="translate(178.3168 1034.4386)" className="st0 st1">문학경기장</text>
      </g>
      <g onClick={this.handleClick} id="Seonhak" key="Seonh_akStation" data="Seonhak">
        <text transform="translate(186.2338 1053.5529)" className="st0 st1">선학</text>
      </g>
      <g onClick={this.handleClick} id="Sinyeonsu" key="Sinye_onsuStation" data="Sinyeonsu">
        <text transform="translate(194.1508 1072.6681)" className="st0 st1">신연수</text>
      </g>
      <g onClick={this.handleClick} id="Dongchun" key="Dongc_hunStation" data="Dongchun">
        <text transform="translate(210.057 1111.0656)" className="st0 st1">동춘</text>
      </g>
      <g onClick={this.handleClick} id="Dongmak" key="Dongm_akStation" data="Dongmak">
        <text transform="translate(218.0492 1130.3556)" className="st0 st1">동막</text>
      </g>
      <g onClick={this.handleClick} id="BupyeongMarket" key="Bupye_ongMarketStation" data="BupyeongMarket">
        <text transform="translate(112.0804 873.6632)" className="st0 st1">부평시장</text>
      </g>
      <g onClick={this.handleClick} id="Balsan" key="Balsa_nStation" data="Balsan">
        <text transform="translate(242.2865 660.9308)" className="st0 st1">발산</text>
      </g>
      <g onClick={this.handleClick} id="Ujangsan" key="Ujang_sanStation" data="Ujangsan">
        <text transform="translate(254.9261 691.4445)" className="st0 st1">우장산</text>
      </g>
      <g onClick={this.handleClick} id="Hwagok" key="Hwago_kStation" data="Hwagok">
        <text transform="translate(266.0736 718.3615)" className="st0 st1">화곡</text>
      </g>
      <g onClick={this.handleClick} id="NambuBusTerminal" key="Nambu_BusTerminalStation" data="NambuBusTerminal">
      ...
      <g onClick={this.handleClick} id="Seonjeongneung" key="Seonj_eongneungStation" data="Seonjeongneung">
        <text transform="translate(872.1932 834.8585)" className="st0 st1">선정릉</text>
      </g>
      <g onClick={this.handleClick} id="Nokbeon" key="Nokbe_onStation" data="Nokbeon">
        <text transform="translate(543.8842 500.1115)" className="st0 st1">녹번</text>
      </g>
      <g onClick={this.handleClick} id="Junghwa" key="Jungh_waStation" data="Junghwa">
        <text transform="translate(977.8798 495.0753)" className="st0 st1">중화</text>
      </g>
      <g onClick={this.handleClick} id="Meokgol" key="Meokg_olStation" data="Meokgol">
      ...
      <g onClick={this.handleClick} id="Junggye" key="Jungg_yeStation" data="Junggye">
        <text transform="translate(938.1649 333.9563)" className="st0 st1">중계</text>
      </g>
      <g onClick={this.handleClick} id="Madeul" key="Madeu_lStation" data="Madeul">
        <text transform="translate(919.9598 260.0841)" className="st0 st1">마들</text>
      </g>
      <g onClick={this.handleClick} id="Suraksan" key="Surak_sanStation" data="Suraksan">
        <text transform="translate(908.7499 214.6036)" className="st0 st1">수락산</text>
      </g>
      <g onClick={this.handleClick} id="Gongneung" key="Gongn_eungStation" data="Gongneung">
        <text transform="translate(956.6796 409.0548)" className="st0 st1">공릉</text>
      </g>
      <g onClick={this.handleClick} id="Jamsillaru" key="Jamsi_llaruStation" data="Jamsillaru">
        <text transform="translate(1036.8446 802.9484)" className="st0 st1">잠실나루</text>
      </g>
      <g onClick={this.handleClick} id="Gangbyeon" key="Gangb_yeonStation" data="Gangbyeon">
        <text transform="translate(1014.8983 749.965)" className="st0 st1">강변</text>
      </g>
      <g onClick={this.handleClick} id="Yongdap" key="Yongd_apStation" data="Yongdap">
        <text transform="translate(892.496 644.8351)" className="st0 st1">용답</text>
      </g>
      <g onClick={this.handleClick} id="Sindap" key="Sinda_pStation" data="Sindap">
        <text transform="translate(876.9335 610.0197)" className="st0 st1">신답</text>
      </g>
      <g onClick={this.handleClick} id="Sareung" key="Sareu_ngStation" data="Sareung">
        <text transform="translate(1081.9315 350.1526)" className="st0 st1">사릉</text>
      </g>
      <g onClick={this.handleClick} id="Mia" key="MiaSt_ation" data="Mia">
        <text transform="translate(822.2762 405.5099)" className="st0 st1">미아</text>
      </g>
      <g onClick={this.handleClick} id="SeokchonHansolHospital" key="Seokc_honHansolHospitalStation" data="SeokchonHansolHospital">
        <text transform="translate(1051.368 857.7804)" className="st0 st1">석촌</text>
      </g>
      <g onClick={this.handleClick} id="NationalPoliceHospital" key="Natio_nalPoliceHospitalStation" data="NationalPoliceHospital">
        <text transform="translate(1109.2186 895.3654)" className="st0 st1">경찰병원</text>
      </g>
      <g onClick={this.handleClick} id="Sinyongsan" key="Sinyo_ngsanStation" data="Sinyongsan">
        <text transform="translate(637.4086 770.2814)" className="st0 st1">신용산</text>
      </g>
      <g onClick={this.handleClick} id="YangjaeCitizensForest" key="Yangj_aeCitizensForestStation" data="YangjaeCitizensForest">
        <text transform="translate(863.3368 985.381)" className="st0 st1">양재시민의숲</text>
      </g>
      <g onClick={this.handleClick} id="Daecheong" key="Daech_eongStation" data="Daecheong">
      ...
      <g onClick={this.handleClick} id="Sinjeongnegeori" key="Sinje_ongnegeoriStation" data="Sinjeongnegeori">
        <text transform="translate(258.7894 801.7472)" className="st0 st1">신정네거리</text>
      </g>
      <g onClick={this.handleClick} id="Jakjeon" key="Jakje_onStation" data="Jakjeon">
        <text transform="translate(77.0892 789.1583)" className="st0 st1">작전</text>
      </g>
      <g onClick={this.handleClick} id="Seoulforest" key="Seoul_forestStation" data="Seoulforest">
        <text transform="translate(845.7762 715.3741)" className="st0 st1">서울숲</text>
      </g>
      <g onClick={this.handleClick} id="Gwangmyeong" key="Gwang_myeongStation" data="Gwangmyeong">
        <text transform="translate(412.7006 1069.9493)" className="st0 st1">광명</text>
      </g>
      <g onClick={this.handleClick} id="Seoksu" key="Seoks_uStation" data="Seoksu">
        <text transform="translate(458.2767 1096.8878)" className="st0 st1">석수</text>
      </g>
      <g onClick={this.handleClick} id="Apgujeongrodeo" key="Apguj_eongrodeoStation" data="Apgujeongrodeo">
        <text transform="translate(857.2919 774.5333)" className="st0 st1">압구정로데오</text>
      </g>
      <g onClick={this.handleClick} id="HongikUniv" key="Hongi_kUnivStation" data="HongikUniv">
        <text transform="translate(507.5287 671.1388)" className="st0 st1">홍대입구</text>
      </g>
      <g onClick={this.handleClick} id="Hapjeong" key="Hapje_ongStation" data="Hapjeong">
        <text transform="translate(489.9515 691.2228)" className="st0 st1">합정</text>
      </g>
      <g onClick={this.handleClick} id="Dangsan" key="Dangs_anStation" data="Dangsan">
        <text transform="translate(445.3617 735.4513)" className="st0 st1">당산</text>
      </g>
      <g onClick={this.handleClick} id="YeongdeungpoguOffice" key="Yeong_deungpoguOfficeStation" data="YeongdeungpoguOffice">
        <text transform="translate(419.7943 777.0577)" className="st0 st1">영등포구청</text>
      </g>
      <g onClick={this.handleClick} id="Daerim" key="Daeri_mStation" data="Daerim">
        <text transform="translate(422.1742 916.9064)" className="st0 st1">대림</text>
      </g>
      <g onClick={this.handleClick} id="GasanDigitalComplex" key="Gasan_DigitalComplexStation" data="GasanDigitalComplex">
      ...
      <g onClick={this.handleClick} id="GeumcheonGuOffice" key="Geumc_heonGuOfficeStation" data="GeumcheonGuOffice">
        <text transform="translate(438.0033 1045.7853)" className="st0 st1">금천구청</text>
      </g>
      <g onClick={this.handleClick} id="Guro" key="GuroS_tation" data="Guro">
        <text transform="translate(377.4447 863.4972)" className="st0 st1">구로</text>
      </g>
      <g onClick={this.handleClick} id="Kkachisan" key="Kkach_isanStation" data="Kkachisan">
        <text transform="translate(284.4828 754.3507)" className="st0 st1">까치산</text>
      </g>
      <g onClick={this.handleClick} id="GimpoIntlAirport" key="Gimpo_IntlAirportStation" data="GimpoIntlAirport">
        <text transform="translate(146.2113 650.7023)" className="st0 st1">김포공항</text>
      </g>
      <g onClick={this.handleClick} id="BupyeongguOffice" key="Bupye_ongguOfficeStation" data="BupyeongguOffice">
        <text transform="translate(90.1273 854.6261)" className="st0 st1">부평구청</text>
      </g>
      <g onClick={this.handleClick} id="Bupyeong" key="Bupye_ongStation" data="Bupyeong">
        <text transform="translate(120.389 895.672)" className="st0 st1">부평</text>
      </g>
      <g onClick={this.handleClick} id="Woninjae" key="Wonin_jaeStation" data="Woninjae">
        <text transform="translate(201.7982 1085.9435)" className="st0 st1">원인재</text>
      </g>
      <g onClick={this.handleClick} id="Gyeyang" key="Gyeya_ngStation" data="Gyeyang">
        <text transform="translate(74.4701 582.379)" className="st0 st1">계양</text>
      </g>
      <g onClick={this.handleClick} id="Sindorim" key="Sindo_rimStation" data="Sindorim">
        <text transform="translate(421.2543 842.3361)" className="st0 st1">신도림</text>
      </g>
      <g onClick={this.handleClick} id="Sadang" key="Sadan_gStation" data="Sadang">
        <text transform="translate(689.5155 959.9845)" className="st0 st1">사당</text>
      </g>
      <g onClick={this.handleClick} id="SeoulNatlUnivofEducation" key="Seoul_NatlUnivofEducationStation" data="SeoulNatlUnivofEducation">
        <text transform="translate(775.1727 904.0958)" className="st0 st1">교대</text>
      </g>
      <g onClick={this.handleClick} id="Gangnam" key="Gangn_amStation" data="Gangnam">
        <text transform="translate(821.6708 884.8361)" className="st0 st1">강남</text>
      </g>
      <g onClick={this.handleClick} id="Seolleung" key="Seoll_eungStation" data="Seolleung">
        <text transform="translate(882.4579 859.6564)" className="st0 st1">선릉</text>
      </g>
      <g onClick={this.handleClick} id="KonkukUniv" key="Konku_kUnivStation" data="KonkukUniv">
        <text transform="translate(952.8798 729.632)" className="st0 st1">건대입구</text>
      </g>
      <g onClick={this.handleClick} id="Wangsimni" key="Wangs_imniStation" data="Wangsimni">
        <text transform="translate(843.3182 640.0626)" className="st0 st1">왕십리</text>
      </g>
      <g onClick={this.handleClick} id="Jamsil" key="Jamsi_lStation" data="Jamsil">
        <text transform="translate(1042.3436 830.9122)" className="st0 st1">잠실</text>
      </g>
      <g onClick={this.handleClick} id="Euljiro3samga" key="Eulji_ro3samgaStation" data="Euljiro3samga">
        <text transform="translate(702.4716 640.0607)" className="st0 st1">을지로3가</text>
      </g>
      <g onClick={this.handleClick} id="Euljiro4saga" key="Eulji_ro4sagaStation" data="Euljiro4saga">
        <text transform="translate(723.7313 626.3898)" className="st0 st1">을지로4가</text>
      </g>
      <g onClick={this.handleClick} id="ExpressBusTerminal1" key="Expre_ssBusTerminal1Station" data="ExpressBusTerminal1">
        <text transform="translate(689.5106 939.004)" className="st0 st1">총신대입구(이수)</text>
      </g>
      <g onClick={this.handleClick} id="ExpressBusTerminal" key="Expre_ssBusTerminalStation" data="ExpressBusTerminal">
        <text transform="translate(717.3983 852.5519)" className="st0 st1">고속터미널</text>
      </g>
      <g onClick={this.handleClick} id="Dongjak" key="Dongj_akStation" data="Dongjak">
        <text transform="translate(662.7723 880.8282)" className="st0 st1">동작</text>
      </g>
      <g onClick={this.handleClick} id="Noryangjin" key="Norya_ngjinStation" data="Noryangjin">
        <text transform="translate(545.6771 835.1212)" className="st0 st1">노량진</text>
      </g>
      <g onClick={this.handleClick} id="Yeouido" key="Yeoui_doStation" data="Yeouido">
        <text transform="translate(510.4633 793.9689)" className="st0 st1">여의도</text>
      </g>
      <g onClick={this.handleClick} id="Singil" key="Singi_lStation" data="Singil">
        <text transform="translate(482.7992 818.5216)" className="st0 st1">신길</text>
      </g>
      <g onClick={this.handleClick} id="GangnamguOffice" key="Gangn_amguOfficeStation" data="GangnamguOffice">
      ...
      <g onClick={this.handleClick} id="Sangbong" key="Sangb_ongStation" data="Sangbong">
      ...
      <g onClick={this.handleClick} id="Cheongnyangni" key="Cheon_gnyangniStation" data="Cheongnyangni">
        <text transform="translate(869.4061 580.4113)" className="st0 st1">청량리</text>
      </g>
      <g onClick={this.handleClick} id="Sinseoldong" key="Sinse_oldongStation" data="Sinseoldong">
        <text transform="translate(803.6678 592.8263)" className="st0 st1">신설동</text>
      </g>
      <g onClick={this.handleClick} id="Dongdaemun" key="Dongd_aemunStation" data="Dongdaemun">
        <text transform="translate(758.2802 605.4318)" className="st0 st1">동대문</text>
      </g>
      <g onClick={this.handleClick} id="Changdong" key="Chang_dongStation" data="Changdong">
        <text transform="translate(885.8397 308.1046)" className="st0 st1">창동</text>
      </g>
      <g onClick={this.handleClick} id="Taereung" key="Taere_ungStation" data="Taereung">
        <text transform="translate(966.203 449.9728)" className="st0 st1">태릉입구</text>
      </g>
      <g onClick={this.handleClick} id="Seokgye" key="Seokg_yeStation" data="Seokgye">
        <text transform="translate(921.9012 452.5704)" className="st0 st1">석계</text>
      </g>
      <g onClick={this.handleClick} id="KwangwoonUniv" key="Kwang_woonUnivStation" data="KwangwoonUniv">
        <text transform="translate(908.5262 423.3868)" className="st0 st1">광운대</text>
      </g>
      <g onClick={this.handleClick} id="Dongmyo" key="Dongm_yoStation" data="Dongmyo">
        <text transform="translate(784.3339 605.4318)" className="st0 st1">동묘앞</text>
      </g>
      <g onClick={this.handleClick} id="Sindang" key="Sinda_ngStation" data="Sindang">
        <text transform="translate(784.3339 625.9747)" className="st0 st1">신당</text>
      </g>
      <g onClick={this.handleClick} id="Cheonggu" key="Cheon_gguStation" data="Cheonggu">
      ...
      <g onClick={this.handleClick} id="Oksu" key="OksuS_tation" data="Oksu">
        <text transform="translate(795.6766 726.4679)" className="st0 st1">옥수</text>
      </g>
      <g onClick={this.handleClick} id="Yangjae" key="Yangj_aeStation" data="Yangjae">
      ...
      <g onClick={this.handleClick} id="Bokjeong" key="Bokje_ongStation" data="Bokjeong">
      ...
      <g onClick={this.handleClick} id="Jeongja" key="Jeong_jaStation" data="Jeongja">
        <text transform="translate(1044.1063 1129.1329)" className="st0 st1">정자</text>
      </g>
      <g onClick={this.handleClick} id="Seongsu" key="Seong_suStation" data="Seongsu">
        <text transform="translate(897.8934 706.3527)" className="st0 st1">성수</text>
      </g>
      <g onClick={this.handleClick} id="GarakMarket" key="Garak_MarketStation" data="GarakMarket">
        <text transform="translate(1093.3593 911.4073)" className="st0 st1">가락시장</text>
      </g>
      <g onClick={this.handleClick} id="Cheonho" key="Cheon_hoStation" data="Cheonho">
        <text transform="translate(1107.8856 729.3146)" className="st0 st1">천호</text>
      </g>
      <g onClick={this.handleClick} id="Gangdong" key="Gangd_ongStation" data="Gangdong">
        <text transform="translate(1133.2821 739.298)" className="st0 st1">강동</text>
      </g>
      <g onClick={this.handleClick} id="Gongdeok" key="Gongd_eokStation" data="Gongdeok">
        <text transform="translate(595.9095 708.6525)" className="st0 st1">공덕</text>
      </g>
      <g onClick={this.handleClick} id="DigitalMediaCity" key="Digit_alMediaCityStation" data="DigitalMediaCity">
        <text transform="translate(457.4496 593.5626)" className="st0 st1">디지털미디어시티</text>
      </g>
      <g onClick={this.handleClick} id="Yeonsinnae" key="Yeons_innaeStation" data="Yeonsinnae">
        <text transform="translate(514.2377 428.9103)" className="st0 st1">연신내</text>
      </g>
      <g onClick={this.handleClick} id="Daegok" key="Daego_kStation" data="Daegok">
        <text transform="translate(408.7748 323.2697)" className="st0 st1">대곡</text>
      </g>
      <g onClick={this.handleClick} id="Jongno3samga" key="Jongn_o3samgaStation" data="Jongno3samga">
        <text transform="translate(691.2723 601.7755)" className="st0 st1">종로3가</text>
      </g>
      <g onClick={this.handleClick} id="Chungmuro" key="Chung_muroStation" data="Chungmuro">
        <text transform="translate(708.0341 655.9484)" className="st0 st1">충무로</text>
      </g>
      <g onClick={this.handleClick} id="SeoulStation" key="Seoul_StationStation" data="SeoulStation">
        <text transform="translate(664.4169 674.1368)" className="st0 st1">서울역</text>
      </g>
      <g onClick={this.handleClick} id="CityHall" key="CityH_allStation" data="CityHall">
        <text transform="translate(648.0682 647.9054)" className="st0 st1">시청</text>
      </g>
      <g onClick={this.handleClick} id="Chungjeongno" key="Chung_jeongnoStation" data="Chungjeongno">
      ...
      <g onClick={this.handleClick} id="Yongsan" key="Yongs_anStation" data="Yongsan">
        <text transform="translate(612.0531 756.0587)" className="st0 st1">용산</text>
      </g>
      <g onClick={this.handleClick} id="Samgakji" key="Samga_kjiStation" data="Samgakji">
        <text transform="translate(656.2616 752.6447)" className="st0 st1">삼각지</text>
      </g>
      <g onClick={this.handleClick} id="Bulgwang" key="Bulgw_angStation" data="Bulgwang">
      ...
      <g onClick={this.handleClick} id="Dobongsan" key="Dobon_gsanStation" data="Dobongsan">
        <text transform="translate(854.8466 176.0548)" className="st0 st1">도봉산</text>
      </g>
      <g onClick={this.handleClick} id="Hoeryong" key="Hoery_ongStation" data="Hoeryong">
      ...
      <g onClick={this.handleClick} id="Onsu" key="OnsuS_tation" data="Onsu">
        <text transform="translate(212.3871 907.1788)" className="st0 st1">온수</text>
      </g>
      <g onClick={this.handleClick} id="Oido" key="OidoS_tation" data="Oido">
      ...
      <g onClick={this.handleClick} id="Geumjeong" key="Geumj_eongStation" data="Geumjeong">
      ...
      <g onClick={this.handleClick} id="Byeongjeom" key="Byeon_gjeomStation" data="Byeongjeom">
        <text transform="translate(789.9432 1170.1271)" className="st0 st1">병점</text>
      </g>
      <g onClick={this.handleClick} id="Giheung" key="Giheu_ngStation" data="Giheung">
      ...
      <g onClick={this.handleClick} id="DongdaemunHistoryCulturePark" key="Dongd_aemunHistoryCultureParkStation" data="DongdaemunHistoryCulturePark">
      ...
      <g onClick={this.handleClick} id="GuroDigitalComplex" key="GuroD_igitalComplexStation" data="GuroDigitalComplex">
    ...
    <g onClick={this.handleClick} id="broad" key="broad_Station" data="broad">
      <g onClick={this.handleClick} id="GangnamGu" key="Gangn_amGuStation" data="GangnamGu">
        <text transform="translate(946.6327 985.6007)" className="st3 st0 st4">강남구</text>
      </g>
      <g onClick={this.handleClick} id="SeochoGu" key="Seoch_oGuStation" data="SeochoGu">
        <text transform="translate(758.9042 981.338)" className="st3 st0 st4">서초구</text>
      </g>
      <g onClick={this.handleClick} id="SongpaGu" key="Songp_aGuStation" data="SongpaGu">
        <text transform="translate(1066.1063 844.8058)" className="st3 st0 st4">송파구</text>
      </g>
      <g onClick={this.handleClick} id="GangdongGu" key="Gangd_ongGuStation" data="GangdongGu">
        <text transform="translate(1181.3065 746.673)" className="st3 st0 st4">강동구</text>
      </g>
      <g onClick={this.handleClick} id="GwanakGu" key="Gwana_kGuStation" data="GwanakGu">
        <text transform="translate(562.64 994.1437)" className="st3 st0 st4">관악구</text>
      </g>
      <g onClick={this.handleClick} id="DongjakGu" key="Dongj_akGuStation" data="DongjakGu">
        <text transform="translate(558.3783 900.2755)" className="st3 st0 st4">동작구</text>
      </g>
      <g onClick={this.handleClick} id="GeumcheonGu" key="Geumc_heonGuStation" data="GeumcheonGu">
        <text transform="translate(447.4486 985.6095)" className="st3 st0 st4">금천구</text>
      </g>
      <g onClick={this.handleClick} id="GuroGu" key="GuroG_uStation" data="GuroGu">
        <text transform="translate(323.7133 913.0812)" className="st3 st0 st4">구로구</text>
      </g>
      <g onClick={this.handleClick} id="YangcheonGu" key="Yangc_heonGuStation" data="YangcheonGu">
        <text transform="translate(310.9154 806.4152)" className="st3 st0 st4">양천구</text>
      </g>
      <g onClick={this.handleClick} id="GangseoGu" key="Gangs_eoGuStation" data="GangseoGu">
        <text transform="translate(306.6537 712.545)" className="st3 st0 st4">강서구</text>
      </g>
      <g onClick={this.handleClick} id="MapoGu" key="MapoG_uStation" data="MapoGu">
        <text transform="translate(571.184 682.6798)" className="st3 st0 st4">마포구</text>
      </g>
      <g onClick={this.handleClick} id="EunpyeongGu" key="Eunpy_eongGuStation" data="EunpyeongGu">
        <text transform="translate(502.9174 554.6818)" className="st3 st0 st4">은평구</text>
      </g>
      <g onClick={this.handleClick} id="SeodaemunGu" key="Seoda_emunGuStation" data="SeodaemunGu">
        <text transform="translate(536.7123 610.1505)" className="st3 st0 st4">서대문구</text>
      </g>
      <g onClick={this.handleClick} id="JongnoGu" key="Jongn_oGuStation" data="JongnoGu">
        <text transform="translate(665.0526 529.087)" className="st3 st0 st4">종로구</text>
      </g>
      <g onClick={this.handleClick} id="JungGu" key="JungG_uStation" data="JungGu">
        <text transform="translate(708.0585 674.1534)" className="st3 st0 st4">중구</text>
      </g>
      <g onClick={this.handleClick} id="SeongdongGu" key="Seong_dongGuStation" data="SeongdongGu">
        <text transform="translate(822.9159 704.0197)" className="st3 st0 st4">성동구</text>
      </g>
      <g onClick={this.handleClick} id="DongdaemunGu" key="Dongd_aemunGuStation" data="DongdaemunGu">
        <text transform="translate(907.9091 588.8195)" className="st3 st0 st4">동대문구</text>
      </g>
      <g onClick={this.handleClick} id="JungnangGu" key="Jungn_angGuStation" data="JungnangGu">
        <text transform="translate(993.578 477.8888)" className="st3 st0 st4">중랑구</text>
      </g>
      <g onClick={this.handleClick} id="DobongGu" key="Dobon_gGuStation" data="DobongGu">
        <text transform="translate(818.6444 247.4884)" className="st3 st0 st4">도봉구</text>
      </g>
      <g onClick={this.handleClick} id="GangbukGu" key="Gangb_ukGuStation" data="GangbukGu">
        <text transform="translate(763.1757 422.42)" className="st3 st0 st4">강북구</text>
      </g>
      <g onClick={this.handleClick} id="SeongbukGu" key="Seong_bukGuStation" data="SeongbukGu">
        <text transform="translate(784.5077 533.3497)" className="st3 st0 st4">성북구</text>
      </g>
      <g onClick={this.handleClick} id="GwangjinGu" key="Gwang_jinGuStation" data="GwangjinGu">
        <text transform="translate(1014.9091 652.8136)" className="st3 st0 st4">광진구</text>
      </g>
      <g onClick={this.handleClick} id="YongsanGu" key="Yongs_anGuStation" data="YongsanGu">
        <text transform="translate(686.3749 772.2775)" className="st3 st0 st4">용산구</text>
      </g>
      <g onClick={this.handleClick} id="YeongdeungpoGu" key="Yeong_deungpoGuStation" data="YeongdeungpoGu">
        <text transform="translate(464.1742 853.34)" className="st3 st0 st4">영등포구</text>
      </g>
      <g onClick={this.handleClick} id="NowonGu" key="Nowon_GuStation" data="NowonGu">
