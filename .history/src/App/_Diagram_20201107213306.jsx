            ...
            if(shape === 'horizon'){
                ...
                for(let i = 0; i < length; i++){
                    if(lengthHalf < 8){
                        ...
                        else if(i >= lengthHalf && i < lengthHalf + lengthHalf/2)corList.push([(i-lengthHalf)*numToMultiply ,40])
                        else if(i >= lengthHalf + lengthHalf/2)corList.push([(i-length)*numToMultiply , 40])
                    }
                }
            }
