...
class Poster extends PureComponent {
    ...
    changeOn(diceOn){
        this.setState({posterOn : diceOn})
    }


    render(){
        const posterOn = this.state.posterOn
            ...
            <>
                ...
                <MapExplainWrapperDiv>
                    <MapExplainDiv>
                        ...
                        />
                        <MapShowText>
                            <Rhombus on={true} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#7B2E8E'}}>박물관 갤러리</div>
                            <Rectangular on={true} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#006CC4'}}>쇼핑 마켓</div>
                            <Circle on={true} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#E20000'}}>랜드마크</div>
                            <Triangle on={true} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#087A0D'}}>자연 휴양지</div>
                            <Ellipse on={true} left={'3px'} right={'0px'} size={'17px'} top={'-4px'}/>
                                <div style={{color:'#EFC820'}}>음식점</div>
                        </MapShowText>
                        <ExplainTitle>
                            기획의도
                        </ExplainTitle>
