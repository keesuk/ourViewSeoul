...
class Window extends Component {
    ...
    handleScroll(event) {
        ...
        if(scrollBottom === windowBottom && windowUp === false){
            this.fetchMoreData(element, windowBottom)
    ...
    fetchMoreData(element, windowBottom) {
        const { stationDatas, arrNum, memoArr } = this.state
        ...
        if(arrNum < 20){
            setTimeout(() => {
                ...
                // element.scrollTo(0, memoArr[arrNum]-40)
                console.log(memoArr)
                console.log(arrNum)
