            ...
            >
                ...
                {pinData.map((pin, i) =>
                    <g transform={`translate(0,${-i*40})`} key={pin && pin.locationName}>
                        ...
                        : (pin && pin.locationTagID === 1 ? rectPin(pin && pin.locationName)
                        : (pin && pin.locationTagID === 2 ? trianglePin(pin && pin.locationName)
                        : (pin && pin.locationTagID === 3 ? rhombusPin(pin && pin.locationName)
