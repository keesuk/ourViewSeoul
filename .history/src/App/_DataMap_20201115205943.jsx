...
const StyledG = styled.g`
    ...
    .hover3 {display: none;}
    .hover4 {display: none;}
    .0:hover .hover0 {display: block;}
    .1:hover .hover1 {display: block;}
    .2:hover .hover2 {display: block;}
    .3:hover .hover3 {display: block;}
    .4:hover .hover4 {display: block;}
                        ...
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                {posterOn 
                                    ? this.state.do
                                        ? <StyledG>
                                            {this.state.locationed.map((one, i) => { return(
                                                <g className={i}>
