                    ...
                    <TransformComponent>
                        <SvgContainer> 
                            ...
                            <g>
                                ...
                                <text transform="translate(40 20)" className="purple">쇼핑 마켓</text>
                                <text transform="translate(40 20)" className="purple">랜드마크</text>
                                <text transform="translate(40 20)" className="purple">자연 휴양지</text>
                                <text transform="translate(40 20)" className="purple">음식점</text>
                            </g>
                            <g id="Ilsan" >
