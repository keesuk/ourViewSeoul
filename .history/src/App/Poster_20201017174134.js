                ...
                <PosterContentDiv>
                    ...
                    <MapExplainWrapperDiv>
                        <MapExplainDiv>
                            ...
                            <MapShowText>
                                <Ellipse on={true} right={'0px'} left={'3px'} width={'18px'} height={'18px'}/>
                                    <text style={{color:'#EFC820'}}></text>
                                <Rhombus on={true} right={'0px'} left={'5px'} size={'24px'}/>
                                    <text style={{color:'#7B2E8E'}}></text>
                                <Rectangular on={true} right={'0px'} left={'5px'} size={'12px'}/>
                                    <text style={{color:'#006CC4'}}></text>
                                <Circle on={true} right={'0px'} left={'5px'} size={'12.7px'}/>
                                    <text style={{color:'#E20000'}}></text>
                                <Triangle on={true} right={'0px'} left={'0px'} size={'18px'}/>
