...
const colorListTag  = ['#E20000','#006CC4','#087A0D','#7B2E8E','#EFC820']
const shapeItems    = ['●','■','▲','◆','⬬']
...
const DiceDiv = styled.div`
    ...
    animation-name: ${props => props.diceOn ? setTimeout( () => { return rotate },3000) : ''};
    animation-iteration-count: infinite;
    ...
    .front { 
        transform: rotateY(0deg) translateZ(5.7vw);
    ...
    .back { 
        transform: rotateX(180deg) translateZ(5.7vw);
    ...
    .right { 
        transform: rotateY(90deg) translateZ(5.7vw); 
...
export class Dice extends React.PureComponent {
    render(){
        console.log(this.props.diceOn)
        return(
            <DiceWrapperDiv>
            <DiceDiv
                diceOn={this.props.diceOn ? 1:0}
            >
                <div className="front">
                    <span></span>
                    <span></span>
