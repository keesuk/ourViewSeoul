            ...
            <>
                ...
                <MapExplainWrapperDiv>
                    <MapExplainDiv>
                        ...
                        />
                        <MapShowText>
                            <Rhombus on={1} on={1} getDown={1} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#e90087'}}>박물관 갤러리</div>
                            <Rectangular on={1} getDown={1} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#006CC4'}}>쇼핑 마켓</div>
                            <Circle on={1} getDown={1} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#E20000'}}>랜드마크</div>
                            <Triangle on={1} getDown={1} left={'3px'} right={'0px'} size={'15px'}/>
                                <div style={{color:'#087A0D'}}>자연 휴양지</div>
                            <Ellipse on={1} getDown={1} left={'3px'} right={'0px'} size={'17px'} top={'-4px'}/>
