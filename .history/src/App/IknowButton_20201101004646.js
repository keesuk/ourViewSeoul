...
import { PinUp, AskMarker, randomize } from './_Diagram.jsx';
            ...
            <IknowWrapDiv>
                {this.state.buttonOn 
                    ? <IknowBtn
                        ...
                        <div>혹시 여기 알아요?
                            <PinUp choose={this.state.choose} width={32} height={39}/>
                        </div>
                    </IknowBtn>
                    : <IknowBtn 
                        onClick={this.intro}>
                        <div>혹시 여기 알아요?
                            <PinUp choose={colorList[0]} width={32} height={39}/>
                        </div>
                    </IknowBtn>
                    }
                {this.state.buttonOn 
                    ? <>
                        <IknowExplainDiv>잘 아는 지역이 있나요? 그 곳을 <br/>클릭하면 다음단계로 이동합니다</IknowExplainDiv>
