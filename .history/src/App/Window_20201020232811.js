                    ...
                    <div className="header-content">
                        ...
                        <div className="tag-wrapper">
                            {stationDatas.map((stationData, i) =>
                                ...
                                ? <Ellipse left={'3px'} right={'3px'} size={'18px'} key={i} on={okArray.filter(value => value === i)}/> 
                                : <Triangle left={'3px'} right={'3px'} size={'16px'} top={'5px'}key={i} on={okArray.filter(value => value === i)}/>
                            ))))}
                        </div>
                    </div>
                </header>
