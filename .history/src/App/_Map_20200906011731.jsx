...
class Map extends PureComponent {
  ...
  render() {
    ...
    <Svg
      ...
      xmlSpace="preserve"
    >
    <g onclick={}id="map" key="mapStation" data="map">
      <g onclick={}id="Ilsan" key="IlsanStation" data="Ilsan">
      ...
      <g onclick={}id="Pungsan" key="PungsanStation" data="Pungsan">
      ...
      <g onclick={}id="Baengma" key="BaengmaStation" data="Baengma">
      ...
      <g onclick={}id="Wondang" key="WondangStation" data="Wondang">
      ...
      <g onclick={}id="Wonheung" key="WonheungStation" data="Wonheung">
      ...
      <g onclick={}id="Samsong" key="SamsongStation" data="Samsong">
      ...
      <g onclick={}id="Tanhyeon" key="TanhyeonStation" data="Tanhyeon">
      ...
      <g onclick={}id="Unjeong" key="UnjeongStation" data="Unjeong">
      ...
      <g onclick={}id="Geumneung" key="GeumneungStation" data="Geumneung">
      ...
      <g onclick={}id="Geumchon" key="GeumchonStation" data="Geumchon">
      ...
      <g onclick={}id="Wollong" key="WollongStation" data="Wollong">
      ...
      <g onclick={}id="Paju" key="PajuStation" data="Paju">
      ...
      <g onclick={}id="Munsan" key="MunsanStation" data="Munsan">
      ...
      <g onclick={}id="Bugae" key="BugaeStation" data="Bugae">
      ...
      <g onclick={}id="Songnae" key="SongnaeStation" data="Songnae">
      ...
      <g onclick={}id="Jungdong" key="JungdongStation" data="Jungdong">
      ...
      <g onclick={}id="Bucheon" key="BucheonStation" data="Bucheon">
      ...
      <g onclick={}id="Sosa" key="SosaStation" data="Sosa">
      ...
      <g onclick={}id="Yeokgok" key="YeokgokStation" data="Yeokgok">
      ...
      <g onclick={}id="Technopark" key="TechnoparkStation" data="Technopark">
      ...
      <g onclick={}id="BITZone" key="BITZoneStation" data="BITZone">
      ...
      <g onclick={}id="IncheonNatlUniv" key="IncheonNatlUnivStation" data="IncheonNatlUniv">
      ...
      <g onclick={}id="CentralPark" key="CentralParkStation" data="CentralPark">
      ...
      <g onclick={}id="IntlBusinessDistrict" key="IntlBusinessDistrictStation" data="IntlBusinessDistrict">
      ...
      <g onclick={}id="Singiloncheon" key="SingiloncheonStation" data="Singiloncheon">
      ...
      <g onclick={}id="Sinchang" key="SinchangStation" data="Sinchang">
      ...
      <g onclick={}id="Onyangoncheon" key="OnyangoncheonStation" data="Onyangoncheon">
      ...
      <g onclick={}id="Baebang" key="BaebangStation" data="Baebang">
      ...
      <g onclick={}id="Asan" key="AsanStation" data="Asan">
      ...
      <g onclick={}id="Ssangyong" key="SsangyongStation" data="Ssangyong">
      ...
      <g onclick={}id="Bongmyeong" key="BongmyeongStation" data="Bongmyeong">
      ...
      <g onclick={}id="Cheonan" key="CheonanStation" data="Cheonan">
      ...
      <g onclick={}id="Dujeong" key="DujeongStation" data="Dujeong">
      ...
      <g onclick={}id="Jiksan" key="JiksanStation" data="Jiksan">
      ...
      <g onclick={}id="Seonghwan" key="SeonghwanStation" data="Seonghwan">
      ...
      <g onclick={}id="Pyeongtaek" key="PyeongtaekStation" data="Pyeongtaek">
      ...
      <g onclick={}id="Jije" key="JijeStation" data="Jije">
      ...
      <g onclick={}id="Seojeongri" key="SeojeongriStation" data="Seojeongri">
      ...
      <g onclick={}id="Songtan" key="SongtanStation" data="Songtan">
      ...
      <g onclick={}id="Osan" key="OsanStation" data="Osan">
      ...
      <g onclick={}id="OsanCollege" key="OsanCollegeStation" data="OsanCollege">
      ...
      <g onclick={}id="Sema" key="SemaStation" data="Sema">
      ...
      <g onclick={}id="Seodongtan" key="SeodongtanStation" data="Seodongtan">
      ...
      <g onclick={}id="Jinwi" key="JinwiStation" data="Jinwi">
      ...
      <g onclick={}id="Ansan" key="AnsanStation" data="Ansan">
      ...
      <g onclick={}id="Choji" key="ChojiStation" data="Choji">
      ...
      <g onclick={}id="Gojan" key="GojanStation" data="Gojan">
      ...
      <g onclick={}id="Jungang" key="JungangStation" data="Jungang">
      ...
      <g onclick={}id="HanyangUnivatAnsan" key="HanyangUnivatAnsanStation" data="HanyangUnivatAnsan">
      ...
      <g onclick={}id="Sangnoksu" key="SangnoksuStation" data="Sangnoksu">
      ...
      <g onclick={}id="Banwol" key="BanwolStation" data="Banwol">
      ...
      <g onclick={}id="Daeyami" key="DaeyamiStation" data="Daeyami">
      ...
      <g onclick={}id="Surisan" key="SurisanStation" data="Surisan">
      ...
      <g onclick={}id="SuwonCityHall1" key="SuwonCityHall1Station" data="SuwonCityHall1">
      ...
      <g onclick={}id="SuwonCityHall" key="SuwonCityHallStation" data="SuwonCityHall">
      ...
      <g onclick={}id="MaetanGwonseon" key="MaetanGwonseonStation" data="MaetanGwonseon">
      ...
      <g onclick={}id="Mangpo" key="MangpoStation" data="Mangpo">
      ...
      <g onclick={}id="Yeongtong" key="YeongtongStation" data="Yeongtong">
      ...
      <g onclick={}id="Cheongmyeong" key="CheongmyeongStation" data="Cheongmyeong">
      ...
      <g onclick={}id="Sanggal" key="SanggalStation" data="Sanggal">
      ...
      <g onclick={}id="Singal" key="SingalStation" data="Singal">
      ...
      <g onclick={}id="Guseong" key="GuseongStation" data="Guseong">
      ...
      <g onclick={}id="Bojeong" key="BojeongStation" data="Bojeong">
      ...
      <g onclick={}id="Jukjeon" key="JukjeonStation" data="Jukjeon">
      ...
      <g onclick={}id="Ori" key="OriStation" data="Ori">
      ...
      <g onclick={}id="MyongjiUniv" key="MyongjiUnivStation" data="MyongjiUniv">
      ...
      <g onclick={}id="Samga1" key="Samga1Station" data="Samga1">
      ...
      <g onclick={}id="Samga" key="SamgaStation" data="Samga">
      ...
      <g onclick={}id="Chodang" key="ChodangStation" data="Chodang">
      ...
      <g onclick={}id="Dongbaek" key="DongbaekStation" data="Dongbaek">
      ...
      <g onclick={}id="Eojeong" key="EojeongStation" data="Eojeong">
      ...
      <g onclick={}id="Jiseok" key="JiseokStation" data="Jiseok">
      ...
      <g onclick={}id="Gulpocheon" key="GulpocheonStation" data="Gulpocheon">
      ...
      <g onclick={}id="SamsanGymnasium" key="SamsanGymnasiumStation" data="SamsanGymnasium">
      ...
      <g onclick={}id="BucheonCityHall" key="BucheonCityHallStation" data="BucheonCityHall">
      ...
      <g onclick={}id="Sinjungdong" key="SinjungdongStation" data="Sinjungdong">
      ...
      <g onclick={}id="Sangdong" key="SangdongStation" data="Sangdong">
      ...
      <g onclick={}id="Jeongwang" key="JeongwangStation" data="Jeongwang">
      ...
      <g onclick={}id="Ungilsan1" key="Ungilsan1Station" data="Ungilsan1">
      ...
      <g onclick={}id="Ungilsan" key="UngilsanStation" data="Ungilsan">
      ...
      <g onclick={}id="Yangsu" key="YangsuStation" data="Yangsu">
      ...
      <g onclick={}id="Sinwon" key="SinwonStation" data="Sinwon">
      ...
      <g onclick={}id="Guksu" key="GuksuStation" data="Guksu">
      ...
      <g onclick={}id="Asin" key="AsinStation" data="Asin">
      ...
      <g onclick={}id="Obin" key="ObinStation" data="Obin">
      ...
      <g onclick={}id="Yangpyeong1" key="Yangpyeong1Station" data="Yangpyeong1">
      ...
      <g onclick={}id="Wondeok" key="WondeokStation" data="Wondeok">
      ...
      <g onclick={}id="Yongmun" key="YongmunStation" data="Yongmun">
      ...
      <g onclick={}id="Paldang" key="PaldangStation" data="Paldang">
      ...
      <g onclick={}id="CampusTown" key="CampusTownStation" data="CampusTown">
      ...
      <g onclick={}id="KangnamUniv" key="KangnamUnivStation" data="KangnamUniv">
      ...
      <g onclick={}id="Sanbon" key="SanbonStation" data="Sanbon">
      ...
      <g onclick={}id="Daebang" key="DaebangStation" data="Daebang">
        <text transform="translate(512.4271 830.09)" className="st0 st1">대방</text>
      </g>
      <g onclick={}id="Sinpung" key="SinpungStation" data="Sinpung">
        <text transform="translate(459.8558 883.8019)" className="st0 st1">신풍</text>
      </g>
      <g onclick={}id="Namguro" key="NamguroStation" data="Namguro">
        <text transform="translate(384.9515 922.6007)" className="st0 st1">남구로</text>
      </g>
      <g onclick={}id="Boramae" key="BoramaeStation" data="Boramae">
        <text transform="translate(490.9633 883.6583)" className="st0 st1">보라매</text>
      </g>
      <g onclick={}id="YangcheonHyanggyo" key="YangcheonHyanggyoStation" data="YangcheonHyanggyo">
        <text transform="translate(258.7406 614.8595)" className="st0 st1">양천향교</text>
      </g>
      <g onclick={}id="Magongnaru" key="MagongnaruStation" data="Magongnaru">
        <text transform="translate(214.4369 614.8595)" className="st0 st1">마곡나루</text>
      </g>
      <g onclick={}id="Sinbanghwa" key="SinbanghwaStation" data="Sinbanghwa">
        <text transform="translate(187.6635 614.8654)" className="st0 st1">신방화</text>
      </g>
      <g onclick={}id="IncheonIntlAirportCargoTerminal1" key="IncheonIntlAirportCargoTerminal1Station" data="IncheonIntlAirportCargoTerminal1">
        <text transform="translate(138.6185 523.8781)" className="st0 st1">인천국제공항</text>
      </g>
      <g onclick={}id="IncheonIntlAirportCargoTerminal" key="IncheonIntlAirportCargoTerminalStation" data="IncheonIntlAirportCargoTerminal">
      ...
      <g onclick={}id="Migeum" key="MigeumStation" data="Migeum">
        <text transform="translate(1033.5135 1137.5939)" className="st0 st1">미금</text>
      </g>
      <g onclick={}id="Yeouinaru" key="YeouinaruStation" data="Yeouinaru">
      ...
      <g onclick={}id="Geumjeong" key="GeumjeongStation" data="Geumjeong">
        <text transform="translate(669.5272 1113.2062)" className="st0 st1">금정</text>
      </g>
      <g onclick={}id="Suwon" key="SuwonStation" data="Suwon">
        <text transform="translate(769.3934 1141.7072)" className="st0 st1">수원</text>
      </g>
      <g onclick={}id="Byeongjeom" key="ByeongjeomStation" data="Byeongjeom">
        <text transform="translate(789.9432 1170.1271)" className="st0 st1">병점</text>
      </g>
      <g onclick={}id="Giheung" key="GiheungStation" data="Giheung">
      ...
      <g onclick={}id="DongdaemunHistoryCulturePark" key="DongdaemunHistoryCultureParkStation" data="DongdaemunHistoryCulturePark">
      ...
      <g onclick={}id="GuroDigitalComplex" key="GuroDigitalComplexStation" data="GuroDigitalComplex">
