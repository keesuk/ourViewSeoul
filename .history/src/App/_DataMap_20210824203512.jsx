                        ...
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                ? <g transform={'translate(10, 30) scale(.7)'}>
                                    ...
                                    <text transform="translate(180 30)" className="green">▲ 자연 휴양지</text>
                                    <text transform="translate(280 30)" className="blue">■ 쇼핑 마켓</text>
                                    <text transform="translate(380 30)" className="red">● 랜드마크</text>
                                    <text transform="translate(480 30)" className="mint">⬮  음식점</text>
                                </g>
                                : null}
