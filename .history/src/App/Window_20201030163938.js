...
class Window extends PureComponent {
    ...
    handleScroll(event) {
        ...
        const array = [...this.state.downArr]
    ...
    render(){
        const { show, okArray, inputOn, sendTextOn, windowUp, value, textOn, nonPass, ButtonOn, arr, downArr } = this.state;
                ...
                <div className="window-content">
                    ...
                    <div className="content-computer-sec">알면 계속 내려주세요</div>
                        <div className="img-content">
                            {arr.map((oneArr,i) =>  
                                <Img 
                                    key={oneArr && oneArr.locationName + i} 
