        ...
        return(
            <TriangleText
                style ={{ color : on.length !== 0
                    ? '#e5e5e5'
                    : (getDown.length !== null ? 'black':'#087A0D'),
                    marginRight: right,
                    marginLeft: left,
                    fontSize: size,
                    marginTop: top
    ...
    render() {
        ...
        return(
            <div
                style ={{ color: on.length !== 0
                    ? '#e5e5e5'
                    : (getDown.length !== null ? 'black':'#E20000' ),
                    marginRight: right,
                    marginLeft: left,
                    fontSize: size,
                }}
    ...
    render() {
        ...
        return(
            <div style ={{ color : on.length !== 0
                ? '#e5e5e5'
                : (getDown.length !== null ? 'black':'#e90087'),
                marginRight: right,
                marginLeft: left,
                fontSize: size,
            }}>
    ...
    render() {
        ...
        return(
            <div
                style ={{ color: on.length !== 0
                    ? '#e5e5e5'
                    : (getDown.length !== null ? 'black':'#006CC4'),
                    marginRight: right,
                    marginLeft: left,
                    fontSize: size,
                }}
    ...
    render() {
        ...
        return(
            <div
                style ={{ color: on.length !== 0
                    ? '#e5e5e5'
                    : (getDown.length !== null ? 'black':'#00bfb3'),
                    marginRight: right,
                    marginLeft: left,
                    fontSize: size,
                    marginTop: top,
