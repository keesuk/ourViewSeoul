...
export class PinBottom extends React.PureComponent {
    ...
    render() {
        ...
        return (
            <>
                <g onClick={this.aboutData} transform={this.props.size < 2 ? "translate(547.1039 352.4816)":"translate(547.1039 402.4816)"}>
                    ...
                    {this.props.size < 2 ?
                        ...
                        <path
                            opacity={0.3}
                            d="M22.839 24.596H.994l-.96 1.094h22.805v-1.094z"
                            fill="url(#prefix__paint0_linear)"
                        />
                        <path
                            d="M8.85 12.398l1.16.861-8.286 11.403L0 25.789.53 23.8l8.32-11.402z"
                            fill="url(#prefix__paint1_linear)"
                        />
                        <path
                            d="M13.06 15.712A7.856 7.856 0 1013.06 0a7.856 7.856 0 000 15.712z"
                            fill="#E20000"
                        />
                        </>
                        }
                ...
                :
                <g onClick={this.aboutData} transform="translate(547.1039 402.4816)">
                <path
                    opacity={0.3}
                    d="M22.839 24.596H.994l-.96 1.094h22.805v-1.094z"
                    fill="url(#prefix__paint0_linear)"
