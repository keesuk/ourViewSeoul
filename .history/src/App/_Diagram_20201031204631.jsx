...
export class Pin extends React.PureComponent {
    ...
    render() {
        ...
        const { pinData, pinCor } = this.props
        ...
        return (
            ...
            {this.state.locationTag ? 
                    <g transform={ this.props.size === pinFirst
                                ? `translate(${pinCor[0]+ 60}, ${pinCor[1]- 200}) scale(0.8)`
                                : ( this.props.size > pinMiddle && this.props.size !== pinFirst 
                                ? `translate(${pinCor[0]+ 30}, ${pinCor[1]- 120}) scale(0.3)`
                                : ( this.props.size < pinMiddle
                                ? `translate(${pinCor[0]+ 30}, ${pinCor[1]- 120}) scale(0.3)`
                                : null
                        ))}
                    >
                        ...
                        <rect 
                            ...
                            x={'0px'}
                            y={'0px'}
                            style={ this.props.size === pinFirst
                                ? { fill:'white', strokeWidth:'8px', stroke:'rgb(0,0,0)'}
                                : ( this.props.size > pinMiddle && this.props.size !== pinFirst 
                                ? { fill:'white', strokeWidth:'5.5px', stroke:'rgb(0,0,0)'}
                                : ( this.props.size < pinMiddle
                                ? { fill:'white', strokeWidth:'3px', stroke:'rgb(0,0,0)'}
                                : { fill:'white', strokeWidth:'2px', stroke:'rgb(0,0,0)'}))
                            }
                        >
                        </rect> 
                        <text 
