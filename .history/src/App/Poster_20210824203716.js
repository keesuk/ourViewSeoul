...
class Poster extends PureComponent {
    ...
    componentDidMount(){
        ...
        setTimeout(() => {this.setState({whole : true})},100)
    }
    ...
    render(){
        const { posterOpen, pageUp, posterPin } = this.props

        return (
            pageUp ?
            <>
                <PosterContentDiv>
                    <WholeWrap style={this.state.whole
                        ?{opacity:1}
                        :{opacity:0}
                    }>
                        <Logo
                        ...
                        <DataMap 
                            ...
                            pointer={false}
                            posterOn={pageUp}
                            rerender={this.state.posterOrnamentOn}
                        />
                        : 
                        <QuestionDiv>
                    ...
                    <MapExplainDiv>
                        ...
                        ? <>
                            ...
                            <DataMap 
                                ...
                                stroke={false}
                                pointer={true}
                                posterPin={ posterPin[posterPin.length-1] }
                            />
                            {/* <MapShowText>
                                <Rhombus right={'0px'}/>
