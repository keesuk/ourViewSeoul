...
class Window extends PureComponent {
    ...
    render(){
        ...
        const myButtonColor = randomize(colorListTag)
        ...
        return(
            ...
            >
                ...
                <div
                    ...
                    boxShadow: inputOn ? '4px 6px black':(windowUp ? (textOn ? (nonPass ? '0px 0px red':'4px 6px'+ myButtonColor ):'0px 0px #cccccc'):'0px 0px #cccccc'),
                    color: inputOn ? 'black':(windowUp ? (textOn ? (nonPass ? 'red': myButtonColor ):'#999'):'#999'),
                    borderColor: inputOn ? 'black' : (windowUp ? (textOn ? (nonPass ? 'red':  myButtonColor):'#cccccc'):'#cccccc'),
                ...
                >
                    {inputOn ? '여기까지 할래요':(windowUp ? (textOn ? (nonPass ? '5자 내로 적어주세요':'다 했어요'):'거의 다 했어요'):stationName)}
                </div>
            </div>
        )
    }
