                    ...
                    <MapExplainWrapperDiv>
                        <MapExplainDiv>
                            ...
                            <ExplainTitle>
                                ...
                                <ExplainPlanning>
                                    서울시 지역구는 서울사람들에게 경험에 따라 각각의 의미가 존재합니다. 각자의 관점에서 표현될 수 있는 지도라는 개념을 재구성할 수 있습니다. <br/> ‘우리가 본 서울시’ 프로젝트는 그래픽적으로 표현되는 데이터들에 대해 사용자의 관점, 추억, 경험에 따른 데이터 재구성을 통해 공감이 가는 혹은 커스터마이징 된 데이터 시각화를 목표로 하며, 여러 사람들의 데이터를 융합한 공감지도를 그려보고자 합니다.
                                </ExplainPlanning>
                        </MapExplainDiv>
                    </MapExplainWrapperDiv>
            </>
