...
import { pxStringfier, colorChooser, randomize, mapDrawer, infoGraphic, getRandomInt } from "./_Diagram.jsx";
...
class MapShow extends PureComponent {
    ...
    componentDidMount(){
        ...
        setTimeout(() => {
            ...
            let num = getRandomInt(0, 500)
            let one = this.cor
            console.log(randomProp(location))
        }, 1000)
    }
