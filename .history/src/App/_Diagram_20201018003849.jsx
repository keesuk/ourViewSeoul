...
export function pxStringfier(value) {
    const valuePx = value.toString() + 'px' 
    return valuePx
}

export function colorChooser(value) {
    if(value === '#7B2E8E')const answer = 'purple'
    else if(value === '#006CC4')const answer = 'blue'
    else if(value === '#E20000')const answer = 'red'
    else if(value === '#087A0D')const answer = 'green'
    else if(value === '#EFC820')const answer = 'yellow'
