...
export class Pin extends React.PureComponent {
    ...
    render() {
        ...
        const trianglePin = (i) => {
            return (<text fontSize={'80px'} transform={`rotate(38.2, 30, -40)`} fill={'#087A0D'} key={i}>
            ▲ </text>
        )}
        const circlePin = (i) => {
        ...
        const rhombusPin = (i) => {
            ...
            <g transform={`rotate(-15, 0, 0)`}>
                <rect width={'55px'} height={'55px'} x={'-5px'} y={'-45px'} transform={`skewX(-30), skewY(0)`} fill={'#e90087'} key={i}/>
            </g>
        )}
