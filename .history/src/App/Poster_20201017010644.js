                    ...
                    <MapExplainWrapperDiv>
                        <MapExplainDiv>
                            ...
                            <ExplainTitle>
                                ...
                                <ExplainPlanning>
                                    지역은 개개인의 경험 속 저마다의 다른 의미가 존재합니다. 그렇기 때문에 내가 보는 특정 지역은 타인이 보는 관점과  <br/> 다를 수도 같을 수도 있습니다. <br/> 우리가 본 서울시 프로젝트는 이러한  <br/> 아이디어에 착안하여 제작되었습니다. 대한민국을 대표하는 도시 서울은 방대한 사람들이 오가는 곳이기에 타도시에 비해 비교적 넓은 공감대를 지니고 있습니다. 그렇기 때문에 서울시는 특정지역을 보더라도 다양한 관점이 나올 수 있고, 그 속에서 공감 혹은 낯선 감정들을 느낄 수 있습니다. 우리가 본 서울시 프로젝트는 저마다의 다른 관점, 추억, 경험을 재구성하여 공감이 갈 수 있는 데이터 시각화를 목표로 하며, 여러 사람들의 데이터를 융합한 공감지도를 그려보고자 합니다.
                                </ExplainPlanning>
                        </MapExplainDiv>
                    </MapExplainWrapperDiv>
            </>
