                    ...
                    <div className="header-content">
                        ...
                        <div>
                            {/* {stationDatas.map(stationData =>
                                stationData && stationData.locationTag === '지하철' && <Circle/>,
                                stationData && stationData.locationTag === '' && <Rhombus/>,
                                stationData && stationData.locationTag === '' && <Triangle/>,
                                stationData && stationData.locationTag === '' && <Rectangular/>,
                                stationData && stationData.locationTag === '' && <Ellipse/>,
                            )} */}
                        </div>
                    </div>
                </header>
