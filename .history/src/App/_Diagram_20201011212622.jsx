...
export class AskMarker extends React.PureComponent {
    render(){ 
        return(
            <>
                <MarkerDiv style={{color:this.props.color === 'red'? colorListTag[0] : (this.props.color === 'green'? colorListTag[1]: (this.props.color === 'blue'? colorListTag[2]: (this.props.color === 'purple'? colorListTag[3] : colorListTag[4])))}}>
                    {this.props.color === 'red' ? shapeItems[0] : (this.props.color === 'green'? shapeItems[1]: (this.props.color === 'blue'? shapeItems[2]: (this.props.color === 'purple'? shapeItems[3] : shapeItems[4])))}
                </MarkerDiv>
            </>
        )
    }
...
export function change(i, items) {
    i = (i+1) % items.length
    return items[i]
}