...
export class Triangle extends React.PureComponent {
    render() {
        ...
        return(
            <TriangleText
                style ={{ 
                    color: getDown.length !== 0 ? '#087A0D':(on.length !== 0 ? '#e5e5e5' : 'black'),
                    marginRight: right,
                    marginLeft: left,
                    fontSize: size,
                    marginTop: top
...
export class Circle extends React.PureComponent {
    render() {
        ...
        return(
            <div
                style ={{ 
                    color: getDown.length !== 0 ? '#E20000':(on.length !== 0 ? '#e5e5e5' : 'black'),
                    marginRight: right,
                    marginLeft: left,
                    fontSize: size,
                }}
...
export class Rhombus extends React.PureComponent {
    render() {
        ...
        return(
            <div style ={{ 
                color: getDown.length !== 0 ? '#e90087':(on.length !== 0 ? '#e5e5e5' : 'black'),
                marginRight: right,
                marginLeft: left,
                fontSize: size,
            }}>
...
export class Rectangular extends React.PureComponent {
    render() {
        ...
        return(
            <div
                style ={{ 
                    color: getDown.length !== 0 ? '#006CC4':(on.length !== 0 ? '#e5e5e5' : 'black'),
                    marginRight: right,
                    marginLeft: left,
                    fontSize: size,
                }}
...
export class Ellipse extends React.PureComponent {
    render() {
        ...
        return(
            <div
                style ={{ 
                    color: getDown.length !== 0 ? '#00bfb3':(on.length !== 0 ? '#e5e5e5' : 'black'),
                    marginRight: right,
                    marginLeft: left,
                    fontSize: size,
                    marginTop: top,
