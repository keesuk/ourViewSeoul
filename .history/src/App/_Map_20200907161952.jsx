...
class Map extends PureComponent {
  render() {
    ...
    <Svg
      ...
      xmlSpace="preserve"
    >
    <g onClick={()=> {history.push(`/map`)}} id="map" key="map_Station">
      <g onClick={()=> {history.push(`/Ilsan`)}} id="Ilsan" key="Ilsan_Station">
      ...
      <g onClick={()=> {history.push(`/Pungsan`)}} id="Pungsan" key="Pungsan_Station">
      ...
      <g onClick={()=> {history.push(`/Baengma`)}} id="Baengma" key="Baengma_Station">
      ...
      <g onClick={()=> {history.push(`/Hwajeong`)}} id="Hwajeong" key="Hwajeong_Station">
      ...
      <g onClick={()=> {history.push(`/Wondang`)}} id="Wondang" key="Wondang_Station">
      ...
      <g onClick={()=> {history.push(`/Wonheung`)}} id="Wonheung" key="Wonheung_Station">
      ...
      <g onClick={()=> {history.push(`/Samsong`)}} id="Samsong" key="Samsong_Station">
      ...
      <g onClick={()=> {history.push(`/Tanhyeon`)}} id="Tanhyeon" key="Tanhyeon_Station">
      ...
      <g onClick={()=> {history.push(`/Unjeong`)}} id="Unjeong" key="Unjeong_Station">
      ...
      <g onClick={()=> {history.push(`/Geumneung`)}} id="Geumneung" key="Geumneung_Station">
      ...
      <g onClick={()=> {history.push(`/Geumchon`)}} id="Geumchon" key="Geumchon_Station">
      ...
      <g onClick={()=> {history.push(`/Wollong`)}} id="Wollong" key="Wollong_Station">
      ...
      <g onClick={()=> {history.push(`/Paju`)}} id="Paju" key="Paju_Station">
      ...
      <g onClick={()=> {history.push(`/Munsan`)}} id="Munsan" key="Munsan_Station">
      ...
      <g onClick={()=> {history.push(`/Bugae`)}} id="Bugae" key="Bugae_Station">
      ...
      <g onClick={()=> {history.push(`/Songnae`)}} id="Songnae" key="Songnae_Station">
      ...
      <g onClick={()=> {history.push(`/Jungdong`)}} id="Jungdong" key="Jungdong_Station">
      ...
      <g onClick={()=> {history.push(`/Bucheon`)}} id="Bucheon" key="Bucheon_Station">
      ...
      <g onClick={()=> {history.push(`/Sosa`)}} id="Sosa" key="Sosa_Station">
      ...
      <g onClick={()=> {history.push(`/Yeokgok`)}} id="Yeokgok" key="Yeokgok_Station">
      ...
      <g onClick={()=> {history.push(`/Technopark`)}} id="Technopark" key="Technopark_Station">
      ...
      <g onClick={()=> {history.push(`/BITZone`)}} id="BITZone" key="BITZone_Station">
      ...
      <g onClick={()=> {history.push(`/IncheonNatlUniv`)}} id="IncheonNatlUniv" key="IncheonNatlUniv_Station">
      ...
      <g onClick={()=> {history.push(`/CentralPark`)}} id="CentralPark" key="CentralPark_Station">
      ...
      <g onClick={()=> {history.push(`/IntlBusinessDistrict`)}} id="IntlBusinessDistrict" key="IntlBusinessDistrict_Station">
      ...
      <g onClick={()=> {history.push(`/SingilonCheon`)}} id="SingilonCheon" key="SingilonCheon_Station">
      ...
      <g onClick={()=> {history.push(`/Sinchang`)}} id="Sinchang" key="Sinchang_Station">
      ...
      <g onClick={()=> {history.push(`/OnyangonCheon`)}} id="OnyangonCheon" key="OnyangonCheon_Station">
      ...
      <g onClick={()=> {history.push(`/Baebang`)}} id="Baebang" key="Baebang_Station">
      ...
      <g onClick={()=> {history.push(`/Asan`)}} id="Asan" key="Asan_Station">
      ...
      <g onClick={()=> {history.push(`/Ssangyong`)}} id="Ssangyong" key="Ssangyong_Station">
      ...
      <g onClick={()=> {history.push(`/Bongmyeong`)}} id="Bongmyeong" key="Bongmyeong_Station">
      ...
      <g onClick={()=> {history.push(`/Cheonan`)}} id="Cheonan" key="Cheonan_Station">
      ...
      <g onClick={()=> {history.push(`/Dujeong`)}} id="Dujeong" key="Dujeong_Station">
      ...
      <g onClick={()=> {history.push(`/Jiksan`)}} id="Jiksan" key="Jiksan_Station">
      ...
      <g onClick={()=> {history.push(`/Seonghwan`)}} id="Seonghwan" key="Seonghwan_Station">
      ...
      <g onClick={()=> {history.push(`/Pyeongtaek`)}} id="Pyeongtaek" key="Pyeongtaek_Station">
      ...
      <g onClick={()=> {history.push(`/Jije`)}} id="Jije" key="Jije_Station">
      ...
      <g onClick={()=> {history.push(`/Seojeongri`)}} id="Seojeongri" key="Seojeongri_Station">
      ...
      <g onClick={()=> {history.push(`/Songtan`)}} id="Songtan" key="Songtan_Station">
      ...
      <g onClick={()=> {history.push(`/Osan`)}} id="Osan" key="Osan_Station">
      ...
      <g onClick={()=> {history.push(`/OsanCollege`)}} id="OsanCollege" key="OsanCollege_Station">
      ...
      <g onClick={()=> {history.push(`/Sema`)}} id="Sema" key="Sema_Station">
      ...
      <g onClick={()=> {history.push(`/Seodongtan`)}} id="Seodongtan" key="Seodongtan_Station">
      ...
      <g onClick={()=> {history.push(`/Jinwi`)}} id="Jinwi" key="Jinwi_Station">
      ...
      <g onClick={()=> {history.push(`/Ansan`)}} id="Ansan" key="Ansan_Station">
      ...
      <g onClick={()=> {history.push(`/Choji`)}} id="Choji" key="Choji_Station">
      ...
      <g onClick={()=> {history.push(`/Gojan`)}} id="Gojan" key="Gojan_Station">
      ...
      <g onClick={()=> {history.push(`/Jungang`)}} id="Jungang" key="Jungang_Station">
      ...
      <g onClick={()=> {history.push(`/HanyangUnivatAnsan`)}} id="HanyangUnivatAnsan" key="HanyangUnivatAnsan_Station">
      ...
      <g onClick={()=> {history.push(`/Sangnoksu`)}} id="Sangnoksu" key="Sangnoksu_Station">
      ...
      <g onClick={()=> {history.push(`/Banwol`)}} id="Banwol" key="Banwol_Station">
      ...
      <g onClick={()=> {history.push(`/Daeyami`)}} id="Daeyami" key="Daeyami_Station">
      ...
      <g onClick={()=> {history.push(`/Surisan`)}} id="Surisan" key="Surisan_Station">
      ...
      <g onClick={()=> {history.push(`/SuwonCityHall1`)}} id="SuwonCityHall1" key="SuwonCityHall1_Station">
      ...
      <g onClick={()=> {history.push(`/SuwonCityHall`)}} id="SuwonCityHall" key="SuwonCityHall_Station">
      ...
      <g onClick={()=> {history.push(`/MaetanGwonseon`)}} id="MaetanGwonseon" key="MaetanGwonseon_Station">
      ...
      <g onClick={()=> {history.push(`/Mangpo`)}} id="Mangpo" key="Mangpo_Station">
      ...
      <g onClick={()=> {history.push(`/Yeongtong`)}} id="Yeongtong" key="Yeongtong_Station">
      ...
      <g onClick={()=> {history.push(`/Cheongmyeong`)}} id="Cheongmyeong" key="Cheongmyeong_Station">
      ...
      <g onClick={()=> {history.push(`/Sanggal`)}} id="Sanggal" key="Sanggal_Station">
      ...
      <g onClick={()=> {history.push(`/Singal`)}} id="Singal" key="Singal_Station">
      ...
      <g onClick={()=> {history.push(`/Guseong`)}} id="Guseong" key="Guseong_Station">
      ...
      <g onClick={()=> {history.push(`/Bojeong`)}} id="Bojeong" key="Bojeong_Station">
      ...
      <g onClick={()=> {history.push(`/Jukjeon`)}} id="Jukjeon" key="Jukjeon_Station">
      ...
      <g onClick={()=> {history.push(`/Ori`)}} id="Ori" key="Ori_Station">
      ...
      <g onClick={()=> {history.push(`/MyongjiUniv`)}} id="MyongjiUniv" key="MyongjiUniv_Station">
      ...
      <g onClick={()=> {history.push(`/Samga1`)}} id="Samga1" key="Samga1_Station">
      ...
      <g onClick={()=> {history.push(`/Samga`)}} id="Samga" key="Samga_Station">
      ...
      <g onClick={()=> {history.push(`/Chodang`)}} id="Chodang" key="Chodang_Station">
      ...
      <g onClick={()=> {history.push(`/Dongbaek`)}} id="Dongbaek" key="Dongbaek_Station">
      ...
      <g onClick={()=> {history.push(`/Eojeong`)}} id="Eojeong" key="Eojeong_Station">
      ...
      <g onClick={()=> {history.push(`/Jiseok`)}} id="Jiseok" key="Jiseok_Station">
      ...
      <g onClick={()=> {history.push(`/Gulpocheon`)}} id="Gulpocheon" key="Gulpocheon_Station">
      ...
      <g onClick={()=> {history.push(`/SamsanGymnasium`)}} id="SamsanGymnasium" key="SamsanGymnasium_Station">
      ...
      <g onClick={()=> {history.push(`/BucheonCityHall`)}} id="BucheonCityHall" key="BucheonCityHall_Station">
      ...
      <g onClick={()=> {history.push(`/Sinjungdong`)}} id="Sinjungdong" key="Sinjungdong_Station">
      ...
      <g onClick={()=> {history.push(`/Sangdong`)}} id="Sangdong" key="Sangdong_Station">
      ...
      <g onClick={()=> {history.push(`/Songdo`)}} id="Songdo" key="Songdo_Station">
      ...
      <g onClick={()=> {history.push(`/Jeongwang`)}} id="Jeongwang" key="Jeongwang_Station">
      ...
      <g onClick={()=> {history.push(`/Ungilsan1`)}} id="Ungilsan1" key="Ungilsan1_Station">
      ...
      <g onClick={()=> {history.push(`/Ungilsan`)}} id="Ungilsan" key="Ungilsan_Station">
      ...
      <g onClick={()=> {history.push(`/Yangsu`)}} id="Yangsu" key="Yangsu_Station">
      ...
      <g onClick={()=> {history.push(`/Sinwon`)}} id="Sinwon" key="Sinwon_Station">
      ...
      <g onClick={()=> {history.push(`/Guksu`)}} id="Guksu" key="Guksu_Station">
      ...
      <g onClick={()=> {history.push(`/Asin`)}} id="Asin" key="Asin_Station">
      ...
      <g onClick={()=> {history.push(`/Obin`)}} id="Obin" key="Obin_Station">
      ...
      <g onClick={()=> {history.push(`/Yangpyeong1`)}} id="Yangpyeong1" key="Yangpyeong1_Station">
      ...
      <g onClick={()=> {history.push(`/Wondeok`)}} id="Wondeok" key="Wondeok_Station">
      ...
      <g onClick={()=> {history.push(`/Yongmun`)}} id="Yongmun" key="Yongmun_Station">
      ...
      <g onClick={()=> {history.push(`/Paldang`)}} id="Paldang" key="Paldang_Station">
      ...
      <g onClick={()=> {history.push(`/CampusTown`)}} id="CampusTown" key="CampusTown_Station">
      ...
      <g onClick={()=> {history.push(`/KangnamUniv`)}} id="KangnamUniv" key="KangnamUniv_Station">
      ...
      <g onClick={()=> {history.push(`/Sanbon`)}} id="Sanbon" key="Sanbon_Station">
      ...
      <g onClick={()=> {history.push(`/Mullae`)}} id="Mullae" key="Mullae_Station">
        <text transform="translate(421.9213 808.1027)" className="st0 st1">문래</text>
      </g>
      <g onClick={()=> {history.push(`/Beomgye`)}} id="Beomgye" key="Beomgye_Station">
        <text transform="translate(689.579 1103.5685)" className="st0 st1">범계</text>
      </g>
      <g onClick={()=> {history.push(`/Pyeongchon`)}} id="Pyeongchon" key="Pyeongchon_Station">
        <text transform="translate(689.579 1088.3175)" className="st0 st1">평촌</text>
      </g>
      <g onClick={()=> {history.push(`/Indeogwon`)}} id="Indeogwon" key="Indeogwon_Station">
        <text transform="translate(689.579 1073.0675)" className="st0 st1">인덕원</text>
      </g>
      <g onClick={()=> {history.push(`/GovernmentComplexGwacheon`)}} id="GovernmentComplexGwacheon" key="GovernmentComplexGwacheon_Station">
        <text transform="translate(689.579 1057.8116)" className="st0 st1">정부과천청사</text>
      </g>
      <g onClick={()=> {history.push(`/Gwacheon`)}} id="Gwacheon" key="Gwacheon_Station">
        <text transform="translate(689.579 1042.5616)" className="st0 st1">과천</text>
      </g>
      <g onClick={()=> {history.push(`/SeoulGrandPark`)}} id="SeoulGrandPark" key="SeoulGrandPark_Station">
        <text transform="translate(689.579 1027.3038)" className="st0 st1">대공원</text>
      </g>
      <g onClick={()=> {history.push(`/SeoulRacecoursePark`)}} id="SeoulRacecoursePark" key="SeoulRacecoursePark_Station">
        <text transform="translate(689.579 1012.0548)" className="st0 st1">경마공원</text>
      </g>
      <g onClick={()=> {history.push(`/Seonbawi`)}} id="Seonbawi" key="Seonbawi_Station">
        <text transform="translate(689.579 996.8038)" className="st0 st1">선바위</text>
      </g>
      <g onClick={()=> {history.push(`/Namtaeryeong`)}} id="Namtaeryeong" key="Namtaeryeong_Station">
        <text transform="translate(689.579 981.547)" className="st0 st1">남태령</text>
      </g>
      <g onClick={()=> {history.push(`/Geomam`)}} id="Geomam" key="Geomam_Station">
        <text transform="translate(74.4359 557.6925)" className="st0 st1">검암</text>
      </g>
      <g onClick={()=> {history.push(`/Gyulhyeon`)}} id="Gyulhyeon" key="Gyulhyeon_Station">
        <text transform="translate(74.4359 626.3771)" className="st0 st1">귤현</text>
      </g>
      <g onClick={()=> {history.push(`/Bakchon`)}} id="Bakchon" key="Bakchon_Station">
        <text transform="translate(74.4359 659.2882)" className="st0 st1">박촌</text>
      </g>
      <g onClick={()=> {history.push(`/Imhak`)}} id="Imhak" key="Imhak_Station">
        <text transform="translate(74.4359 692.1993)" className="st0 st1">임학</text>
      </g>
      <g onClick={()=> {history.push(`/Gyesan`)}} id="Gyesan" key="Gyesan_Station">
        <text transform="translate(74.4359 725.1183)" className="st0 st1">계산</text>
      </g>
      <g onClick={()=> {history.push(`/GyeonginNatlUnivofEducation`)}} id="GyeonginNatlUnivofEducation" key="GyeonginNatlUnivofEducation_Station">
        <text transform="translate(74.4359 758.0304)" className="st0 st1">경인교대입구</text>
      </g>
      <g onClick={()=> {history.push(`/CheongnaIntlCityStation`)}} id="CheongnaIntlCityStation" key="CheongnaIntlCityStation_Station">
        <text transform="translate(75.9447 539.4855)" className="st0 st1">청라국제도시</text>
      </g>
      <g onClick={()=> {history.push(`/Yongmasan`)}} id="Yongmasan" key="Yongmasan_Station">
        <text transform="translate(999.2616 602.9288)" className="st0 st1">용마산</text>
      </g>
      <g onClick={()=> {history.push(`/Sagajeong`)}} id="Sagajeong" key="Sagajeong_Station">
        <text transform="translate(999.2616 576.5245)" className="st0 st1">사가정</text>
      </g>
      <g onClick={()=> {history.push(`/Myeonmok`)}} id="Myeonmok" key="Myeonmok_Station">
        <text transform="translate(999.2616 547.546)" className="st0 st1">면목</text>
      </g>
      <g onClick={()=> {history.push(`/Jungnang`)}} id="Jungnang" key="Jungnang_Station">
        <text transform="translate(952.6971 533.172)" className="st0 st1">중랑</text>
      </g>
      <g onClick={()=> {history.push(`/Sinnae`)}} id="Sinnae" key="Sinnae_Station">
        <text transform="translate(1045.7147 457.4913)" className="st0 st1">신내</text>
      </g>
      <g onClick={()=> {history.push(`/Changsin`)}} id="Changsin" key="Changsin_Station">
        <text transform="translate(786.6542 581.3898)" className="st0 st1">창신</text>
      </g>
      <g onClick={()=> {history.push(`/Apgujeong`)}} id="Apgujeong" key="Apgujeong_Station">
        <text transform="translate(798.9677 779.5177)" className="st0 st1">압구정</text>
      </g>
      <g onClick={()=> {history.push(`/Saejeol`)}} id="Saejeol" key="Saejeol_Station">
        <text transform="translate(487.3246 536.0724)" className="st0 st1">새절</text>
      </g>
      <g onClick={()=> {history.push(`/Eungam`)}} id="Eungam" key="Eungam_Station">
        <text transform="translate(487.3246 509.6984)" className="st0 st1">응암</text>
      </g>
      <g onClick={()=> {history.push(`/Gupabal`)}} id="Gupabal" key="Gupabal_Station">
        <text transform="translate(503.6517 366.7472)" className="st0 st1">구파발</text>
      </g>
      <g onClick={()=> {history.push(`/SookmyungWomensUniv`)}} id="SookmyungWomensUniv" key="SookmyungWomensUniv_Station">
        <text transform="translate(662.0165 707.6759)" className="st0 st1">숙대입구</text>
      </g>
      <g onClick={()=> {history.push(`/Namyeong`)}} id="Namyeong" key="Namyeong_Station">
        <text transform="translate(657.6512 724.6798)" className="st0 st1">남영</text>
      </g>
      <g onClick={()=> {history.push(`/Seryu`)}} id="Seryu" key="Seryu_Station">
        <text transform="translate(790.1747 1155.4816)" className="st0 st1">세류</text>
      </g>
      <g onClick={()=> {history.push(`/GachonUniv`)}} id="GachonUniv" key="GachonUniv_Station">
        <text transform="translate(1084.0741 1012.7999)" className="st0 st1">가천대</text>
      </g>
      <g onClick={()=> {history.push(`/Jangji`)}} id="Jangji" key="Jangji_Station">
        <text transform="translate(1114.5497 957.3292)" className="st0 st1">장지</text>
      </g>
      <g onClick={()=> {history.push(`/Dandaeogeori`)}} id="Dandaeogeori" key="Dandaeogeori_Station">
        <text transform="translate(1144.9891 1032.671)" className="st0 st1">단대오거리</text>
      </g>
      <g onClick={()=> {history.push(`/Taepyeong`)}} id="Taepyeong" key="Taepyeong_Station">
        <text transform="translate(1089.6171 1036.5177)" className="st0 st1">태평</text>
      </g>
      <g onClick={()=> {history.push(`/Banghak`)}} id="Banghak" key="Banghak_Station">
        <text transform="translate(861.9227 253.8585)" className="st0 st1">방학</text>
      </g>
      <g onClick={()=> {history.push(`/Dobong`)}} id="Dobong" key="Dobong_Station">
        <text transform="translate(862.0604 209.5226)" className="st0 st1">도봉</text>
      </g>
      <g onClick={()=> {history.push(`/Dokbawi`)}} id="Dokbawi" key="Dokbawi_Station">
        <text transform="translate(547.1039 434.4816)" className="st0 st1">독바위</text>
      </g>
      <g onClick={()=> {history.push(`/Sinheung`)}} id="Sinheung" key="Sinheung_Station">
        <text transform="translate(1144.5682 1052.2491)" className="st0 st1">신흥</text>
      </g>
      <g onClick={()=> {history.push(`/Geumho`)}} id="Geumho" key="Geumho_Station">
        <text transform="translate(789.7303 696.9347)" className="st0 st1">금호</text>
      </g>
      <g onClick={()=> {history.push(`/Hyehwa`)}} id="Hyehwa" key="Hyehwa_Station">
        <text transform="translate(744.8182 571.2072)" className="st0 st1">혜화</text>
      </g>
      <g onClick={()=> {history.push(`/Achasan`)}} id="Achasan" key="Achasan_Station">
        <text transform="translate(1007.2538 683.2189)" className="st0 st1">아차산</text>
      </g>
      <g onClick={()=> {history.push(`/Jichuk`)}} id="Jichuk" key="Jichuk_Station">
        <text transform="translate(503.5902 339.8673)" className="st0 st1">지축</text>
      </g>
      <g onClick={()=> {history.push(`/Gusan`)}} id="Gusan" key="Gusan_Station">
        <text transform="translate(487.3314 461.13)" className="st0 st1">구산</text>
      </g>
      <g onClick={()=> {history.push(`/Munjeong`)}} id="Munjeong" key="Munjeong_Station">
        <text transform="translate(1114.5575 926.8282)" className="st0 st1">문정</text>
      </g>
      <g onClick={()=> {history.push(`/Mangwolsa`)}} id="Mangwolsa" key="Mangwolsa_Station">
        <text transform="translate(880.5663 83.1691)" className="st0 st1">망월사</text>
      </g>
      <g onClick={()=> {history.push(`/NamdongInduspark`)}} id="NamdongInduspark" key="NamdongInduspark_Station">
      ...
      <g onClick={()=> {history.push(`/Hogupo`)}} id="Hogupo" key="Hogupo_Station">
        <text transform="translate(258.9594 1085.7189)" className="st0 st1">호구포</text>
      </g>
      <g onClick={()=> {history.push(`/IncheonNonhyeon`)}} id="IncheonNonhyeon" key="IncheonNonhyeon_Station">
        <text transform="translate(290.5687 1085.7189)" className="st0 st1">인천논현</text>
      </g>
      <g onClick={()=> {history.push(`/Gwanak`)}} id="Gwanak" key="Gwanak_Station">
        <text transform="translate(499.1869 1111.7286)" className="st0 st1">관악</text>
      </g>
      <g onClick={()=> {history.push(`/Anyang`)}} id="Anyang" key="Anyang_Station">
        <text transform="translate(559.2426 1111.7286)" className="st0 st1">안양</text>
      </g>
      <g onClick={()=> {history.push(`/Myeonghak`)}} id="Myeonghak" key="Myeonghak_Station">
        <text transform="translate(619.598 1111.7286)" className="st0 st1">명학</text>
      </g>
      <g onClick={()=> {history.push(`/Gunpo`)}} id="Gunpo" key="Gunpo_Station">
        <text transform="translate(700.3573 1111.7286)" className="st0 st1">군포</text>
      </g>
      <g onClick={()=> {history.push(`/Dangjeong`)}} id="Dangjeong" key="Dangjeong_Station">
        <text transform="translate(720.6688 1111.7286)" className="st0 st1">당정</text>
      </g>
      <g onClick={()=> {history.push(`/Uiwang`)}} id="Uiwang" key="Uiwang_Station">
        <text transform="translate(740.9227 1111.7286)" className="st0 st1">의왕</text>
      </g>
      <g onClick={()=> {history.push(`/SungkyunkwanUniv`)}} id="SungkyunkwanUniv" key="SungkyunkwanUniv_Station">
        <text transform="translate(755.7469 1111.7286)" className="st0 st1">성균관대</text>
      </g>
      <g onClick={()=> {history.push(`/Sindaebang`)}} id="Sindaebang" key="Sindaebang_Station">
        <text transform="translate(470.9662 936.3361)" className="st0 st1">신대방</text>
      </g>
      <g onClick={()=> {history.push(`/Bongcheon`)}} id="Bongcheon" key="Bongcheon_Station">
        <text transform="translate(555.9603 938.84)" className="st0 st1">봉천</text>
      </g>
      <g onClick={()=> {history.push(`/Euljiro1ilga`)}} id="Euljiro1ilga" key="Euljiro1ilga_Station">
        <text transform="translate(671.5243 639.88)" className="st0 st1">을지로입구</text>
      </g>
      <g onClick={()=> {history.push(`/Jonggak`)}} id="Jonggak" key="Jonggak_Station">
        <text transform="translate(678.6317 619.6505)" className="st0 st1">종각역</text>
      </g>
      <g onClick={()=> {history.push(`/Jongno5oga`)}} id="Jongno5oga" key="Jongno5oga_Station">
        <text transform="translate(732.6561 605.4894)" className="st0 st1">종로5가</text>
      </g>
      <g onClick={()=> {history.push(`/Daebang`)}} id="Daebang" key="Daebang_Station">
        <text transform="translate(512.4271 830.09)" className="st0 st1">대방</text>
      </g>
      <g onClick={()=> {history.push(`/Sinpung`)}} id="Sinpung" key="Sinpung_Station">
        <text transform="translate(459.8558 883.8019)" className="st0 st1">신풍</text>
      </g>
      <g onClick={()=> {history.push(`/Namguro`)}} id="Namguro" key="Namguro_Station">
        <text transform="translate(384.9515 922.6007)" className="st0 st1">남구로</text>
      </g>
      <g onClick={()=> {history.push(`/Boramae`)}} id="Boramae" key="Boramae_Station">
        <text transform="translate(490.9633 883.6583)" className="st0 st1">보라매</text>
      </g>
      <g onClick={()=> {history.push(`/YangcheonHyanggyo`)}} id="YangcheonHyanggyo" key="YangcheonHyanggyo_Station">
        <text transform="translate(258.7406 614.8595)" className="st0 st1">양천향교</text>
      </g>
      <g onClick={()=> {history.push(`/Magongnaru`)}} id="Magongnaru" key="Magongnaru_Station">
        <text transform="translate(214.4369 614.8595)" className="st0 st1">마곡나루</text>
      </g>
      <g onClick={()=> {history.push(`/Sinbanghwa`)}} id="Sinbanghwa" key="Sinbanghwa_Station">
        <text transform="translate(187.6635 614.8654)" className="st0 st1">신방화</text>
      </g>
      <g onClick={()=> {history.push(`/IncheonIntlAirportCargoTerminal1`)}} id="IncheonIntlAirportCargoTerminal1" key="IncheonIntlAirportCargoTerminal1_Station">
        <text transform="translate(138.6185 523.8781)" className="st0 st1">인천국제공항</text>
      </g>
      <g onClick={()=> {history.push(`/IncheonIntlAirportCargoTerminal`)}} id="IncheonIntlAirportCargoTerminal" key="IncheonIntlAirportCargoTerminal_Station">
      ...
      <g onClick={()=> {history.push(`/Songjeong`)}} id="Songjeong" key="Songjeong_Station">
        <text transform="translate(177.6615 651.3849)" className="st0 st1">송정</text>
      </g>
      <g onClick={()=> {history.push(`/Magok`)}} id="Magok" key="Magok_Station">
        <text transform="translate(211.1859 651.3849)" className="st0 st1">마곡</text>
      </g>
      <g onClick={()=> {history.push(`/Sinjeong`)}} id="Sinjeong" key="Sinjeong_Station">
        <text transform="translate(304.0209 776.3175)" className="st0 st1">신정</text>
      </g>
      <g onClick={()=> {history.push(`/Mokdong`)}} id="Mokdong" key="Mokdong_Station">
        <text transform="translate(328.5228 776.3175)" className="st0 st1">목동</text>
      </g>
      <g onClick={()=> {history.push(`/Omokgyo`)}} id="Omokgyo" key="Omokgyo_Station">
        <text transform="translate(357.6205 776.3175)" className="st0 st1">오목교</text>
      </g>
      <g onClick={()=> {history.push(`/Yangpyeong`)}} id="Yangpyeong" key="Yangpyeong_Station">
        <text transform="translate(391.1205 776.3175)" className="st0 st1">양평</text>
      </g>
      <g onClick={()=> {history.push(`/Gwanghwamun`)}} id="Gwanghwamun" key="Gwanghwamun_Station">
        <text transform="translate(658.2391 601.0743)" className="st0 st1">광화문</text>
      </g>
      <g onClick={()=> {history.push(`/Itaewon`)}} id="Itaewon" key="Itaewon_Station">
        <text transform="translate(712.5272 752.3615)" className="st0 st1">이태원</text>
      </g>
      <g onClick={()=> {history.push(`/Noksapyeong`)}} id="Noksapyeong" key="Noksapyeong_Station">
        <text transform="translate(688.8143 752.3927)" className="st0 st1">녹사평</text>
      </g>
      <g onClick={()=> {history.push(`/Seobinggo`)}} id="Seobinggo" key="Seobinggo_Station">
        <text transform="translate(692.8485 808.8419)" className="st0 st1">서빙고</text>
      </g>
      <g onClick={()=> {history.push(`/Gwangheungchang`)}} id="Gwangheungchang" key="Gwangheungchang_Station">
        <text transform="translate(526.0931 706.4865)" className="st0 st1">광흥창</text>
      </g>
      <g onClick={()=> {history.push(`/Sangsu`)}} id="Sangsu" key="Sangsu_Station">
        <text transform="translate(502.5941 706.4865)" className="st0 st1">상수</text>
      </g>
      <g onClick={()=> {history.push(`/Baekseok`)}} id="Baekseok" key="Baekseok_Station">
        <text transform="translate(396.8383 337.1681)" className="st0 st1">백석</text>
      </g>
      <g onClick={()=> {history.push(`/Gyeongbokgung`)}} id="Gyeongbokgung" key="Gyeongbokgung_Station">
        <text transform="translate(650.2665 584.1642)" className="st0 st1">경복궁</text>
      </g>
      <g onClick={()=> {history.push(`/Anguk`)}} id="Anguk" key="Anguk_Station">
        <text transform="translate(688.5907 584.1466)" className="st0 st1">안국</text>
      </g>
      <g onClick={()=> {history.push(`/Myeongdong`)}} id="Myeongdong" key="Myeongdong_Station">
        <text transform="translate(690.7069 655.4435)" className="st0 st1">명동</text>
      </g>
      <g onClick={()=> {history.push(`/LrtUijeongbu`)}} id="LrtUijeongbu" key="LrtUijeongbu_Station">
      ...
      <g onClick={()=> {history.push(`/Geumjeong`)}} id="Geumjeong" key="Geumjeong_Station">
        <text transform="translate(669.5272 1113.2062)" className="st0 st1">금정</text>
      </g>
      <g onClick={()=> {history.push(`/Suwon`)}} id="Suwon" key="Suwon_Station">
        <text transform="translate(769.3934 1141.7072)" className="st0 st1">수원</text>
      </g>
      <g onClick={()=> {history.push(`/Byeongjeom`)}} id="Byeongjeom" key="Byeongjeom_Station">
        <text transform="translate(789.9432 1170.1271)" className="st0 st1">병점</text>
      </g>
      <g onClick={()=> {history.push(`/Giheung`)}} id="Giheung" key="Giheung_Station">
      ...
      <g onClick={()=> {history.push(`/DongdaemunHistoryCulturePark`)}} id="DongdaemunHistoryCulturePark" key="DongdaemunHistoryCulturePark_Station">
      ...
      <g onClick={()=> {history.push(`/GuroDigitalComplex`)}} id="GuroDigitalComplex" key="GuroDigitalComplex_Station">
    ...
    <g onClick={()=> {history.push(`/broad`)}} id="broad" key="broad_Station">
      <g onClick={()=> {history.push(`/GangnamGu`)}} id="GangnamGu" key="GangnamGu_Station">
        <text transform="translate(946.6327 985.6007)" className="st3 st0 st4">강남구</text>
      </g>
      <g onClick={()=> {history.push(`/SeochoGu`)}} id="SeochoGu" key="SeochoGu_Station">
        <text transform="translate(758.9042 981.338)" className="st3 st0 st4">서초구</text>
      </g>
      <g onClick={()=> {history.push(`/SongpaGu`)}} id="SongpaGu" key="SongpaGu_Station">
        <text transform="translate(1066.1063 844.8058)" className="st3 st0 st4">송파구</text>
      </g>
      <g onClick={()=> {history.push(`/GangdongGu`)}} id="GangdongGu" key="GangdongGu_Station">
        <text transform="translate(1181.3065 746.673)" className="st3 st0 st4">강동구</text>
      </g>
      <g onClick={()=> {history.push(`/GwanakGu`)}} id="GwanakGu" key="GwanakGu_Station">
        <text transform="translate(562.64 994.1437)" className="st3 st0 st4">관악구</text>
      </g>
      <g onClick={()=> {history.push(`/DongjakGu`)}} id="DongjakGu" key="DongjakGu_Station">
        <text transform="translate(558.3783 900.2755)" className="st3 st0 st4">동작구</text>
      </g>
      <g onClick={()=> {history.push(`/GeumcheonGu`)}} id="GeumcheonGu" key="GeumcheonGu_Station">
        <text transform="translate(447.4486 985.6095)" className="st3 st0 st4">금천구</text>
      </g>
      <g onClick={()=> {history.push(`/GuroGu`)}} id="GuroGu" key="GuroGu_Station">
        <text transform="translate(323.7133 913.0812)" className="st3 st0 st4">구로구</text>
      </g>
      <g onClick={()=> {history.push(`/YangcheonGu`)}} id="YangcheonGu" key="YangcheonGu_Station">
        <text transform="translate(310.9154 806.4152)" className="st3 st0 st4">양천구</text>
      </g>
      <g onClick={()=> {history.push(`/GangseoGu`)}} id="GangseoGu" key="GangseoGu_Station">
        <text transform="translate(306.6537 712.545)" className="st3 st0 st4">강서구</text>
      </g>
      <g onClick={()=> {history.push(`/MapoGu`)}} id="MapoGu" key="MapoGu_Station">
        <text transform="translate(571.184 682.6798)" className="st3 st0 st4">마포구</text>
      </g>
      <g onClick={()=> {history.push(`/EunpyeongGu`)}} id="EunpyeongGu" key="EunpyeongGu_Station">
        <text transform="translate(502.9174 554.6818)" className="st3 st0 st4">은평구</text>
      </g>
      <g onClick={()=> {history.push(`/SeodaemunGu`)}} id="SeodaemunGu" key="SeodaemunGu_Station">
        <text transform="translate(536.7123 610.1505)" className="st3 st0 st4">서대문구</text>
      </g>
      <g onClick={()=> {history.push(`/JongnoGu`)}} id="JongnoGu" key="JongnoGu_Station">
        <text transform="translate(665.0526 529.087)" className="st3 st0 st4">종로구</text>
      </g>
      <g onClick={()=> {history.push(`/JungGu`)}} id="JungGu" key="JungGu_Station">
        <text transform="translate(708.0585 674.1534)" className="st3 st0 st4">중구</text>
      </g>
      <g onClick={()=> {history.push(`/SeongdongGu`)}} id="SeongdongGu" key="SeongdongGu_Station">
        <text transform="translate(822.9159 704.0197)" className="st3 st0 st4">성동구</text>
      </g>
      <g onClick={()=> {history.push(`/DongdaemunGu`)}} id="DongdaemunGu" key="DongdaemunGu_Station">
        <text transform="translate(907.9091 588.8195)" className="st3 st0 st4">동대문구</text>
      </g>
      <g onClick={()=> {history.push(`/JungnangGu`)}} id="JungnangGu" key="JungnangGu_Station">
        <text transform="translate(993.578 477.8888)" className="st3 st0 st4">중랑구</text>
      </g>
      <g onClick={()=> {history.push(`/DobongGu`)}} id="DobongGu" key="DobongGu_Station">
        <text transform="translate(818.6444 247.4884)" className="st3 st0 st4">도봉구</text>
      </g>
      <g onClick={()=> {history.push(`/GangbukGu`)}} id="GangbukGu" key="GangbukGu_Station">
        <text transform="translate(763.1757 422.42)" className="st3 st0 st4">강북구</text>
      </g>
      <g onClick={()=> {history.push(`/SeongbukGu`)}} id="SeongbukGu" key="SeongbukGu_Station">
        <text transform="translate(784.5077 533.3497)" className="st3 st0 st4">성북구</text>
      </g>
      <g onClick={()=> {history.push(`/GwangjinGu`)}} id="GwangjinGu" key="GwangjinGu_Station">
        <text transform="translate(1014.9091 652.8136)" className="st3 st0 st4">광진구</text>
      </g>
      <g onClick={()=> {history.push(`/YongsanGu`)}} id="YongsanGu" key="YongsanGu_Station">
        <text transform="translate(686.3749 772.2775)" className="st3 st0 st4">용산구</text>
      </g>
      <g onClick={()=> {history.push(`/YeongdeungpoGu`)}} id="YeongdeungpoGu" key="YeongdeungpoGu_Station">
        <text transform="translate(464.1742 853.34)" className="st3 st0 st4">영등포구</text>
      </g>
      <g onClick={()=> {history.push(`/NowonGu`)}} id="NowonGu" key="NowonGu_Station">
