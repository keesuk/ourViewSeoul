                    ...
                    <TransformComponent>
                        <SvgContainer> 
                            ...
                            <g>
                                ...
                                <text transform="translate(40 40)" className="blue">쇼핑 마켓</text>
                                <text transform="translate(40 60)" className="red">랜드마크</text>
                                <text transform="translate(40 80)" className="green">자연 휴양지</text>
                                <text transform="translate(40 100)" className="yellow">음식점</text>
                            </g>
                            <g id="Ilsan" >
