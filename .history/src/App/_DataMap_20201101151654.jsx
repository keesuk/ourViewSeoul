...
import { pxStringfier, colorChooser, randomize, mapDrawer } from "./_Diagram.jsx";
...
class MapShow extends PureComponent {
    ...
    componentDidUpdate(){
        if(this.props.posterPin !== null)this.getLocation(this.props.posterPin)
        console.log(this.props.posterPin)
    }
