...
export function infoGraphic(location, corArr){
    return(circlePin(checkSize(location[0].number), `translate(${corArr[0] && corArr[0][0]}, ${corArr[0] && corArr[0][1]})`, i)
                )
    // location.map((station, i) => 
    //     {
    //         if(station.id === 0){
    //             return(
    //                 circlePin(checkSize(station.number), `translate(${corArr[i] && corArr[i][0]}, ${corArr[i] && corArr[i][1]})`, i)
    //             )
