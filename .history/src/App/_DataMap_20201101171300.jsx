                    ...
                    <React.Fragment>
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                {stroke 
                                ? <g>
                                    <text transform="translate(80 40)" className="purple">&#9670; 박물관 갤러리</text>
                                    <text transform="translate(80 100)" className="green">▲ 자연 휴양지</text>
                                    <text transform="translate(80 160)" className="blue">■ 쇼핑 마켓</text>
                                    <text transform="translate(80 220)" className="red">● 랜드마크</text>
                                    <text transform="translate(80 280)" className="yellow">⬮  음식점</text>
                                </g>
                                : null}
