...
export function infoGraphic(location, corArr, i){
    ...
    function startWithOrnamentType(id, corA, corB, i){ 
        ...
        function copyToMakeShapeSec(num){
            const shape = randomize(['cross', 'horizon', 'vertical'])
            const numToMultiply = 60
        ...
        function copyToMakeShapeFir(num){
            const shape = randomize(['stairs', 'cross', 'horizon', 'vertical', 'circle'])
