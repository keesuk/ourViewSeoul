...
const distanceList  = ['0px', '20px', '40px', '60px', '80px', '100px', '120px', '140px', '160px', '180px', '200px','210px']
let i = 0
                ...
                {this.state.buttonOn 
                    ? <>
                        ...
                        <IknowExplainArrowDiv>
                            <AskMarker left={randomize(distanceList)} top={randomize(distanceList)} color={this.state.choose}/>
                            <AskMarker left={randomize(distanceList)} top={randomize(distanceList)} color={this.state.choose}/>
                            <AskMarker left={randomize(distanceList)} top={randomize(distanceList)} color={this.state.choose}/>
                            <AskMarker left={randomize(distanceList)} top={randomize(distanceList)} color={this.state.choose}/>
                        </IknowExplainArrowDiv>
