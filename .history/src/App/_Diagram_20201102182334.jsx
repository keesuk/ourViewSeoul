        ...
        if(location[i].id === 0){
            if(location[i].id === 1){
                if(location[i].id === 2){
                    if(location[i].id === 3){
                        if(location[i].id === 4){
                            return ellipsePin(checkSize(location[i].number), corArr[i] && corArr[i][0], corArr[i] && corArr[i][1], `translate()`, i)
                        }
                        else {
                            return rhombusPin(checkSize(location[i].number), corArr[i] && corArr[i][0], corArr[i] && corArr[i][1], i)
                        }
                    }else {
                        return trianglePin(checkSize(location[i].number), `translate(${corArr[i] && corArr[i][0]}, ${corArr[i] && corArr[i][1]})`, i)
                    }
                }else {
                    return rectPin(checkSize(location[i].number), corArr[i] && corArr[i][0], corArr[i] && corArr[i][1], i)
                }
            }else{
                return circlePin(checkSize(location[i].number), `translate(${corArr[i] && corArr[i][0]}, ${corArr[i] && corArr[i][1]})`, i)
            }
    }
