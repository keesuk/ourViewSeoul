                        ...
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                ? <g>
                                    ...
                                    <text transform="translate(80 60)" className="green">▲ 자연 휴양지</text>
                                    <text transform="translate(80 100)" className="blue">■ 쇼핑 마켓</text>
                                    <text transform="translate(80 140)" className="red">● 랜드마크</text>
                                    <text transform="translate(80 180)" className="yellow">⬮ 음식점</text>
                                </g>
                                : null}
