                    ...
                    <TransformComponent>
                        <SvgContainer> 
                            ...
                            <g>
                                ...
                                <text transform="translate(40 40)" className="st0 blue">쇼핑 마켓</text>
                                <text transform="translate(40 60)" className="st0 red">랜드마크</text>
                                <text transform="translate(40 80)" className="st0 green">자연 휴양지</text>
                                <text transform="translate(40 100)" className="st0 yellow">음식점</text>
                            </g>
                            <g id="Ilsan" >
