...
class Window extends PureComponent {
    ...
    fetchMoreData = () => {
        const stationDatas = this.state.stationDatas

        setTimeout(() => {
            this.setState(state => ({ 
                arr : [...state.arr, stationDatas[state.arrNum], stationDatas[state.arrNum+1], stationDatas[state.arrNum+2], stationDatas[state.arrNum+3]],
                arrNum : state.arrNum + 4
            }))
        }, 1500)
    }
                        ...
                        >
                            {arr.map((stationData,i) =>  
                                    <Img 
                                        ...
                                        points={console.log(stationData && stationData.locationData)}
                                        onOk={this.handleOk}
                                        chilcOk={i}
