...
import { PinBottom, TagOn } from './_Diagram.jsx'
...
class SeoulMap extends PureComponent {
    constructor(props){
        ...
        this.aboutData = this.aboutData.bind(this);
    }
    ...
    render() { 
        const { wheelValue, imgShow, station, locationTag} = this.state;
                ...
                <React.Fragment>
                    <TransformComponent>
                        <SvgContainer>                
                            ...
                            >
                                <PinBottom onClick={this.aboutData}/>
                                {locationTag? <TagOn/> : null}
                                <Map/>
                            </Svg>
                        </SvgContainer>
                    </TransformComponent>
