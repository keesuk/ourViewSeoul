...
const colorList = ['#7B2E8E','#006CC4','#E20000','#087A0D','#EFC820' ]
                    ...
                    <React.Fragment>
                        <TransformComponent>
                            <SvgContainer> 
                                ...
                                <g onClick={this.getLocation("Songtan")} id="Songtan" >
                                ...
                                <g onClick={this.getLocation("Seodongtan")} id="Seodongtan" >
                                ...
                                <g onClick={this.getLocation("SuwonCityHall1")} id="SuwonCityHall1" >
                                ...
                                <g onClick={this.getLocation("Samga1")} id="Samga1" >
                                ...
                                <g onClick={this.getLocation("Ungilsan1")} id="Ungilsan1" >
                                ...
                                <g onClick={this.getLocation("Yangpyeong1")} id="Yangpyeong1" >
                                ...
                                <g onClick={this.getLocation("Jangji")} id="Jangji" >
                                ...
                                <g onClick={this.getLocation("Geumho")} id="Geumho" >
                                ...
                                <g onClick={this.getLocation("IncheonIntlAirportCargoTerminal1")} id="IncheonIntlAirportCargoTerminal1" >
                                ...
                                <g onClick={this.getLocation("Anguk")} id="Anguk" >
                                ...
                                <g onClick={this.getLocation("Yongdu")} id="Yongdu" >
                                    <text transform="translate(854.2069 598.9894)" className="st0 st1">용두</text>
                                </g>
                                <g onClick={this.getLocation("Sangwangsimni")} id="Sangwangsimni" >
                                ...
                                <g onClick={this.getLocation("Yeongdeungpo")} id="Yeongdeungpo" >
                                ...
                                <g onClick={this.getLocation("Cheonwang")} id="Cheonwang" >
                                    <text transform="translate(249.766 921.631)" className="st0 st1">천왕</text>
                                </g>
                                <g onClick={this.getLocation("Gwangmyeongsageori")} id="Gwangmyeongsageori" >
                                ...
                                <g onClick={this.getLocation("SogangUniv")} id="SogangUniv" >
                                ...
                                <g onClick={this.getLocation("Juyeop")} id="Juyeop" >
                                ...
                                <g onClick={this.getLocation("Baegyangri")} id="Baegyangri" >
                                ...
                                <g onClick={this.getLocation("Gwangmyeong")} id="Gwangmyeong" >
                                ...
                                <g onClick={this.getLocation("ExpressBusTerminal1")} id="ExpressBusTerminal1" >
