                ...
                <PosterContentDiv>
                    ...
                    <MapExplainWrapperDiv>
                        <MapExplainDiv>
                            ...
                            <MapShowText>
                                <Rhombus on={true} style={{marginRight:'0px'}}/>
                                    <text style={{color:'#7B2E8E'}}>박물관 갤러리</text>
                                <Rectangular on={true} style={{marginRight:'0px'}}/>
                                    <text style={{color:'#006CC4'}}>쇼핑 마켓</text>
                                <Circle on={true} style={{marginRight:'0px'}}/>
                                    <text style={{color:'#E20000'}}>랜드마크</text>
                                <Triangle on={true} style={{marginRight:'0px'}}/>
                                    <text style={{color:'#087A0D'}}>자연 휴양지</text>
                                <Ellipse on={true} style={{marginRight:'0px'}}/>
