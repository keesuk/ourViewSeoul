        ...
        return(
            ...
            >
                <div>
                    ...
                    : <>
                    <CategoryText>
                        <Rhombus size={'3vw'}right={'0px'}/><div style={{color:'#e90087'}}>박물관 갤러리</div>
                    </CategoryText>
                    <CategoryText>
                        <Rectangular size={'3vw'} right={'0px'}/><div style={{color:'#006CC4'}}>쇼핑 마켓</div>
                    </CategoryText>
                    <CategoryText>
                        <Circle size={'3vw'} right={'0px'}/><div style={{color:'#E20000'}}>랜드마크</div>
                    </CategoryText>
                    <CategoryText>
                        <Triangle size={'3vw'} right={'0px'} top={'-0.5px'}/><div style={{color:'#087A0D'}}>자연 휴양지</div>
                    </CategoryText>
                    <CategoryText>
                        <Ellipse size={'3vw'} right={'0px'} top={'-4.5px'}/><div style={{color:'#00bfb3'}}>음식점</div>
                    </CategoryText>
                    </>}
                </div>
            </OutputWrapper>
