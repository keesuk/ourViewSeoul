                    ...
                    <div className="header-content">
                        ...
                        <div>
                            {stationDatas.map(stationData =>
                                stationData && stationData.locationTag === '지하철,전철' && <Circle/>,
                                stationData && stationData.locationTag === '건강검진' && <Rhombus/>,
                                stationData && stationData.locationTag === '중식당' && <Triangle/>,
                                stationData && stationData.locationTag === '족발,보쌈' && <Rectangular/>,
                                stationData && stationData.locationTag === '돈까스' && <Ellipse/>,
                            )}
                        </div>
                    </div>
                </header>
