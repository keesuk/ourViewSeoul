                    ...
                    <MapExplainWrapperDiv>
                        <MapExplainDiv>
                            ...
                            <ExplainTitle>
                                ...
                                <ExplainPlanning>
                                    서울시 지역구는 서울에 사는 사람들 개개의 경험 속 저마다의 다른 의미가 존재합니다. 그렇기 때문에 내가 보는 서울시는 타인이 보는 서울시와 다를 수도 같을 수도 있습니다. <br/> 우리가 본 서울시 프로젝트는 저마다의 다른 관점, 추억, 경험을 재구성하여 공감이 갈 수 있는 데이터 시각화를 목표로 하며, 여러 사람들의 데이터를 융합한 공감지도를 그려보고자 합니다.
                                </ExplainPlanning>
                        </MapExplainDiv>
                    </MapExplainWrapperDiv>
            </>
