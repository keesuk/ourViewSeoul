...
class Window extends Component {
    ...
    handleSubmit(event) {
        ...
        this.props.whatsOk(calculatedArr)
        this.goBack()
    }
    ...
    render(){
        ...
        return(
            ...
            >
                ...
                <div
                    onClick={sendTextOn 
                        ? ( value !== '' ? this.handleSubmit : this.sendTextWindowUp )
                        : this.handleSubmit
                    } 
                    className="content-next-button" style={{
                    boxShadow: inputOn ? '3px 5px black':(windowUp ? (textOn ? (nonPass ? '0px 0px red':'3px 5px'+ myButtonColor ):'0px 0px #cccccc'):'0px 0px #cccccc'),
