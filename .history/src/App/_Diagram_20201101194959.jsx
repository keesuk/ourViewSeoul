...
export function infoGraphic(location, corArr){
    console.log(location, corArr)
    
    console.log(corArr[0][0])
    // const graphic = location.map((station, i) => 
    //     {
    //         if(station.id === 0){
    //             return(
    //                 circlePin(checkSize(station.number), `translate(${corArr[i][0]}, ${corArr[i][1]})`, i)
    //             )
