            ...
            <PinSvg width={this.props.width} height={this.props.height} viewBox='0 -5 70 80' fill="none">
                ...
                <defs>
                    <linearGradient
                        ...
                        x1={this.props.choose==='red'? 60.788 : (this.props.choose==='green' ? 60.788 : (this.props.choose==='blue' ? 8.683: (this.props.choose==='purple' ? 8.683 : 60.788)))}
                        y1={75.863}
                        x2={this.props.choose==='red'? 17.936 : (this.props.choose==='green' ? 17.936 : (this.props.choose==='blue' ? 51.535: (this.props.choose==='purple' ? 51.535 : 17.936)))}
                        y2={75.863}
                    ...
                    <linearGradient
                        ...
                        x1={this.props.choose==='red'? 15.979 : (this.props.choose==='green' ? 15.979 : (this.props.choose==='blue' ? 53.492: (this.props.choose==='purple' ? 53.492 : 15.979)))}
                        y1={59.527}
                        x2={this.props.choose==='red'? 13.483 : (this.props.choose==='green' ? 13.483 : (this.props.choose==='blue' ? 55.988: (this.props.choose==='purple' ? 55.988 : 13.483)))}
                        y2={57.709}
                        gradientUnits="userSpaceOnUse"
                    >
...
const colorListTag  = ['#E20000','#087A0D','#006CC4','#7B2E8E','#EFC820']
const shapeItems    = ['●','▲','◼︎','◆','⬬']
