...
const _IknowWrapDiv = styled.div`	
    position: absolute;
    width: 50vw;
    margin-top: 20px;
    z-index: 100;
...
const _IknowExplainDiv = styled.div`
    position: absolute;
    margin-top: 80px;
    line-height: 1.3em;
    font-size: 24px;
    ...
    render() {
        return(
            <_IknowWrapDiv>
                ...
                {this.state.ButtonOn ? 
                    <_IknowExplainDiv>잘 아는 지역이 있나요? 그 곳을 클릭해서 저에게 알려주세요.</_IknowExplainDiv>
                    : 
                    <div/>
                } 
            </_IknowWrapDiv>
