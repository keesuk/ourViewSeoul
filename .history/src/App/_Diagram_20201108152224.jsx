    ...
    function startWithOrnamentType(id, corA, corB, i){ 
        ...
        function copyToMakeShape(num){
            ...
            if(shape === 'stairs'){
                ...
                for(let i = 0; i < length; i++){
                    if(i < lengthHalf*7/8) corList.push([i*numToMultiply ,0])
                    else if(i >= lengthHalf*7/8 && i < lengthHalf*6/8) corList.push([lengthHalf - i*numToMultiply ,numToMultiply])
                    // else if(i >= lengthHalf*6/8 && i < lengthHalf*5/8) corList.push([i*numToMultiply ,numToMultiply])
                    // else if(i >= lengthHalf*5/8 && i < lengthHalf*4/8)
                    // else if(i >= lengthHalf*4/8 && i < lengthHalf*3/8)
                    // else if(i >= lengthHalf*3/8 && i < lengthHalf*2/8)
                    // else 
                }
                console.log(corList)
            }
