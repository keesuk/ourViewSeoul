        ...
        return(
            ...
            >
                ...
                <div
                    ...
                    boxShadow: inputOn ? '4px 6px black':(windowUp ? (textOn ? (nonPass ? '0px 0px red':'4px 6px'+ randomize(colorListTag)):'0px 0px #cccccc'):'0px 0px #cccccc'),
                    color: inputOn ? 'black':(windowUp ? (textOn ? (nonPass ? 'red':randomize(colorListTag) ):'#999'):'#999'),
                    borderColor: inputOn ? 'black' : (windowUp ? (textOn ? (nonPass ? 'red': randomize(colorListTag)):'#cccccc'):'#cccccc'),
