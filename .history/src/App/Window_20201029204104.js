...
class Window extends PureComponent {
    ...
    fetchMoreData = () => {
        setTimeout(() => {
            this.setState(state => ({ 
                arr : [...state.arr, this.state.stationDatas.list[state.arrNum], this.state.stationDatas.list[state.arrNum+1], this.state.stationDatas.list[state.arrNum+2], this.state.stationDatas.list[state.arrNum+3]],
                arrNum : state.arrNum + 4
            }))
        }, 1500)
    }
