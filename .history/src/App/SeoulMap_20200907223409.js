...
class SeoulMap extends PureComponent {
    constructor(props){
        ...
        this.state = {
            ...
            wheelValue : 2,
            station : ':station',
            urlStation : this.props.match.params.station,
        }
        this._updateDimensions = this._updateDimensions.bind(this);
    }

    // componentWillMount(previousProps, previousState) {
    //     const station = this.props.match.params.station;
    //     console.log(station, 'didUpdate')
    //     console.log(previousState.station, 'prevdidupdate')
    ...
    render() { 
        const { wheelValue, show, station, urlStation } = this.state;
