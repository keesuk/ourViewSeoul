...
export class PinBottom extends React.PureComponent {
    ...
    aboutData = () => {
        this.timeout = setTimeOut(()=> this.setState(state => ({locationTag : !state.locationTag})),2000)
    }
    ...
    render() {
        return(
            ...
            <g filter="url(#prefix__filter0_d)" transform="translate(-20 -330)">
                ...
                <path
                d="M7.097 4.598h-2.5V282.45H44.45l17.757 31.129 2.13 3.736 2.192-3.7 18.46-31.165h163.539V4.598H7.098z"
                stroke="#000"
                strokeWidth={5}
                />
                <path
                d="M7.097 7.098h238.931V279.95H83.565L64.38 312.34l-18.477-32.39H7.097V7.098z"
                fill="#fff"
                />
            </g>
            <defs>
