                ...
                <React.Fragment>
                    <TransformComponent>
                        <SvgContainer> 
                            ...
                            >
                            <g>
                                <text transform="translate(40 20)" className="purple">박물관 갤러리</text>
                                <text transform="translate(40 40)" className="purple">쇼핑 마켓</text>
                                <text transform="translate(40 60)" className="purple">랜드마크</text>
                                <text transform="translate(40 80)" className="purple">자연 휴양지</text>
                                <text transform="translate(40 100)" className="purple">음식점</text>
                            </g>
                            <g id="Ilsan" >
