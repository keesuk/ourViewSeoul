            ...
            >
                ...
                {this.props.size < pinSize 
                    ?<>
                        ...
                        {pinData.map((pin, i) =>
                            <g transform={`translate(${i*40},${i*40})`}>
                                {pin.locationTagID === "0" ? circlePin(i) 
                                : (pin.locationTagID === "1" ? rhombusPin(i)
                                : (pin.locationTagID === "2" ? trianglePin(i)
                                : (pin.locationTagID === "3" ? rectPin(i)
                                : (pin.locationTagID === "4" ? ellipsePin(i)
                                : null))))}  
                            </g>
                        )}
