...
export class Pin extends React.PureComponent {
    ...
    render() {
        ...
        const circlePin = (i) => {
            return (<text fontSize={'70px'} transform={`rotate(38.2, 10, -50)`} fill={'#E20000'} key={i}>
            ● </text>
        )}
        const rectPin = (i) => {
        ...
        const rhombusPin = (i) => {
            ...
            <g transform={`rotate(-15, 0, 0)`}>
                <rect width={'52px'} height={'52px'} x={'-10px'} y={'-35px'} transform={`skewX(-30), skewY(0)`} fill={'#e90087'} key={i}/>
            </g>
        )}
