...
class Map extends PureComponent {
  ...
  render() {
    return (
    <>
    <Window title={this.state.activeStation}/>
    <Svg
    ...
    <g id="map" key="map_Station" data="map">
      <g onClick={() => this.handleItemClick(true)}id="Ilsan" key="Ilsan_Station" data="Ilsan">
      ...
      <g id="Baengma" key="Baengma_Station" data="Baengma">
      ...
      <g id="Hwajeong" key="Hwajeong_Station" data="Hwajeong">
      ...
      <g id="Wondang" key="Wondang_Station" data="Wondang">
      ...
      <g id="Wonheung" key="Wonheung_Station" data="Wonheung">
      ...
      <g id="Samsong" key="Samsong_Station" data="Samsong">
      ...
      <g id="Tanhyeon" key="Tanhyeon_Station" data="Tanhyeon">
      ...
      <g id="Unjeong" key="Unjeong_Station" data="Unjeong">
      ...
      <g id="Geumneung" key="Geumneung_Station" data="Geumneung">
      ...
      <g id="Geumchon" key="Geumchon_Station" data="Geumchon">
      ...
      <g id="Wollong" key="Wollong_Station" data="Wollong">
      ...
      <g id="Paju" key="Paju_Station" data="Paju">
      ...
      <g id="Munsan" key="Munsan_Station" data="Munsan">
      ...
      <g id="Bugae" key="Bugae_Station" data="Bugae">
      ...
      <g id="Songnae" key="Songnae_Station" data="Songnae">
      ...
      <g id="Jungdong" key="Jungdong_Station" data="Jungdong">
      ...
      <g id="Bucheon" key="Bucheon_Station" data="Bucheon">
      ...
      <g id="Sosa" key="Sosa_Station" data="Sosa">
      ...
      <g id="Yeokgok" key="Yeokgok_Station" data="Yeokgok">
      ...
      <g id="Technopark" key="Technopark_Station" data="Technopark">
      ...
      <g id="BITZone" key="BITZone_Station" data="BITZone">
      ...
      <g id="IncheonNatlUniv" key="IncheonNatlUniv_Station" data="IncheonNatlUniv">
      ...
      <g id="CentralPark" key="CentralPark_Station" data="CentralPark">
      ...
      <g id="IntlBusinessDistrict" key="IntlBusinessDistrict_Station" data="IntlBusinessDistrict">
      ...
      <g id="SingilonCheon" key="SingilonCheon_Station" data="SingilonCheon">
      ...
      <g id="Sinchang" key="Sinchang_Station" data="Sinchang">
      ...
      <g id="OnyangonCheon" key="OnyangonCheon_Station" data="OnyangonCheon">
      ...
      <g id="Baebang" key="Baebang_Station" data="Baebang">
      ...
      <g id="Asan" key="Asan_Station" data="Asan">
      ...
      <g id="Ssangyong" key="Ssangyong_Station" data="Ssangyong">
      ...
      <g id="Bongmyeong" key="Bongmyeong_Station" data="Bongmyeong">
      ...
      <g id="Cheonan" key="Cheonan_Station" data="Cheonan">
      ...
      <g id="Dujeong" key="Dujeong_Station" data="Dujeong">
      ...
      <g id="Jiksan" key="Jiksan_Station" data="Jiksan">
      ...
      <g id="Seonghwan" key="Seonghwan_Station" data="Seonghwan">
      ...
      <g id="Pyeongtaek" key="Pyeongtaek_Station" data="Pyeongtaek">
      ...
      <g id="Jije" key="Jije_Station" data="Jije">
      ...
      <g id="Seojeongri" key="Seojeongri_Station" data="Seojeongri">
      ...
      <g id="Songtan" key="Songtan_Station" data="Songtan">
      ...
      <g id="Osan" key="Osan_Station" data="Osan">
      ...
      <g id="OsanCollege" key="OsanCollege_Station" data="OsanCollege">
      ...
      <g id="Sema" key="Sema_Station" data="Sema">
      ...
      <g id="Seodongtan" key="Seodongtan_Station" data="Seodongtan">
      ...
      <g id="Jinwi" key="Jinwi_Station" data="Jinwi">
      ...
      <g id="Ansan" key="Ansan_Station" data="Ansan">
      ...
      <g id="Choji" key="Choji_Station" data="Choji">
      ...
      <g id="Gojan" key="Gojan_Station" data="Gojan">
      ...
      <g id="Jungang" key="Jungang_Station" data="Jungang">
      ...
      <g id="HanyangUnivatAnsan" key="HanyangUnivatAnsan_Station" data="HanyangUnivatAnsan">
      ...
      <g id="Sangnoksu" key="Sangnoksu_Station" data="Sangnoksu">
      ...
      <g id="Banwol" key="Banwol_Station" data="Banwol">
      ...
      <g id="Daeyami" key="Daeyami_Station" data="Daeyami">
      ...
      <g id="Surisan" key="Surisan_Station" data="Surisan">
      ...
      <g id="SuwonCityHall1" key="SuwonCityHall1_Station" data="SuwonCityHall1">
      ...
      <g id="SuwonCityHall" key="SuwonCityHall_Station" data="SuwonCityHall">
      ...
      <g id="MaetanGwonseon" key="MaetanGwonseon_Station" data="MaetanGwonseon">
      ...
      <g id="Mangpo" key="Mangpo_Station" data="Mangpo">
      ...
      <g id="Yeongtong" key="Yeongtong_Station" data="Yeongtong">
      ...
      <g id="Cheongmyeong" key="Cheongmyeong_Station" data="Cheongmyeong">
      ...
      <g id="Sanggal" key="Sanggal_Station" data="Sanggal">
      ...
      <g id="Singal" key="Singal_Station" data="Singal">
      ...
      <g id="Guseong" key="Guseong_Station" data="Guseong">
      ...
      <g id="Bojeong" key="Bojeong_Station" data="Bojeong">
      ...
      <g id="Jukjeon" key="Jukjeon_Station" data="Jukjeon">
      ...
      <g id="Ori" key="Ori_Station" data="Ori">
      ...
      <g id="MyongjiUniv" key="MyongjiUniv_Station" data="MyongjiUniv">
      ...
      <g id="Samga1" key="Samga1_Station" data="Samga1">
      ...
      <g id="Samga" key="Samga_Station" data="Samga">
      ...
      <g id="Chodang" key="Chodang_Station" data="Chodang">
      ...
      <g id="Dongbaek" key="Dongbaek_Station" data="Dongbaek">
      ...
      <g id="Eojeong" key="Eojeong_Station" data="Eojeong">
      ...
      <g id="Jiseok" key="Jiseok_Station" data="Jiseok">
      ...
      <g id="Gulpocheon" key="Gulpocheon_Station" data="Gulpocheon">
      ...
      <g id="SamsanGymnasium" key="SamsanGymnasium_Station" data="SamsanGymnasium">
      ...
      <g id="BucheonCityHall" key="BucheonCityHall_Station" data="BucheonCityHall">
      ...
      <g id="Sinjungdong" key="Sinjungdong_Station" data="Sinjungdong">
      ...
      <g id="Sangdong" key="Sangdong_Station" data="Sangdong">
      ...
      <g id="Songdo" key="Songdo_Station" data="Songdo">
      ...
      <g id="Jeongwang" key="Jeongwang_Station" data="Jeongwang">
      ...
      <g id="Ungilsan1" key="Ungilsan1_Station" data="Ungilsan1">
      ...
      <g id="Ungilsan" key="Ungilsan_Station" data="Ungilsan">
      ...
      <g id="Yangsu" key="Yangsu_Station" data="Yangsu">
      ...
      <g id="Sinwon" key="Sinwon_Station" data="Sinwon">
      ...
      <g id="Guksu" key="Guksu_Station" data="Guksu">
      ...
      <g id="Asin" key="Asin_Station" data="Asin">
      ...
      <g id="Obin" key="Obin_Station" data="Obin">
      ...
      <g id="Yangpyeong1" key="Yangpyeong1_Station" data="Yangpyeong1">
      ...
      <g id="Wondeok" key="Wondeok_Station" data="Wondeok">
      ...
      <g id="Yongmun" key="Yongmun_Station" data="Yongmun">
      ...
      <g id="Paldang" key="Paldang_Station" data="Paldang">
      ...
      <g id="CampusTown" key="CampusTown_Station" data="CampusTown">
      ...
      <g id="KangnamUniv" key="KangnamUniv_Station" data="KangnamUniv">
      ...
      <g id="Sanbon" key="Sanbon_Station" data="Sanbon">
      ...
      <g id="DongdaemunHistoryCulturePark" key="DongdaemunHistoryCulturePark_Station" data="DongdaemunHistoryCulturePark">
      ...
      <g id="GuroDigitalComplex" key="GuroDigitalComplex_Station" data="GuroDigitalComplex">
