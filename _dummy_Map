...
class Map extends PureComponent {
  ...
  render() {
    ...
    <g key="map">
      ...
      <g key="GovernmentComplexGwacheon">
      ...
      <g key="IncheonIntlAirportCargoTerminal_1_">
        <text transform="translate(138.6185 523.8781)" className="st0 st1">인천국제공항</text>
      </g>
      <g key="IncheonIntlAirportCargoTerminal">
      ...
      <g key="HankukUnivofForeignStudies">
      ...
      <g key="GyeonggiProvincialGovernmentNorthernOffice">
      ...
      <g key="SeoulNatlUnivofEducation">
      ...
      <g key="DongdaemunHistoryCulturePark">
